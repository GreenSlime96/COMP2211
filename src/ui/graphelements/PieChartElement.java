...
public class PieChartElement implements ChartElement {
	...
	{
		chart.setPrefSize(dimension.width, dimension.height - TITLE_HEIGHT - LEGEND_HEIGHT);
		chart.setLabelLineLength( ((dimension.width > dimension.height ? dimension.width : dimension.height) / DEFAULT_SIZE) * DEFAULT_LINE_LENGTH );
	}
