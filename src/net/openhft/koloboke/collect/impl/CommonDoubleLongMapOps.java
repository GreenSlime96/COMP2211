...
public final class CommonDoubleLongMapOps {
    ...
    public static boolean containsAllEntries(final InternalDoubleLongMapOps map,
            Map<?, ?> another) {
        if ( map == another )
    ...
    public static  void putAll(final InternalDoubleLongMapOps map,
            Map<? extends Double, ? extends Long> another) {
        if (map == another)
            throw new IllegalArgumentException();
