...
public final class CommonObjLongMapOps {
    ...
    public static boolean containsAllEntries(final InternalObjLongMapOps<?> map,
            Map<?, ?> another) {
        if ( map == another )
    ...
    public static <K> void putAll(final InternalObjLongMapOps<K> map,
            Map<? extends K, ? extends Long> another) {
        if (map == another)
            throw new IllegalArgumentException();
        ...
        if (another instanceof ObjLongMap) {
            ...
            for (Map.Entry<? extends K, ? extends Long> e : another.entrySet()) {
