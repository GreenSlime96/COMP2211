...
public class UpdatableQHashParallelKVCharCharMapGO
        extends UpdatableQHashParallelKVCharCharMapSO {
    ...
    class EntryView extends AbstractSetView<Map.Entry<Character, Character>>
        ...
        public HashConfig hashConfig() {
            return UpdatableQHashParallelKVCharCharMapGO.this.hashConfig();
        }


        @Override
        public int size() {
            return UpdatableQHashParallelKVCharCharMapGO.this.size();
        }

        @Override
        public double currentLoad() {
            return UpdatableQHashParallelKVCharCharMapGO.this.currentLoad();
        }
        ...
        public int hashCode() {
            return UpdatableQHashParallelKVCharCharMapGO.this.hashCode();
        }
        ...
        public boolean shrink() {
            return UpdatableQHashParallelKVCharCharMapGO.this.shrink();
        }
        ...
        @Override
        public void clear() {
            UpdatableQHashParallelKVCharCharMapGO.this.clear();
        }
    }
    ...
    class ValueView extends AbstractCharValueView {
        ...
        @Override
        public boolean contains(Object o) {
            return UpdatableQHashParallelKVCharCharMapGO.this.containsValue(o);
        }

        @Override
        public boolean contains(char v) {
            return UpdatableQHashParallelKVCharCharMapGO.this.containsValue(v);
        }
