...
public abstract class QHashSeparateKVShortIntMapFactoryGO
        extends QHashSeparateKVShortIntMapFactorySO {

    QHashSeparateKVShortIntMapFactoryGO(HashConfig hashConf, int defaultExpectedSize
    ...
    private  UpdatableQHashSeparateKVShortIntMapGO shrunk(
            UpdatableQHashSeparateKVShortIntMapGO map) {
    ...
    @Override
    @Nonnull
    public  MutableQHashSeparateKVShortIntMapGO newMutableMap() {
    ...
    public  UpdatableQHashSeparateKVShortIntMapGO newUpdatableMap(
            Map<Short, Integer> map1, Map<Short, Integer> map2,
            int expectedSize) {
        UpdatableQHashSeparateKVShortIntMapGO map = newUpdatableMap(expectedSize);
        map.putAll(map1);
        map.putAll(map2);
        return shrunk(map);
    }
    ...
    public  UpdatableQHashSeparateKVShortIntMapGO newUpdatableMap(
            Consumer<net.openhft.koloboke.function.ShortIntConsumer> entriesSupplier,
            int expectedSize) {
        final UpdatableQHashSeparateKVShortIntMapGO map = newUpdatableMap(expectedSize);
    ...
    @Override
    @Nonnull
    public  UpdatableQHashSeparateKVShortIntMapGO newUpdatableMapOf(
            short k1, int v1) {
        UpdatableQHashSeparateKVShortIntMapGO map = newUpdatableMap(1);
        map.put(k1, v1);
        return map;
    }
    ...
    public  UpdatableQHashSeparateKVShortIntMapGO newUpdatableMapOf(
        ...
        UpdatableQHashSeparateKVShortIntMapGO map = newUpdatableMap(2);
        map.put(k1, v1);
        map.put(k2, v2);
        return map;
    }
    ...
    public  UpdatableQHashSeparateKVShortIntMapGO newUpdatableMapOf(
            short k1, int v1, short k2, int v2,
            short k3, int v3) {
        UpdatableQHashSeparateKVShortIntMapGO map = newUpdatableMap(3);
        map.put(k1, v1);
        map.put(k2, v2);
        map.put(k3, v3);
        return map;
    ...
    public  UpdatableQHashSeparateKVShortIntMapGO newUpdatableMapOf(
        ...
        UpdatableQHashSeparateKVShortIntMapGO map = newUpdatableMap(4);
        map.put(k1, v1);
        map.put(k2, v2);
        map.put(k3, v3);
        map.put(k4, v4);
    ...
    public  UpdatableQHashSeparateKVShortIntMapGO newUpdatableMapOf(
            ...
            short k3, int v3, short k4, int v4,
            short k5, int v5) {
        UpdatableQHashSeparateKVShortIntMapGO map = newUpdatableMap(5);
        map.put(k1, v1);
        map.put(k2, v2);
        map.put(k3, v3);
        map.put(k4, v4);
    ...
    public  HashShortIntMap newMutableMap(Map<Short, Integer> map1,
        ...
        MutableQHashSeparateKVShortIntMapGO res = uninitializedMutableMap();
    ...
    public  HashShortIntMap newImmutableMap(Map<Short, Integer> map1,
            Map<Short, Integer> map2, int expectedSize) {
        ImmutableQHashSeparateKVShortIntMapGO res = uninitializedImmutableMap();
        res.move(newUpdatableMap(map1, map2, expectedSize));
        return res;
    }
    ...
    public  HashShortIntMap newImmutableMap(
            Consumer<net.openhft.koloboke.function.ShortIntConsumer> entriesSupplier
            , int expectedSize) {
        ImmutableQHashSeparateKVShortIntMapGO map = uninitializedImmutableMap();
        map.move(newUpdatableMap(entriesSupplier, expectedSize));
        return map;
    }
