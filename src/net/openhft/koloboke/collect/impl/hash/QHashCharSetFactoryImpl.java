...
public final class QHashCharSetFactoryImpl extends QHashCharSetFactoryGO {
    ...
    public QHashCharSetFactoryImpl(HashConfig hashConf, int defaultExpectedSize
    ...
    HashCharSetFactory withDomain(char lower, char upper) {
        if (lower == getLowerKeyDomainBound() && upper == getUpperKeyDomainBound())
            return this;
        return new QHashCharSetFactoryImpl(getHashConfig(), getDefaultExpectedSize(), lower, upper);
    }
