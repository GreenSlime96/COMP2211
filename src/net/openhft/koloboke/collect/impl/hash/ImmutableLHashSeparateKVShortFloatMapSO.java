...
public abstract class ImmutableLHashSeparateKVShortFloatMapSO
        extends ImmutableLHashSeparateKVShortKeyMap
        implements HashShortFloatMap, InternalShortFloatMapOps, SeparateKVShortFloatLHash {

    int[] values;

    void copy(SeparateKVShortFloatLHash hash) {
        super.copy(hash);
        values = hash.valueArray().clone();
    }

    void move(SeparateKVShortFloatLHash hash) {
        super.move(hash);
