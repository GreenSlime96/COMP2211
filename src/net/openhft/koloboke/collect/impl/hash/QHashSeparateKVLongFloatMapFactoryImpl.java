...
public final class QHashSeparateKVLongFloatMapFactoryImpl
        extends QHashSeparateKVLongFloatMapFactoryGO {
    ...
    QHashSeparateKVLongFloatMapFactoryImpl(HashConfig hashConf, int defaultExpectedSize, long lower, long upper) {
    ...
    static final class WithCustomDefaultValue
        ...
        @Override
         MutableQHashSeparateKVLongFloatMapGO uninitializedMutableMap() {
            MutableQHashSeparateKVLongFloatMap.WithCustomDefaultValue map =
                    new MutableQHashSeparateKVLongFloatMap.WithCustomDefaultValue();
            map.defaultValue = defaultValue;
            return map;
        }
        @Override
         UpdatableQHashSeparateKVLongFloatMapGO uninitializedUpdatableMap() {
            UpdatableQHashSeparateKVLongFloatMap.WithCustomDefaultValue map =
                    new UpdatableQHashSeparateKVLongFloatMap.WithCustomDefaultValue();
            map.defaultValue = defaultValue;
            return map;
        }
        @Override
         ImmutableQHashSeparateKVLongFloatMapGO uninitializedImmutableMap() {
            ImmutableQHashSeparateKVLongFloatMap.WithCustomDefaultValue map =
                    new ImmutableQHashSeparateKVLongFloatMap.WithCustomDefaultValue();
            map.defaultValue = defaultValue;
            return map;
        }
        ...
        public HashLongFloatMapFactory withDefaultValue(float defaultValue) {
            if (defaultValue == 0.0f)
                return new QHashSeparateKVLongFloatMapFactoryImpl(getHashConfig(), getDefaultExpectedSize()
