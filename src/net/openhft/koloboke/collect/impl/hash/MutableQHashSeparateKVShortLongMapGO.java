...
public class MutableQHashSeparateKVShortLongMapGO
        extends MutableQHashSeparateKVShortLongMapSO {
    ...
    class EntryView extends AbstractSetView<Map.Entry<Short, Long>>
        ...
        public HashConfig hashConfig() {
            return MutableQHashSeparateKVShortLongMapGO.this.hashConfig();
        }


        @Override
        public int size() {
            return MutableQHashSeparateKVShortLongMapGO.this.size();
        }

        @Override
        public double currentLoad() {
            return MutableQHashSeparateKVShortLongMapGO.this.currentLoad();
        }
        ...
        public int hashCode() {
            return MutableQHashSeparateKVShortLongMapGO.this.hashCode();
        }
        ...
        public boolean shrink() {
            return MutableQHashSeparateKVShortLongMapGO.this.shrink();
        }
        ...
        public boolean remove(Object o) {
            try {
                ...
                return MutableQHashSeparateKVShortLongMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
        ...
        @Override
        public void clear() {
            MutableQHashSeparateKVShortLongMapGO.this.clear();
        }
    }
    ...
    class ValueView extends AbstractLongValueView {
        ...
        @Override
        public boolean contains(Object o) {
            return MutableQHashSeparateKVShortLongMapGO.this.containsValue(o);
        }

        @Override
        public boolean contains(long v) {
            return MutableQHashSeparateKVShortLongMapGO.this.containsValue(v);
        }
    ...
    class SomeRemovedEntryIterator implements ObjIterator<Map.Entry<Short, Long>> {
        final short[] keys;
        final long[] vals;
        final short free;
        final short removed;
    ...
    class SomeRemovedEntryCursor implements ObjCursor<Map.Entry<Short, Long>> {
        final short[] keys;
        final long[] vals;
        final short free;
        final short removed;
    ...
    class SomeRemovedMapCursor implements ShortLongCursor {
        final short[] keys;
        final long[] vals;
        final short free;
        final short removed;
