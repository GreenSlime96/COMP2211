...
public class UpdatableLHashParallelKVDoubleDoubleMapGO
        extends UpdatableLHashParallelKVDoubleDoubleMapSO {
    ...
    class EntryView extends AbstractSetView<Map.Entry<Double, Double>>
        ...
        public HashConfig hashConfig() {
            return UpdatableLHashParallelKVDoubleDoubleMapGO.this.hashConfig();
        }


        @Override
        public int size() {
            return UpdatableLHashParallelKVDoubleDoubleMapGO.this.size();
        }

        @Override
        public double currentLoad() {
            return UpdatableLHashParallelKVDoubleDoubleMapGO.this.currentLoad();
        }
        ...
        public int hashCode() {
            return UpdatableLHashParallelKVDoubleDoubleMapGO.this.hashCode();
        }
        ...
        public boolean shrink() {
            return UpdatableLHashParallelKVDoubleDoubleMapGO.this.shrink();
        }
        ...
        public boolean remove(Object o) {
            try {
                ...
                return UpdatableLHashParallelKVDoubleDoubleMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
        ...
        @Override
        public void clear() {
            UpdatableLHashParallelKVDoubleDoubleMapGO.this.clear();
        }
    }
    ...
    class ValueView extends AbstractDoubleValueView {
        ...
        @Override
        public boolean contains(Object o) {
            return UpdatableLHashParallelKVDoubleDoubleMapGO.this.containsValue(o);
        }

        @Override
        public boolean contains(double v) {
            return UpdatableLHashParallelKVDoubleDoubleMapGO.this.containsValue(v);
        }

        @Override
        public boolean contains(long bits) {
            return UpdatableLHashParallelKVDoubleDoubleMapGO.this.containsValue(bits);
        }
