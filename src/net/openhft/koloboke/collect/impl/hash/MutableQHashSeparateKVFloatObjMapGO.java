...
public class MutableQHashSeparateKVFloatObjMapGO<V>
        extends MutableQHashSeparateKVFloatObjMapSO<V> {
    ...
    // under this condition - operations, overridden from MutableSeparateKVFloatQHashGO
    ...
    class EntryView extends AbstractSetView<Map.Entry<Float, V>>
        ...
        public HashConfig hashConfig() {
            return MutableQHashSeparateKVFloatObjMapGO.this.hashConfig();
        }


        @Override
        public int size() {
            return MutableQHashSeparateKVFloatObjMapGO.this.size();
        }

        @Override
        public double currentLoad() {
            return MutableQHashSeparateKVFloatObjMapGO.this.currentLoad();
        }
        ...
        public int hashCode() {
            return MutableQHashSeparateKVFloatObjMapGO.this.hashCode();
        }
        ...
        public boolean shrink() {
            return MutableQHashSeparateKVFloatObjMapGO.this.shrink();
        }
        ...
        public boolean remove(Object o) {
            try {
                ...
                float key = e.getKey();
                V value = e.getValue();
                return MutableQHashSeparateKVFloatObjMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
        ...
        @Override
        public void clear() {
            MutableQHashSeparateKVFloatObjMapGO.this.clear();
        }
    }
    ...
    class ValueView extends AbstractObjValueView<V> {
        ...
        @Override
        public boolean contains(Object o) {
            return MutableQHashSeparateKVFloatObjMapGO.this.containsValue(o);
        }
    ...
    class SomeRemovedEntryIterator implements ObjIterator<Map.Entry<Float, V>> {
        final int[] keys;
        final V[] vals;
        int expectedModCount;
        int index = -1;
    ...
    class SomeRemovedEntryCursor implements ObjCursor<Map.Entry<Float, V>> {
        final int[] keys;
        final V[] vals;
        int expectedModCount;
        int index;
    ...
    class SomeRemovedMapCursor implements FloatObjCursor<V> {
        final int[] keys;
        final V[] vals;
        int expectedModCount;
        int index;
