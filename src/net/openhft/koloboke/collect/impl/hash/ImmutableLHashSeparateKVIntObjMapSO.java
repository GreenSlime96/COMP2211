...
public abstract class ImmutableLHashSeparateKVIntObjMapSO<V>
        extends ImmutableLHashSeparateKVIntKeyMap
        implements HashIntObjMap<V>,
        InternalIntObjMapOps<V>, SeparateKVIntObjLHash {

    V[] values;

    void copy(SeparateKVIntObjLHash hash) {
        super.copy(hash);
        // noinspection unchecked
        values = (V[]) hash.valueArray().clone();
    }

    void move(SeparateKVIntObjLHash hash) {
        super.move(hash);
        // noinspection unchecked
