...
public abstract class ImmutableLHashSeparateKVIntCharMapSO
        extends ImmutableLHashSeparateKVIntKeyMap
        implements HashIntCharMap, InternalIntCharMapOps, SeparateKVIntCharLHash {

    char[] values;

    void copy(SeparateKVIntCharLHash hash) {
        super.copy(hash);
        values = hash.valueArray().clone();
    }

    void move(SeparateKVIntCharLHash hash) {
        super.move(hash);
