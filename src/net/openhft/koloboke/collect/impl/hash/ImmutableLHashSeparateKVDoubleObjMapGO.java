...
public class ImmutableLHashSeparateKVDoubleObjMapGO<V>
        extends ImmutableLHashSeparateKVDoubleObjMapSO<V> {
    ...
    class EntryView extends AbstractSetView<Map.Entry<Double, V>>
        ...
        public HashConfig hashConfig() {
            return ImmutableLHashSeparateKVDoubleObjMapGO.this.hashConfig();
        }


        @Override
        public int size() {
            return ImmutableLHashSeparateKVDoubleObjMapGO.this.size();
        }

        @Override
        public double currentLoad() {
            return ImmutableLHashSeparateKVDoubleObjMapGO.this.currentLoad();
        }
        ...
        public int hashCode() {
            return ImmutableLHashSeparateKVDoubleObjMapGO.this.hashCode();
        }
        ...
        public boolean shrink() {
            return ImmutableLHashSeparateKVDoubleObjMapGO.this.shrink();
        }
        ...
        public boolean remove(Object o) {
            try {
                ...
                double key = e.getKey();
                V value = e.getValue();
                return ImmutableLHashSeparateKVDoubleObjMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
        ...
        @Override
        public void clear() {
            ImmutableLHashSeparateKVDoubleObjMapGO.this.clear();
        }
    }
    ...
    class ValueView extends AbstractObjValueView<V> {
        ...
        @Override
        public boolean contains(Object o) {
            return ImmutableLHashSeparateKVDoubleObjMapGO.this.containsValue(o);
        }
