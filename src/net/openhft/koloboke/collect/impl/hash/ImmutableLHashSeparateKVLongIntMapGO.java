...
public class ImmutableLHashSeparateKVLongIntMapGO
        extends ImmutableLHashSeparateKVLongIntMapSO {

    @Override
    final void copy(SeparateKVLongIntLHash hash) {
    ...
    @Override
    final void move(SeparateKVLongIntLHash hash) {
        int myMC = modCount(), hashMC = hash.modCount();
        super.move(hash);
        if (myMC != modCount() || hashMC != hash.modCount())
            throw new ConcurrentModificationException();
    ...
    class EntryView extends AbstractSetView<Map.Entry<Long, Integer>>
        ...
        public HashConfig hashConfig() {
            return ImmutableLHashSeparateKVLongIntMapGO.this.hashConfig();
        }


        @Override
        public int size() {
            return ImmutableLHashSeparateKVLongIntMapGO.this.size();
        }

        @Override
        public double currentLoad() {
            return ImmutableLHashSeparateKVLongIntMapGO.this.currentLoad();
        }
        ...
        public int hashCode() {
            return ImmutableLHashSeparateKVLongIntMapGO.this.hashCode();
        }
        ...
        public boolean shrink() {
            return ImmutableLHashSeparateKVLongIntMapGO.this.shrink();
        }
        ...
        public boolean remove(Object o) {
            try {
                ...
                return ImmutableLHashSeparateKVLongIntMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
        ...
        @Override
        public void clear() {
            ImmutableLHashSeparateKVLongIntMapGO.this.clear();
        }
    }
    ...
    private class ImmutableEntry extends LongIntEntry {
    ...
    class ValueView extends AbstractIntValueView {
        ...
        @Override
        public boolean contains(Object o) {
            return ImmutableLHashSeparateKVLongIntMapGO.this.containsValue(o);
        }

        @Override
        public boolean contains(int v) {
            return ImmutableLHashSeparateKVLongIntMapGO.this.containsValue(v);
        }
