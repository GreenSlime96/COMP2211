...
public class UpdatableLHashParallelKVIntFloatMapGO
        extends UpdatableLHashParallelKVIntFloatMapSO {
    ...
    class EntryView extends AbstractSetView<Map.Entry<Integer, Float>>
        ...
        public HashConfig hashConfig() {
            return UpdatableLHashParallelKVIntFloatMapGO.this.hashConfig();
        }


        @Override
        public int size() {
            return UpdatableLHashParallelKVIntFloatMapGO.this.size();
        }

        @Override
        public double currentLoad() {
            return UpdatableLHashParallelKVIntFloatMapGO.this.currentLoad();
        }
        ...
        public int hashCode() {
            return UpdatableLHashParallelKVIntFloatMapGO.this.hashCode();
        }
        ...
        public boolean shrink() {
            return UpdatableLHashParallelKVIntFloatMapGO.this.shrink();
        }
        ...
        public boolean remove(Object o) {
            try {
                ...
                return UpdatableLHashParallelKVIntFloatMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
        ...
        @Override
        public void clear() {
            UpdatableLHashParallelKVIntFloatMapGO.this.clear();
        }
    }
    ...
    class ValueView extends AbstractFloatValueView {
        ...
        @Override
        public boolean contains(Object o) {
            return UpdatableLHashParallelKVIntFloatMapGO.this.containsValue(o);
        }

        @Override
        public boolean contains(float v) {
            return UpdatableLHashParallelKVIntFloatMapGO.this.containsValue(v);
        }

        @Override
        public boolean contains(int bits) {
            return UpdatableLHashParallelKVIntFloatMapGO.this.containsValue(bits);
        }
