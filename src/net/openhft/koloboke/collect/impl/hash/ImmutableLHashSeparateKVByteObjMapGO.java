...
public class ImmutableLHashSeparateKVByteObjMapGO<V>
        extends ImmutableLHashSeparateKVByteObjMapSO<V> {
    ...
    class EntryView extends AbstractSetView<Map.Entry<Byte, V>>
        ...
        public HashConfig hashConfig() {
            return ImmutableLHashSeparateKVByteObjMapGO.this.hashConfig();
        }


        @Override
        public int size() {
            return ImmutableLHashSeparateKVByteObjMapGO.this.size();
        }

        @Override
        public double currentLoad() {
            return ImmutableLHashSeparateKVByteObjMapGO.this.currentLoad();
        }
        ...
        public int hashCode() {
            return ImmutableLHashSeparateKVByteObjMapGO.this.hashCode();
        }
        ...
        public boolean shrink() {
            return ImmutableLHashSeparateKVByteObjMapGO.this.shrink();
        }
        ...
        public boolean remove(Object o) {
            try {
                ...
                byte key = e.getKey();
                V value = e.getValue();
                return ImmutableLHashSeparateKVByteObjMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
        ...
        @Override
        public void clear() {
            ImmutableLHashSeparateKVByteObjMapGO.this.clear();
        }
    }
    ...
    class ValueView extends AbstractObjValueView<V> {
        ...
        @Override
        public boolean contains(Object o) {
            return ImmutableLHashSeparateKVByteObjMapGO.this.containsValue(o);
        }
