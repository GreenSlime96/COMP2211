...
public class UpdatableLHashSeparateKVObjShortMapGO<K>
        extends UpdatableLHashSeparateKVObjShortMapSO<K> {
    ...
    class EntryView extends AbstractSetView<Map.Entry<K, Short>>
        ...
        public HashConfig hashConfig() {
            return UpdatableLHashSeparateKVObjShortMapGO.this.hashConfig();
        }


        @Override
        public int size() {
            return UpdatableLHashSeparateKVObjShortMapGO.this.size();
        }

        @Override
        public double currentLoad() {
            return UpdatableLHashSeparateKVObjShortMapGO.this.currentLoad();
        }
        ...
        public int hashCode() {
            return UpdatableLHashSeparateKVObjShortMapGO.this.hashCode();
        }
        ...
        public boolean shrink() {
            return UpdatableLHashSeparateKVObjShortMapGO.this.shrink();
        }
        ...
        public boolean remove(Object o) {
            try {
                ...
                return UpdatableLHashSeparateKVObjShortMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
        ...
        @Override
        public void clear() {
            UpdatableLHashSeparateKVObjShortMapGO.this.clear();
        }
    }
    ...
    class ValueView extends AbstractShortValueView {
        ...
        @Override
        public boolean contains(Object o) {
            return UpdatableLHashSeparateKVObjShortMapGO.this.containsValue(o);
        }

        @Override
        public boolean contains(short v) {
            return UpdatableLHashSeparateKVObjShortMapGO.this.containsValue(v);
        }
