...
public class ImmutableQHashParallelKVFloatFloatMapGO
        extends ImmutableQHashParallelKVFloatFloatMapSO {
    ...
    class EntryView extends AbstractSetView<Map.Entry<Float, Float>>
        ...
        public HashConfig hashConfig() {
            return ImmutableQHashParallelKVFloatFloatMapGO.this.hashConfig();
        }


        @Override
        public int size() {
            return ImmutableQHashParallelKVFloatFloatMapGO.this.size();
        }

        @Override
        public double currentLoad() {
            return ImmutableQHashParallelKVFloatFloatMapGO.this.currentLoad();
        }
        ...
        public int hashCode() {
            return ImmutableQHashParallelKVFloatFloatMapGO.this.hashCode();
        }
        ...
        public boolean shrink() {
            return ImmutableQHashParallelKVFloatFloatMapGO.this.shrink();
        }
        ...
        public boolean remove(Object o) {
            try {
                ...
                return ImmutableQHashParallelKVFloatFloatMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
        ...
        @Override
        public void clear() {
            ImmutableQHashParallelKVFloatFloatMapGO.this.clear();
        }
    }
    ...
    class ValueView extends AbstractFloatValueView {
        ...
        @Override
        public boolean contains(Object o) {
            return ImmutableQHashParallelKVFloatFloatMapGO.this.containsValue(o);
        }

        @Override
        public boolean contains(float v) {
            return ImmutableQHashParallelKVFloatFloatMapGO.this.containsValue(v);
        }

        @Override
        public boolean contains(int bits) {
            return ImmutableQHashParallelKVFloatFloatMapGO.this.containsValue(bits);
        }
