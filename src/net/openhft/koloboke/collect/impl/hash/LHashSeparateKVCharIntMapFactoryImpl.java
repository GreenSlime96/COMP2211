...
public final class LHashSeparateKVCharIntMapFactoryImpl
        extends LHashSeparateKVCharIntMapFactoryGO {
    ...
    LHashSeparateKVCharIntMapFactoryImpl(HashConfig hashConf, int defaultExpectedSize, char lower, char upper) {
    ...
    static final class WithCustomDefaultValue
        ...
        @Override
         MutableLHashSeparateKVCharIntMapGO uninitializedMutableMap() {
            MutableLHashSeparateKVCharIntMap.WithCustomDefaultValue map =
                    new MutableLHashSeparateKVCharIntMap.WithCustomDefaultValue();
            map.defaultValue = defaultValue;
            return map;
        }
        @Override
         UpdatableLHashSeparateKVCharIntMapGO uninitializedUpdatableMap() {
            UpdatableLHashSeparateKVCharIntMap.WithCustomDefaultValue map =
                    new UpdatableLHashSeparateKVCharIntMap.WithCustomDefaultValue();
            map.defaultValue = defaultValue;
            return map;
        }
        @Override
         ImmutableLHashSeparateKVCharIntMapGO uninitializedImmutableMap() {
            ImmutableLHashSeparateKVCharIntMap.WithCustomDefaultValue map =
                    new ImmutableLHashSeparateKVCharIntMap.WithCustomDefaultValue();
            map.defaultValue = defaultValue;
            return map;
        }
        ...
        public HashCharIntMapFactory withDefaultValue(int defaultValue) {
            if (defaultValue == 0)
                return new LHashSeparateKVCharIntMapFactoryImpl(getHashConfig(), getDefaultExpectedSize()
