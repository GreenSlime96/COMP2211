...
public class UpdatableLHashSeparateKVFloatByteMapGO
        extends UpdatableLHashSeparateKVFloatByteMapSO {
    ...
    class EntryView extends AbstractSetView<Map.Entry<Float, Byte>>
        ...
        public HashConfig hashConfig() {
            return UpdatableLHashSeparateKVFloatByteMapGO.this.hashConfig();
        }


        @Override
        public int size() {
            return UpdatableLHashSeparateKVFloatByteMapGO.this.size();
        }

        @Override
        public double currentLoad() {
            return UpdatableLHashSeparateKVFloatByteMapGO.this.currentLoad();
        }
        ...
        public int hashCode() {
            return UpdatableLHashSeparateKVFloatByteMapGO.this.hashCode();
        }
        ...
        public boolean shrink() {
            return UpdatableLHashSeparateKVFloatByteMapGO.this.shrink();
        }
        ...
        public boolean remove(Object o) {
            try {
                ...
                return UpdatableLHashSeparateKVFloatByteMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
        ...
        @Override
        public void clear() {
            UpdatableLHashSeparateKVFloatByteMapGO.this.clear();
        }
    }
    ...
    class ValueView extends AbstractByteValueView {
        ...
        @Override
        public boolean contains(Object o) {
            return UpdatableLHashSeparateKVFloatByteMapGO.this.containsValue(o);
        }

        @Override
        public boolean contains(byte v) {
            return UpdatableLHashSeparateKVFloatByteMapGO.this.containsValue(v);
        }
