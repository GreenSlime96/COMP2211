...
public class MutableQHashSeparateKVIntCharMapGO
        extends MutableQHashSeparateKVIntCharMapSO {
    ...
    class EntryView extends AbstractSetView<Map.Entry<Integer, Character>>
        ...
        public HashConfig hashConfig() {
            return MutableQHashSeparateKVIntCharMapGO.this.hashConfig();
        }


        @Override
        public int size() {
            return MutableQHashSeparateKVIntCharMapGO.this.size();
        }

        @Override
        public double currentLoad() {
            return MutableQHashSeparateKVIntCharMapGO.this.currentLoad();
        }
        ...
        public int hashCode() {
            return MutableQHashSeparateKVIntCharMapGO.this.hashCode();
        }
        ...
        public boolean shrink() {
            return MutableQHashSeparateKVIntCharMapGO.this.shrink();
        }
        ...
        public boolean remove(Object o) {
            try {
                ...
                return MutableQHashSeparateKVIntCharMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
        ...
        @Override
        public void clear() {
            MutableQHashSeparateKVIntCharMapGO.this.clear();
        }
    }
    ...
    class ValueView extends AbstractCharValueView {
        ...
        @Override
        public boolean contains(Object o) {
            return MutableQHashSeparateKVIntCharMapGO.this.containsValue(o);
        }

        @Override
        public boolean contains(char v) {
            return MutableQHashSeparateKVIntCharMapGO.this.containsValue(v);
        }
    ...
    class SomeRemovedEntryIterator implements ObjIterator<Map.Entry<Integer, Character>> {
        final int[] keys;
        final char[] vals;
        final int free;
        final int removed;
    ...
    class SomeRemovedEntryCursor implements ObjCursor<Map.Entry<Integer, Character>> {
        final int[] keys;
        final char[] vals;
        final int free;
        final int removed;
    ...
    class SomeRemovedMapCursor implements IntCharCursor {
        final int[] keys;
        final char[] vals;
        final int free;
        final int removed;
