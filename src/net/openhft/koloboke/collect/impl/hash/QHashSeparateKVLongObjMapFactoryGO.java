...
public abstract class QHashSeparateKVLongObjMapFactoryGO<V>
        extends QHashSeparateKVLongObjMapFactorySO<V> {

    QHashSeparateKVLongObjMapFactoryGO(HashConfig hashConf, int defaultExpectedSize
...
;
    ...
    private <V2 extends V> UpdatableQHashSeparateKVLongObjMapGO<V2> shrunk(
            UpdatableQHashSeparateKVLongObjMapGO<V2> map) {
    ...
    @Override
    @Nonnull
    public <V2 extends V> MutableQHashSeparateKVLongObjMapGO<V2> newMutableMap() {
    ...
    public <V2 extends V> UpdatableQHashSeparateKVLongObjMapGO<V2> newUpdatableMap(
            Map<Long, ? extends V2> map1, Map<Long, ? extends V2> map2,
            int expectedSize) {
        UpdatableQHashSeparateKVLongObjMapGO<V2> map = newUpdatableMap(expectedSize);
        map.putAll(map1);
        map.putAll(map2);
        return shrunk(map);
    }
    ...
    public <V2 extends V> UpdatableQHashSeparateKVLongObjMapGO<V2> newUpdatableMap(
            Consumer<net.openhft.koloboke.function.LongObjConsumer<V2>> entriesSupplier,
            int expectedSize) {
        final UpdatableQHashSeparateKVLongObjMapGO<V2> map = newUpdatableMap(expectedSize);
    ...
    @Override
    @Nonnull
    public <V2 extends V> UpdatableQHashSeparateKVLongObjMapGO<V2> newUpdatableMapOf(
            long k1, V2 v1) {
        UpdatableQHashSeparateKVLongObjMapGO<V2> map = newUpdatableMap(1);
        map.put(k1, v1);
        return map;
    }
    ...
    public <V2 extends V> UpdatableQHashSeparateKVLongObjMapGO<V2> newUpdatableMapOf(
        ...
        UpdatableQHashSeparateKVLongObjMapGO<V2> map = newUpdatableMap(2);
        map.put(k1, v1);
        map.put(k2, v2);
        return map;
    }
    ...
    public <V2 extends V> UpdatableQHashSeparateKVLongObjMapGO<V2> newUpdatableMapOf(
            long k1, V2 v1, long k2, V2 v2,
            long k3, V2 v3) {
        UpdatableQHashSeparateKVLongObjMapGO<V2> map = newUpdatableMap(3);
        map.put(k1, v1);
        map.put(k2, v2);
        map.put(k3, v3);
        return map;
    ...
    public <V2 extends V> UpdatableQHashSeparateKVLongObjMapGO<V2> newUpdatableMapOf(
        ...
        UpdatableQHashSeparateKVLongObjMapGO<V2> map = newUpdatableMap(4);
        map.put(k1, v1);
        map.put(k2, v2);
        map.put(k3, v3);
        map.put(k4, v4);
    ...
    public <V2 extends V> UpdatableQHashSeparateKVLongObjMapGO<V2> newUpdatableMapOf(
            ...
            long k3, V2 v3, long k4, V2 v4,
            long k5, V2 v5) {
        UpdatableQHashSeparateKVLongObjMapGO<V2> map = newUpdatableMap(5);
        map.put(k1, v1);
        map.put(k2, v2);
        map.put(k3, v3);
        map.put(k4, v4);
    ...
    public <V2 extends V> HashLongObjMap<V2> newMutableMap(Map<Long, ? extends V2> map1,
        ...
        MutableQHashSeparateKVLongObjMapGO<V2> res = uninitializedMutableMap();
    ...
    public <V2 extends V> HashLongObjMap<V2> newMutableMap(
            Consumer<net.openhft.koloboke.function.LongObjConsumer<V2>> entriesSupplier
            , int expectedSize) {
        MutableQHashSeparateKVLongObjMapGO<V2> map = uninitializedMutableMap();
    ...
    public <V2 extends V> HashLongObjMap<V2> newImmutableMap(Map<Long, ? extends V2> map1,
            Map<Long, ? extends V2> map2, int expectedSize) {
        ImmutableQHashSeparateKVLongObjMapGO<V2> res = uninitializedImmutableMap();
        res.move(newUpdatableMap(map1, map2, expectedSize));
        return res;
    }
    ...
    public <V2 extends V> HashLongObjMap<V2> newImmutableMap(
            Consumer<net.openhft.koloboke.function.LongObjConsumer<V2>> entriesSupplier
            , int expectedSize) {
        ImmutableQHashSeparateKVLongObjMapGO<V2> map = uninitializedImmutableMap();
        map.move(newUpdatableMap(entriesSupplier, expectedSize));
        return map;
    }
