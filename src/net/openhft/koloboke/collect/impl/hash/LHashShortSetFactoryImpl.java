...
public final class LHashShortSetFactoryImpl extends LHashShortSetFactoryGO {
    ...
    public LHashShortSetFactoryImpl(HashConfig hashConf, int defaultExpectedSize
    ...
    HashShortSetFactory withDomain(short lower, short upper) {
        if (lower == getLowerKeyDomainBound() && upper == getUpperKeyDomainBound())
            return this;
        return new LHashShortSetFactoryImpl(getHashConfig(), getDefaultExpectedSize(), lower, upper);
    }
