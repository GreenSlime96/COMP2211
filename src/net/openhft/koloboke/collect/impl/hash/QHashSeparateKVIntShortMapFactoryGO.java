...
public abstract class QHashSeparateKVIntShortMapFactoryGO
        extends QHashSeparateKVIntShortMapFactorySO {

    QHashSeparateKVIntShortMapFactoryGO(HashConfig hashConf, int defaultExpectedSize
            , int lower, int upper) {
    ...
    private  UpdatableQHashSeparateKVIntShortMapGO shrunk(
            UpdatableQHashSeparateKVIntShortMapGO map) {
    ...
    @Override
    @Nonnull
    public  MutableQHashSeparateKVIntShortMapGO newMutableMap() {
    ...
    public  UpdatableQHashSeparateKVIntShortMapGO newUpdatableMap(
            Map<Integer, Short> map1, Map<Integer, Short> map2,
            int expectedSize) {
        UpdatableQHashSeparateKVIntShortMapGO map = newUpdatableMap(expectedSize);
        map.putAll(map1);
        map.putAll(map2);
        return shrunk(map);
    }
    ...
    public  UpdatableQHashSeparateKVIntShortMapGO newUpdatableMap(
            Consumer<net.openhft.koloboke.function.IntShortConsumer> entriesSupplier,
            int expectedSize) {
        final UpdatableQHashSeparateKVIntShortMapGO map = newUpdatableMap(expectedSize);
    ...
    @Override
    @Nonnull
    public  UpdatableQHashSeparateKVIntShortMapGO newUpdatableMapOf(
            int k1, short v1) {
        UpdatableQHashSeparateKVIntShortMapGO map = newUpdatableMap(1);
        map.put(k1, v1);
        return map;
    }
    ...
    public  UpdatableQHashSeparateKVIntShortMapGO newUpdatableMapOf(
        ...
        UpdatableQHashSeparateKVIntShortMapGO map = newUpdatableMap(2);
        map.put(k1, v1);
        map.put(k2, v2);
        return map;
    }
    ...
    public  UpdatableQHashSeparateKVIntShortMapGO newUpdatableMapOf(
            int k1, short v1, int k2, short v2,
            int k3, short v3) {
        UpdatableQHashSeparateKVIntShortMapGO map = newUpdatableMap(3);
        map.put(k1, v1);
        map.put(k2, v2);
        map.put(k3, v3);
        return map;
    ...
    public  UpdatableQHashSeparateKVIntShortMapGO newUpdatableMapOf(
        ...
        UpdatableQHashSeparateKVIntShortMapGO map = newUpdatableMap(4);
        map.put(k1, v1);
        map.put(k2, v2);
        map.put(k3, v3);
        map.put(k4, v4);
    ...
    public  UpdatableQHashSeparateKVIntShortMapGO newUpdatableMapOf(
            ...
            int k3, short v3, int k4, short v4,
            int k5, short v5) {
        UpdatableQHashSeparateKVIntShortMapGO map = newUpdatableMap(5);
        map.put(k1, v1);
        map.put(k2, v2);
        map.put(k3, v3);
        map.put(k4, v4);
    ...
    public  HashIntShortMap newMutableMap(Map<Integer, Short> map1,
        ...
        MutableQHashSeparateKVIntShortMapGO res = uninitializedMutableMap();
    ...
    public  HashIntShortMap newImmutableMap(Map<Integer, Short> map1,
            Map<Integer, Short> map2, int expectedSize) {
        ImmutableQHashSeparateKVIntShortMapGO res = uninitializedImmutableMap();
        res.move(newUpdatableMap(map1, map2, expectedSize));
        return res;
    }
    ...
    public  HashIntShortMap newImmutableMap(
            Consumer<net.openhft.koloboke.function.IntShortConsumer> entriesSupplier
            , int expectedSize) {
        ImmutableQHashSeparateKVIntShortMapGO map = uninitializedImmutableMap();
        map.move(newUpdatableMap(entriesSupplier, expectedSize));
        return map;
    }
