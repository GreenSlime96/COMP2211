...
public abstract class UpdatableQHashSeparateKVCharDoubleMapSO
        extends UpdatableQHashSeparateKVCharKeyMap
        implements HashCharDoubleMap, InternalCharDoubleMapOps, SeparateKVCharDoubleQHash {

    long[] values;

    void copy(SeparateKVCharDoubleQHash hash) {
        super.copy(hash);
        values = hash.valueArray().clone();
    }

    void move(SeparateKVCharDoubleQHash hash) {
        super.move(hash);
