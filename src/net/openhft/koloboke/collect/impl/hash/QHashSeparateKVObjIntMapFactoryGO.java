...
public abstract class QHashSeparateKVObjIntMapFactoryGO<K>
        extends QHashSeparateKVObjIntMapFactorySO<K> {

    QHashSeparateKVObjIntMapFactoryGO(HashConfig hashConf, int defaultExpectedSize
    ...
    private <K2 extends K>
     UpdatableQHashSeparateKVObjIntMapGO<K2> shrunk(
            UpdatableQHashSeparateKVObjIntMapGO<K2> map) {
    ...
    public <K2 extends K>
     UpdatableQHashSeparateKVObjIntMapGO<K2> newUpdatableMap(
            Map<? extends K2, Integer> map1, Map<? extends K2, Integer> map2,
            int expectedSize) {
        UpdatableQHashSeparateKVObjIntMapGO<K2> map = newUpdatableMap(expectedSize);
        map.putAll(map1);
        map.putAll(map2);
        return shrunk(map);
    }
    ...
    public <K2 extends K>
     UpdatableQHashSeparateKVObjIntMapGO<K2> newUpdatableMap(
            Consumer<net.openhft.koloboke.function.ObjIntConsumer<K2>> entriesSupplier,
            int expectedSize) {
        final UpdatableQHashSeparateKVObjIntMapGO<K2> map = newUpdatableMap(expectedSize);
    ...
    @Nonnull
    public <K2 extends K>
     UpdatableQHashSeparateKVObjIntMapGO<K2> newUpdatableMapOf(
            K2 k1, int v1) {
        UpdatableQHashSeparateKVObjIntMapGO<K2> map = newUpdatableMap(1);
        map.put(k1, v1);
        return map;
    }
    ...
    public <K2 extends K>
     UpdatableQHashSeparateKVObjIntMapGO<K2> newUpdatableMapOf(
        ...
        UpdatableQHashSeparateKVObjIntMapGO<K2> map = newUpdatableMap(2);
        map.put(k1, v1);
        map.put(k2, v2);
        return map;
    }
    ...
    public <K2 extends K>
     UpdatableQHashSeparateKVObjIntMapGO<K2> newUpdatableMapOf(
            K2 k1, int v1, K2 k2, int v2,
            K2 k3, int v3) {
        UpdatableQHashSeparateKVObjIntMapGO<K2> map = newUpdatableMap(3);
        map.put(k1, v1);
        map.put(k2, v2);
        map.put(k3, v3);
        return map;
    ...
    public <K2 extends K>
     UpdatableQHashSeparateKVObjIntMapGO<K2> newUpdatableMapOf(
        ...
        UpdatableQHashSeparateKVObjIntMapGO<K2> map = newUpdatableMap(4);
        map.put(k1, v1);
        map.put(k2, v2);
        map.put(k3, v3);
        map.put(k4, v4);
    ...
    public <K2 extends K>
     UpdatableQHashSeparateKVObjIntMapGO<K2> newUpdatableMapOf(
            ...
            K2 k3, int v3, K2 k4, int v4,
            K2 k5, int v5) {
        UpdatableQHashSeparateKVObjIntMapGO<K2> map = newUpdatableMap(5);
        map.put(k1, v1);
        map.put(k2, v2);
        map.put(k3, v3);
        map.put(k4, v4);
    ...
    public <K2 extends K>
     HashObjIntMap<K2> newMutableMap(
            Map<? extends K2, Integer> map, int expectedSize) {
        MutableQHashSeparateKVObjIntMapGO<K2> res = uninitializedMutableMap();
    ...
    public <K2 extends K>
     HashObjIntMap<K2> newImmutableMap(
            Map<? extends K2, Integer> map, int expectedSize) {
        ImmutableQHashSeparateKVObjIntMapGO<K2> res = uninitializedImmutableMap();
        res.move(newUpdatableMap(map, expectedSize));
        return res;
    }
    ...
    public <K2 extends K>
     HashObjIntMap<K2> newImmutableMap(
            Consumer<net.openhft.koloboke.function.ObjIntConsumer<K2>> entriesSupplier
            , int expectedSize) {
        ImmutableQHashSeparateKVObjIntMapGO<K2> map = uninitializedImmutableMap();
        map.move(newUpdatableMap(entriesSupplier, expectedSize));
        return map;
    }
