...
public abstract class QHashSeparateKVByteIntMapFactoryGO
        extends QHashSeparateKVByteIntMapFactorySO {

    QHashSeparateKVByteIntMapFactoryGO(HashConfig hashConf, int defaultExpectedSize
    ...
    private  UpdatableQHashSeparateKVByteIntMapGO shrunk(
            UpdatableQHashSeparateKVByteIntMapGO map) {
    ...
    @Override
    @Nonnull
    public  MutableQHashSeparateKVByteIntMapGO newMutableMap() {
    ...
    public  UpdatableQHashSeparateKVByteIntMapGO newUpdatableMap(
            Map<Byte, Integer> map1, Map<Byte, Integer> map2,
            int expectedSize) {
        UpdatableQHashSeparateKVByteIntMapGO map = newUpdatableMap(expectedSize);
        map.putAll(map1);
        map.putAll(map2);
        return shrunk(map);
    }
    ...
    public  UpdatableQHashSeparateKVByteIntMapGO newUpdatableMap(
            Consumer<net.openhft.koloboke.function.ByteIntConsumer> entriesSupplier,
            int expectedSize) {
        final UpdatableQHashSeparateKVByteIntMapGO map = newUpdatableMap(expectedSize);
        entriesSupplier.accept(new net.openhft.koloboke.function.ByteIntConsumer() {
             @Override
    ...
    @Nonnull
    public  UpdatableQHashSeparateKVByteIntMapGO newUpdatableMap(
            Iterable<Byte> keys, Iterable<Integer> values) {
    ...
    @Nonnull
    public  UpdatableQHashSeparateKVByteIntMapGO newUpdatableMap(
            Iterable<Byte> keys, Iterable<Integer> values, int expectedSize) {
        UpdatableQHashSeparateKVByteIntMapGO map = newUpdatableMap(expectedSize);
    ...
    @Override
    @Nonnull
    public  UpdatableQHashSeparateKVByteIntMapGO newUpdatableMapOf(
            byte k1, int v1) {
        UpdatableQHashSeparateKVByteIntMapGO map = newUpdatableMap(1);
        map.put(k1, v1);
        return map;
    }
    ...
    public  UpdatableQHashSeparateKVByteIntMapGO newUpdatableMapOf(
        ...
        UpdatableQHashSeparateKVByteIntMapGO map = newUpdatableMap(2);
        map.put(k1, v1);
        map.put(k2, v2);
        return map;
    }
    ...
    public  UpdatableQHashSeparateKVByteIntMapGO newUpdatableMapOf(
            byte k1, int v1, byte k2, int v2,
            byte k3, int v3) {
        UpdatableQHashSeparateKVByteIntMapGO map = newUpdatableMap(3);
        map.put(k1, v1);
        map.put(k2, v2);
        map.put(k3, v3);
        return map;
    ...
    public  UpdatableQHashSeparateKVByteIntMapGO newUpdatableMapOf(
        ...
        UpdatableQHashSeparateKVByteIntMapGO map = newUpdatableMap(4);
        map.put(k1, v1);
        map.put(k2, v2);
        map.put(k3, v3);
        map.put(k4, v4);
    ...
    public  UpdatableQHashSeparateKVByteIntMapGO newUpdatableMapOf(
            ...
            byte k3, int v3, byte k4, int v4,
            byte k5, int v5) {
        UpdatableQHashSeparateKVByteIntMapGO map = newUpdatableMap(5);
        map.put(k1, v1);
        map.put(k2, v2);
        map.put(k3, v3);
        map.put(k4, v4);
    ...
    public  HashByteIntMap newMutableMap(Map<Byte, Integer> map1,
        ...
        MutableQHashSeparateKVByteIntMapGO res = uninitializedMutableMap();
    ...
    public  HashByteIntMap newImmutableMap(Map<Byte, Integer> map1,
            Map<Byte, Integer> map2, int expectedSize) {
        ImmutableQHashSeparateKVByteIntMapGO res = uninitializedImmutableMap();
        res.move(newUpdatableMap(map1, map2, expectedSize));
        return res;
    }
    ...
    public  HashByteIntMap newImmutableMap(
            Consumer<net.openhft.koloboke.function.ByteIntConsumer> entriesSupplier
            , int expectedSize) {
        ImmutableQHashSeparateKVByteIntMapGO map = uninitializedImmutableMap();
        map.move(newUpdatableMap(entriesSupplier, expectedSize));
        return map;
    }
