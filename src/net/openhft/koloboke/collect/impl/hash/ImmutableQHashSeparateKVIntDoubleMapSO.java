...
public abstract class ImmutableQHashSeparateKVIntDoubleMapSO
        extends ImmutableQHashSeparateKVIntKeyMap
        implements HashIntDoubleMap, InternalIntDoubleMapOps, SeparateKVIntDoubleQHash {

    long[] values;

    void copy(SeparateKVIntDoubleQHash hash) {
        super.copy(hash);
        values = hash.valueArray().clone();
    }

    void move(SeparateKVIntDoubleQHash hash) {
        super.move(hash);
