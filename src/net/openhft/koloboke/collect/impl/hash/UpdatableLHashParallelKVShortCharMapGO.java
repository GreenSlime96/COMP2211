...
public class UpdatableLHashParallelKVShortCharMapGO
        extends UpdatableLHashParallelKVShortCharMapSO {
    ...
    class EntryView extends AbstractSetView<Map.Entry<Short, Character>>
        ...
        public HashConfig hashConfig() {
            return UpdatableLHashParallelKVShortCharMapGO.this.hashConfig();
        }


        @Override
        public int size() {
            return UpdatableLHashParallelKVShortCharMapGO.this.size();
        }

        @Override
        public double currentLoad() {
            return UpdatableLHashParallelKVShortCharMapGO.this.currentLoad();
        }
        ...
        public int hashCode() {
            return UpdatableLHashParallelKVShortCharMapGO.this.hashCode();
        }
        ...
        public boolean shrink() {
            return UpdatableLHashParallelKVShortCharMapGO.this.shrink();
        }
        ...
        public boolean remove(Object o) {
            try {
                ...
                return UpdatableLHashParallelKVShortCharMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
        ...
        @Override
        public void clear() {
            UpdatableLHashParallelKVShortCharMapGO.this.clear();
        }
    }
    ...
    class ValueView extends AbstractCharValueView {
        ...
        @Override
        public boolean contains(Object o) {
            return UpdatableLHashParallelKVShortCharMapGO.this.containsValue(o);
        }

        @Override
        public boolean contains(char v) {
            return UpdatableLHashParallelKVShortCharMapGO.this.containsValue(v);
        }
