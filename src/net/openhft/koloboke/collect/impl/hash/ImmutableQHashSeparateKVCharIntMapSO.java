...
public abstract class ImmutableQHashSeparateKVCharIntMapSO
        extends ImmutableQHashSeparateKVCharKeyMap
        implements HashCharIntMap, InternalCharIntMapOps, SeparateKVCharIntQHash {

    int[] values;

    void copy(SeparateKVCharIntQHash hash) {
        super.copy(hash);
        values = hash.valueArray().clone();
    }

    void move(SeparateKVCharIntQHash hash) {
        super.move(hash);
