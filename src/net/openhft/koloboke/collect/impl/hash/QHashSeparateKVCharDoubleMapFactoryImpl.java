...
public final class QHashSeparateKVCharDoubleMapFactoryImpl
        extends QHashSeparateKVCharDoubleMapFactoryGO {
    ...
    QHashSeparateKVCharDoubleMapFactoryImpl(HashConfig hashConf, int defaultExpectedSize, char lower, char upper) {
    ...
    static final class WithCustomDefaultValue
        ...
        @Override
         MutableQHashSeparateKVCharDoubleMapGO uninitializedMutableMap() {
            MutableQHashSeparateKVCharDoubleMap.WithCustomDefaultValue map =
                    new MutableQHashSeparateKVCharDoubleMap.WithCustomDefaultValue();
            map.defaultValue = defaultValue;
            return map;
        }
        @Override
         UpdatableQHashSeparateKVCharDoubleMapGO uninitializedUpdatableMap() {
            UpdatableQHashSeparateKVCharDoubleMap.WithCustomDefaultValue map =
                    new UpdatableQHashSeparateKVCharDoubleMap.WithCustomDefaultValue();
            map.defaultValue = defaultValue;
            return map;
        }
        @Override
         ImmutableQHashSeparateKVCharDoubleMapGO uninitializedImmutableMap() {
            ImmutableQHashSeparateKVCharDoubleMap.WithCustomDefaultValue map =
                    new ImmutableQHashSeparateKVCharDoubleMap.WithCustomDefaultValue();
            map.defaultValue = defaultValue;
            return map;
        }
        ...
        public HashCharDoubleMapFactory withDefaultValue(double defaultValue) {
            if (defaultValue == 0.0)
                return new QHashSeparateKVCharDoubleMapFactoryImpl(getHashConfig(), getDefaultExpectedSize()
