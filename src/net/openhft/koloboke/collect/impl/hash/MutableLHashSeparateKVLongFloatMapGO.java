...
public class MutableLHashSeparateKVLongFloatMapGO
        extends MutableLHashSeparateKVLongFloatMapSO {
    ...
    class EntryView extends AbstractSetView<Map.Entry<Long, Float>>
        ...
        public HashConfig hashConfig() {
            return MutableLHashSeparateKVLongFloatMapGO.this.hashConfig();
        }


        @Override
        public int size() {
            return MutableLHashSeparateKVLongFloatMapGO.this.size();
        }

        @Override
        public double currentLoad() {
            return MutableLHashSeparateKVLongFloatMapGO.this.currentLoad();
        }
        ...
        public int hashCode() {
            return MutableLHashSeparateKVLongFloatMapGO.this.hashCode();
        }
        ...
        public boolean shrink() {
            return MutableLHashSeparateKVLongFloatMapGO.this.shrink();
        }
        ...
        public boolean remove(Object o) {
            try {
                ...
                return MutableLHashSeparateKVLongFloatMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
        ...
        @Override
        public void clear() {
            MutableLHashSeparateKVLongFloatMapGO.this.clear();
        }
    }
    ...
    class ValueView extends AbstractFloatValueView {
        ...
        @Override
        public boolean contains(Object o) {
            return MutableLHashSeparateKVLongFloatMapGO.this.containsValue(o);
        }

        @Override
        public boolean contains(float v) {
            return MutableLHashSeparateKVLongFloatMapGO.this.containsValue(v);
        }

        @Override
        public boolean contains(int bits) {
            return MutableLHashSeparateKVLongFloatMapGO.this.containsValue(bits);
        }
