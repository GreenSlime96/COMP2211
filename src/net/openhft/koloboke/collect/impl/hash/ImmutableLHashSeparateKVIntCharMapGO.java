...
public class ImmutableLHashSeparateKVIntCharMapGO
        extends ImmutableLHashSeparateKVIntCharMapSO {
    ...
    class EntryView extends AbstractSetView<Map.Entry<Integer, Character>>
        ...
        public HashConfig hashConfig() {
            return ImmutableLHashSeparateKVIntCharMapGO.this.hashConfig();
        }


        @Override
        public int size() {
            return ImmutableLHashSeparateKVIntCharMapGO.this.size();
        }

        @Override
        public double currentLoad() {
            return ImmutableLHashSeparateKVIntCharMapGO.this.currentLoad();
        }
        ...
        public int hashCode() {
            return ImmutableLHashSeparateKVIntCharMapGO.this.hashCode();
        }
        ...
        public boolean shrink() {
            return ImmutableLHashSeparateKVIntCharMapGO.this.shrink();
        }
        ...
        public boolean remove(Object o) {
            try {
                ...
                return ImmutableLHashSeparateKVIntCharMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
        ...
        @Override
        public void clear() {
            ImmutableLHashSeparateKVIntCharMapGO.this.clear();
        }
    }
    ...
    private class ImmutableEntry extends IntCharEntry {
    ...
    class ValueView extends AbstractCharValueView {
        ...
        @Override
        public boolean contains(Object o) {
            return ImmutableLHashSeparateKVIntCharMapGO.this.containsValue(o);
        }

        @Override
        public boolean contains(char v) {
            return ImmutableLHashSeparateKVIntCharMapGO.this.containsValue(v);
        }
