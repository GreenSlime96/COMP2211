...
public class ImmutableQHashSeparateKVIntObjMapGO<V>
        extends ImmutableQHashSeparateKVIntObjMapSO<V> {
    ...
    class EntryView extends AbstractSetView<Map.Entry<Integer, V>>
        ...
        public HashConfig hashConfig() {
            return ImmutableQHashSeparateKVIntObjMapGO.this.hashConfig();
        }


        @Override
        public int size() {
            return ImmutableQHashSeparateKVIntObjMapGO.this.size();
        }

        @Override
        public double currentLoad() {
            return ImmutableQHashSeparateKVIntObjMapGO.this.currentLoad();
        }
        ...
        public int hashCode() {
            return ImmutableQHashSeparateKVIntObjMapGO.this.hashCode();
        }
        ...
        public boolean shrink() {
            return ImmutableQHashSeparateKVIntObjMapGO.this.shrink();
        }
        ...
        public boolean remove(Object o) {
            try {
                ...
                int key = e.getKey();
                V value = e.getValue();
                return ImmutableQHashSeparateKVIntObjMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
        ...
        @Override
        public void clear() {
            ImmutableQHashSeparateKVIntObjMapGO.this.clear();
        }
    }
    ...
    class ValueView extends AbstractObjValueView<V> {
        ...
        @Override
        public boolean contains(Object o) {
            return ImmutableQHashSeparateKVIntObjMapGO.this.containsValue(o);
        }
