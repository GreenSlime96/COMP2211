...
public class MutableQHashParallelKVDoubleDoubleMapGO
        extends MutableQHashParallelKVDoubleDoubleMapSO {
    ...
    class EntryView extends AbstractSetView<Map.Entry<Double, Double>>
        ...
        public HashConfig hashConfig() {
            return MutableQHashParallelKVDoubleDoubleMapGO.this.hashConfig();
        }


        @Override
        public int size() {
            return MutableQHashParallelKVDoubleDoubleMapGO.this.size();
        }

        @Override
        public double currentLoad() {
            return MutableQHashParallelKVDoubleDoubleMapGO.this.currentLoad();
        }
        ...
        public int hashCode() {
            return MutableQHashParallelKVDoubleDoubleMapGO.this.hashCode();
        }
        ...
        public boolean shrink() {
            return MutableQHashParallelKVDoubleDoubleMapGO.this.shrink();
        }
        ...
        public boolean remove(Object o) {
            try {
                ...
                return MutableQHashParallelKVDoubleDoubleMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
        ...
        @Override
        public void clear() {
            MutableQHashParallelKVDoubleDoubleMapGO.this.clear();
        }
    }
    ...
    class ValueView extends AbstractDoubleValueView {
        ...
        @Override
        public boolean contains(Object o) {
            return MutableQHashParallelKVDoubleDoubleMapGO.this.containsValue(o);
        }

        @Override
        public boolean contains(double v) {
            return MutableQHashParallelKVDoubleDoubleMapGO.this.containsValue(v);
        }

        @Override
        public boolean contains(long bits) {
            return MutableQHashParallelKVDoubleDoubleMapGO.this.containsValue(bits);
        }
    ...
    class SomeRemovedEntryIterator implements ObjIterator<Map.Entry<Double, Double>> {
        final long[] tab;
        int expectedModCount;
        int index = -1;
        int nextIndex;
    ...
    class SomeRemovedEntryCursor implements ObjCursor<Map.Entry<Double, Double>> {
        final long[] tab;
        int expectedModCount;
        int index;
        long curKey;
    ...
    class SomeRemovedMapCursor implements DoubleDoubleCursor {
        final long[] tab;
        int expectedModCount;
        int index;
        long curKey;
