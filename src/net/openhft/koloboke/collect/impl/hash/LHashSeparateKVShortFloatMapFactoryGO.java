...
public abstract class LHashSeparateKVShortFloatMapFactoryGO
        extends LHashSeparateKVShortFloatMapFactorySO {

    LHashSeparateKVShortFloatMapFactoryGO(HashConfig hashConf, int defaultExpectedSize
    ...
    private  UpdatableLHashSeparateKVShortFloatMapGO shrunk(
            UpdatableLHashSeparateKVShortFloatMapGO map) {
    ...
    @Override
    @Nonnull
    public  MutableLHashSeparateKVShortFloatMapGO newMutableMap() {
    ...
    public  UpdatableLHashSeparateKVShortFloatMapGO newUpdatableMap(
            Map<Short, Float> map1, Map<Short, Float> map2,
            int expectedSize) {
        UpdatableLHashSeparateKVShortFloatMapGO map = newUpdatableMap(expectedSize);
        map.putAll(map1);
        map.putAll(map2);
        return shrunk(map);
    }
    ...
    public  UpdatableLHashSeparateKVShortFloatMapGO newUpdatableMap(
            Consumer<net.openhft.koloboke.function.ShortFloatConsumer> entriesSupplier,
            int expectedSize) {
        final UpdatableLHashSeparateKVShortFloatMapGO map = newUpdatableMap(expectedSize);
    ...
    @Override
    @Nonnull
    public  UpdatableLHashSeparateKVShortFloatMapGO newUpdatableMapOf(
            short k1, float v1) {
        UpdatableLHashSeparateKVShortFloatMapGO map = newUpdatableMap(1);
        map.put(k1, v1);
        return map;
    }
    ...
    public  UpdatableLHashSeparateKVShortFloatMapGO newUpdatableMapOf(
        ...
        UpdatableLHashSeparateKVShortFloatMapGO map = newUpdatableMap(2);
        map.put(k1, v1);
        map.put(k2, v2);
        return map;
    }
    ...
    public  UpdatableLHashSeparateKVShortFloatMapGO newUpdatableMapOf(
            short k1, float v1, short k2, float v2,
            short k3, float v3) {
        UpdatableLHashSeparateKVShortFloatMapGO map = newUpdatableMap(3);
        map.put(k1, v1);
        map.put(k2, v2);
        map.put(k3, v3);
        return map;
    ...
    public  UpdatableLHashSeparateKVShortFloatMapGO newUpdatableMapOf(
        ...
        UpdatableLHashSeparateKVShortFloatMapGO map = newUpdatableMap(4);
        map.put(k1, v1);
        map.put(k2, v2);
        map.put(k3, v3);
        map.put(k4, v4);
    ...
    public  UpdatableLHashSeparateKVShortFloatMapGO newUpdatableMapOf(
            ...
            short k3, float v3, short k4, float v4,
            short k5, float v5) {
        UpdatableLHashSeparateKVShortFloatMapGO map = newUpdatableMap(5);
        map.put(k1, v1);
        map.put(k2, v2);
        map.put(k3, v3);
        map.put(k4, v4);
    ...
    public  HashShortFloatMap newMutableMap(Map<Short, Float> map1,
        ...
        MutableLHashSeparateKVShortFloatMapGO res = uninitializedMutableMap();
    ...
    public  HashShortFloatMap newImmutableMap(Map<Short, Float> map1,
            Map<Short, Float> map2, int expectedSize) {
        ImmutableLHashSeparateKVShortFloatMapGO res = uninitializedImmutableMap();
        res.move(newUpdatableMap(map1, map2, expectedSize));
        return res;
    }
    ...
    public  HashShortFloatMap newImmutableMap(
            Consumer<net.openhft.koloboke.function.ShortFloatConsumer> entriesSupplier
            , int expectedSize) {
        ImmutableLHashSeparateKVShortFloatMapGO map = uninitializedImmutableMap();
        map.move(newUpdatableMap(entriesSupplier, expectedSize));
        return map;
    }
