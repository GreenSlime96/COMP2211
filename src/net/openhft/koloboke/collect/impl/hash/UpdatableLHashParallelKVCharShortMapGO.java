...
public class UpdatableLHashParallelKVCharShortMapGO
        extends UpdatableLHashParallelKVCharShortMapSO {
    ...
    class EntryView extends AbstractSetView<Map.Entry<Character, Short>>
        ...
        public HashConfig hashConfig() {
            return UpdatableLHashParallelKVCharShortMapGO.this.hashConfig();
        }


        @Override
        public int size() {
            return UpdatableLHashParallelKVCharShortMapGO.this.size();
        }

        @Override
        public double currentLoad() {
            return UpdatableLHashParallelKVCharShortMapGO.this.currentLoad();
        }
        ...
        public int hashCode() {
            return UpdatableLHashParallelKVCharShortMapGO.this.hashCode();
        }
        ...
        public boolean shrink() {
            return UpdatableLHashParallelKVCharShortMapGO.this.shrink();
        }
        ...
        public boolean remove(Object o) {
            try {
                ...
                return UpdatableLHashParallelKVCharShortMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
        ...
        @Override
        public void clear() {
            UpdatableLHashParallelKVCharShortMapGO.this.clear();
        }
    }
    ...
    class ValueView extends AbstractShortValueView {
        ...
        @Override
        public boolean contains(Object o) {
            return UpdatableLHashParallelKVCharShortMapGO.this.containsValue(o);
        }

        @Override
        public boolean contains(short v) {
            return UpdatableLHashParallelKVCharShortMapGO.this.containsValue(v);
        }
