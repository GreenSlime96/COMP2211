...
public abstract class UpdatableLHash extends HashWithoutRemovedSlots implements LHash {
     ...
     * in {@code UpdatableLHash} from {@link #initForRehash(int)} and
     ...
     * in {@code UpdatableLHash} from {@link #postInsertHook()}, {@link #ensureCapacity(long)}
     ...
     *
     * <p>It is UpdatableLHash's concern in order to treat edge cases of capacities near to Java
