...
public final class LHashParallelKVDoubleLongMapFactoryImpl
        extends LHashParallelKVDoubleLongMapFactoryGO {
    ...
    LHashParallelKVDoubleLongMapFactoryImpl(HashConfig hashConf, int defaultExpectedSize) {
    ...
    static final class WithCustomDefaultValue
        ...
        @Override
         MutableLHashParallelKVDoubleLongMapGO uninitializedMutableMap() {
            MutableLHashParallelKVDoubleLongMap.WithCustomDefaultValue map =
                    new MutableLHashParallelKVDoubleLongMap.WithCustomDefaultValue();
            map.defaultValue = defaultValue;
            return map;
        }
        @Override
         UpdatableLHashParallelKVDoubleLongMapGO uninitializedUpdatableMap() {
            UpdatableLHashParallelKVDoubleLongMap.WithCustomDefaultValue map =
                    new UpdatableLHashParallelKVDoubleLongMap.WithCustomDefaultValue();
            map.defaultValue = defaultValue;
            return map;
        }
        @Override
         ImmutableLHashParallelKVDoubleLongMapGO uninitializedImmutableMap() {
            ImmutableLHashParallelKVDoubleLongMap.WithCustomDefaultValue map =
                    new ImmutableLHashParallelKVDoubleLongMap.WithCustomDefaultValue();
            map.defaultValue = defaultValue;
            return map;
        }
        ...
        public HashDoubleLongMapFactory withDefaultValue(long defaultValue) {
            if (defaultValue == 0L)
                return new LHashParallelKVDoubleLongMapFactoryImpl(getHashConfig(), getDefaultExpectedSize()
        );
