...
public class UpdatableLHashParallelKVLongDoubleMapGO
        extends UpdatableLHashParallelKVLongDoubleMapSO {
    ...
    class EntryView extends AbstractSetView<Map.Entry<Long, Double>>
        ...
        public HashConfig hashConfig() {
            return UpdatableLHashParallelKVLongDoubleMapGO.this.hashConfig();
        }


        @Override
        public int size() {
            return UpdatableLHashParallelKVLongDoubleMapGO.this.size();
        }

        @Override
        public double currentLoad() {
            return UpdatableLHashParallelKVLongDoubleMapGO.this.currentLoad();
        }
        ...
        public int hashCode() {
            return UpdatableLHashParallelKVLongDoubleMapGO.this.hashCode();
        }
        ...
        public boolean shrink() {
            return UpdatableLHashParallelKVLongDoubleMapGO.this.shrink();
        }
        ...
        public boolean remove(Object o) {
            try {
                ...
                return UpdatableLHashParallelKVLongDoubleMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
        ...
        @Override
        public void clear() {
            UpdatableLHashParallelKVLongDoubleMapGO.this.clear();
        }
    }
    ...
    class ValueView extends AbstractDoubleValueView {
        ...
        @Override
        public boolean contains(Object o) {
            return UpdatableLHashParallelKVLongDoubleMapGO.this.containsValue(o);
        }

        @Override
        public boolean contains(double v) {
            return UpdatableLHashParallelKVLongDoubleMapGO.this.containsValue(v);
        }

        @Override
        public boolean contains(long bits) {
            return UpdatableLHashParallelKVLongDoubleMapGO.this.containsValue(bits);
        }
