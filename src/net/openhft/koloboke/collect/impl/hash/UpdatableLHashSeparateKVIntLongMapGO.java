...
public class UpdatableLHashSeparateKVIntLongMapGO
        extends UpdatableLHashSeparateKVIntLongMapSO {
    ...
    class EntryView extends AbstractSetView<Map.Entry<Integer, Long>>
        ...
        public boolean remove(Object o) {
            try {
                ...
                return UpdatableLHashSeparateKVIntLongMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
    ...
    class ValueView extends AbstractLongValueView {
        ...
        @Override
        public boolean contains(Object o) {
            return UpdatableLHashSeparateKVIntLongMapGO.this.containsValue(o);
        }

        @Override
        public boolean contains(long v) {
            return UpdatableLHashSeparateKVIntLongMapGO.this.containsValue(v);
        }
