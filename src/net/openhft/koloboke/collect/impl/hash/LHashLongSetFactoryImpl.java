...
public final class LHashLongSetFactoryImpl extends LHashLongSetFactoryGO {
    ...
    public LHashLongSetFactoryImpl(HashConfig hashConf, int defaultExpectedSize
    ...
    HashLongSetFactory withDomain(long lower, long upper) {
        if (lower == getLowerKeyDomainBound() && upper == getUpperKeyDomainBound())
            return this;
        return new LHashLongSetFactoryImpl(getHashConfig(), getDefaultExpectedSize(), lower, upper);
    }
