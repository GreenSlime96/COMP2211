...
public class MutableLHashSeparateKVObjByteMapGO<K>
        extends MutableLHashSeparateKVObjByteMapSO<K> {
    ...
    class EntryView extends AbstractSetView<Map.Entry<K, Byte>>
        ...
        public HashConfig hashConfig() {
            return MutableLHashSeparateKVObjByteMapGO.this.hashConfig();
        }


        @Override
        public int size() {
            return MutableLHashSeparateKVObjByteMapGO.this.size();
        }

        @Override
        public double currentLoad() {
            return MutableLHashSeparateKVObjByteMapGO.this.currentLoad();
        }
        ...
        public int hashCode() {
            return MutableLHashSeparateKVObjByteMapGO.this.hashCode();
        }
        ...
        public boolean shrink() {
            return MutableLHashSeparateKVObjByteMapGO.this.shrink();
        }
        ...
        public boolean remove(Object o) {
            try {
                ...
                return MutableLHashSeparateKVObjByteMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
        ...
        @Override
        public void clear() {
            MutableLHashSeparateKVObjByteMapGO.this.clear();
        }
    }
    ...
    class ValueView extends AbstractByteValueView {
        ...
        @Override
        public boolean contains(Object o) {
            return MutableLHashSeparateKVObjByteMapGO.this.containsValue(o);
        }

        @Override
        public boolean contains(byte v) {
            return MutableLHashSeparateKVObjByteMapGO.this.containsValue(v);
        }
    ...
    class NoRemovedEntryIterator implements ObjIterator<Map.Entry<K, Byte>> {
        ...
        class MutableEntry2 extends MutableEntry {
            MutableEntry2(int modCount, int index, K key, byte value) {
