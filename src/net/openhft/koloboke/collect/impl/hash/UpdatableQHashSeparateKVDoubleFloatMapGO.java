...
public class UpdatableQHashSeparateKVDoubleFloatMapGO
        extends UpdatableQHashSeparateKVDoubleFloatMapSO {
    ...
    class EntryView extends AbstractSetView<Map.Entry<Double, Float>>
        ...
        public boolean remove(Object o) {
            try {
                ...
                return UpdatableQHashSeparateKVDoubleFloatMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
    ...
    class ValueView extends AbstractFloatValueView {
        ...
        @Override
        public boolean contains(Object o) {
            return UpdatableQHashSeparateKVDoubleFloatMapGO.this.containsValue(o);
        }

        @Override
        public boolean contains(float v) {
            return UpdatableQHashSeparateKVDoubleFloatMapGO.this.containsValue(v);
        }

        @Override
        public boolean contains(int bits) {
            return UpdatableQHashSeparateKVDoubleFloatMapGO.this.containsValue(bits);
        }
