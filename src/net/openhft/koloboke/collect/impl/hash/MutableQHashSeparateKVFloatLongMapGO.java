...
public class MutableQHashSeparateKVFloatLongMapGO
    ...
    class SomeRemovedEntryIterator implements ObjIterator<Map.Entry<Float, Long>> {
        final int[] keys;
        final long[] vals;
        int expectedModCount;
        int index = -1;
    ...
    class SomeRemovedEntryCursor implements ObjCursor<Map.Entry<Float, Long>> {
        final int[] keys;
        final long[] vals;
        int expectedModCount;
        int index;
    ...
    class SomeRemovedMapCursor implements FloatLongCursor {
        final int[] keys;
        final long[] vals;
        int expectedModCount;
        int index;
