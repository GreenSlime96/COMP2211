...
public class ImmutableLHashSeparateKVFloatObjMapGO<V>
        extends ImmutableLHashSeparateKVFloatObjMapSO<V> {
    ...
    class EntryView extends AbstractSetView<Map.Entry<Float, V>>
        ...
        public HashConfig hashConfig() {
            return ImmutableLHashSeparateKVFloatObjMapGO.this.hashConfig();
        }


        @Override
        public int size() {
            return ImmutableLHashSeparateKVFloatObjMapGO.this.size();
        }

        @Override
        public double currentLoad() {
            return ImmutableLHashSeparateKVFloatObjMapGO.this.currentLoad();
        }
        ...
        public int hashCode() {
            return ImmutableLHashSeparateKVFloatObjMapGO.this.hashCode();
        }
        ...
        public boolean shrink() {
            return ImmutableLHashSeparateKVFloatObjMapGO.this.shrink();
        }
        ...
        public boolean remove(Object o) {
            try {
                ...
                float key = e.getKey();
                V value = e.getValue();
                return ImmutableLHashSeparateKVFloatObjMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
        ...
        @Override
        public void clear() {
            ImmutableLHashSeparateKVFloatObjMapGO.this.clear();
        }
    }
    ...
    class ValueView extends AbstractObjValueView<V> {
        ...
        @Override
        public boolean contains(Object o) {
            return ImmutableLHashSeparateKVFloatObjMapGO.this.containsValue(o);
        }
