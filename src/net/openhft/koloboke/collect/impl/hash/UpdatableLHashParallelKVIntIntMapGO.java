...
public class UpdatableLHashParallelKVIntIntMapGO
        extends UpdatableLHashParallelKVIntIntMapSO {
    ...
    class EntryView extends AbstractSetView<Map.Entry<Integer, Integer>>
        ...
        public HashConfig hashConfig() {
            return UpdatableLHashParallelKVIntIntMapGO.this.hashConfig();
        }


        @Override
        public int size() {
            return UpdatableLHashParallelKVIntIntMapGO.this.size();
        }

        @Override
        public double currentLoad() {
            return UpdatableLHashParallelKVIntIntMapGO.this.currentLoad();
        }
        ...
        public int hashCode() {
            return UpdatableLHashParallelKVIntIntMapGO.this.hashCode();
        }
        ...
        public boolean shrink() {
            return UpdatableLHashParallelKVIntIntMapGO.this.shrink();
        }
        ...
        public boolean remove(Object o) {
            try {
                ...
                return UpdatableLHashParallelKVIntIntMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
        ...
        @Override
        public void clear() {
            UpdatableLHashParallelKVIntIntMapGO.this.clear();
        }
    }
    ...
    class ValueView extends AbstractIntValueView {
        ...
        @Override
        public boolean contains(Object o) {
            return UpdatableLHashParallelKVIntIntMapGO.this.containsValue(o);
        }

        @Override
        public boolean contains(int v) {
            return UpdatableLHashParallelKVIntIntMapGO.this.containsValue(v);
        }
