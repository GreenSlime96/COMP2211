...
public class MutableQHashSeparateKVByteObjMapGO<V>
    ...
    // under this condition - operations, overridden from MutableSeparateKVByteQHashGO
    ...
    class SomeRemovedEntryIterator implements ObjIterator<Map.Entry<Byte, V>> {
        final byte[] keys;
        final V[] vals;
        final byte free;
        final byte removed;
    ...
    class SomeRemovedEntryCursor implements ObjCursor<Map.Entry<Byte, V>> {
        final byte[] keys;
        final V[] vals;
        final byte free;
        final byte removed;
    ...
    class SomeRemovedMapCursor implements ByteObjCursor<V> {
        final byte[] keys;
        final V[] vals;
        final byte free;
        final byte removed;
