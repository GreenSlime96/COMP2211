...
public abstract class MutableParallelKVDoubleQHashGO
        extends MutableParallelKVDoubleQHashSO {
    ...
    class SomeRemovedIterator implements DoubleIterator {
        final long[] tab;
        int expectedModCount;
        int index = -1;
        int nextIndex;
    ...
    class SomeRemovedCursor implements DoubleCursor {
        final long[] tab;
        int expectedModCount;
        int index;
        long curKey;
