...
public class UpdatableLHashSeparateKVFloatShortMapGO
        extends UpdatableLHashSeparateKVFloatShortMapSO {
    ...
    class EntryView extends AbstractSetView<Map.Entry<Float, Short>>
        ...
        public HashConfig hashConfig() {
            return UpdatableLHashSeparateKVFloatShortMapGO.this.hashConfig();
        }


        @Override
        public int size() {
            return UpdatableLHashSeparateKVFloatShortMapGO.this.size();
        }

        @Override
        public double currentLoad() {
            return UpdatableLHashSeparateKVFloatShortMapGO.this.currentLoad();
        }
        ...
        public int hashCode() {
            return UpdatableLHashSeparateKVFloatShortMapGO.this.hashCode();
        }
        ...
        public boolean shrink() {
            return UpdatableLHashSeparateKVFloatShortMapGO.this.shrink();
        }
        ...
        public boolean remove(Object o) {
            try {
                ...
                return UpdatableLHashSeparateKVFloatShortMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
        ...
        @Override
        public void clear() {
            UpdatableLHashSeparateKVFloatShortMapGO.this.clear();
        }
    }
    ...
    class ValueView extends AbstractShortValueView {
        ...
        @Override
        public boolean contains(Object o) {
            return UpdatableLHashSeparateKVFloatShortMapGO.this.containsValue(o);
        }

        @Override
        public boolean contains(short v) {
            return UpdatableLHashSeparateKVFloatShortMapGO.this.containsValue(v);
        }
