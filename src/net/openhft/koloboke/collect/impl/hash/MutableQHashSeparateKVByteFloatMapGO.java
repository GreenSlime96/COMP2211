...
public class MutableQHashSeparateKVByteFloatMapGO
        extends MutableQHashSeparateKVByteFloatMapSO {
    ...
    class EntryView extends AbstractSetView<Map.Entry<Byte, Float>>
        ...
        public HashConfig hashConfig() {
            return MutableQHashSeparateKVByteFloatMapGO.this.hashConfig();
        }


        @Override
        public int size() {
            return MutableQHashSeparateKVByteFloatMapGO.this.size();
        }

        @Override
        public double currentLoad() {
            return MutableQHashSeparateKVByteFloatMapGO.this.currentLoad();
        }
        ...
        public int hashCode() {
            return MutableQHashSeparateKVByteFloatMapGO.this.hashCode();
        }
        ...
        public boolean shrink() {
            return MutableQHashSeparateKVByteFloatMapGO.this.shrink();
        }
        ...
        public boolean remove(Object o) {
            try {
                ...
                return MutableQHashSeparateKVByteFloatMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
        ...
        @Override
        public void clear() {
            MutableQHashSeparateKVByteFloatMapGO.this.clear();
        }
    }
    ...
    class ValueView extends AbstractFloatValueView {
        ...
        @Override
        public boolean contains(Object o) {
            return MutableQHashSeparateKVByteFloatMapGO.this.containsValue(o);
        }

        @Override
        public boolean contains(float v) {
            return MutableQHashSeparateKVByteFloatMapGO.this.containsValue(v);
        }

        @Override
        public boolean contains(int bits) {
            return MutableQHashSeparateKVByteFloatMapGO.this.containsValue(bits);
        }
    ...
    class SomeRemovedEntryIterator implements ObjIterator<Map.Entry<Byte, Float>> {
        final byte[] keys;
        final int[] vals;
        final byte free;
        final byte removed;
    ...
    class SomeRemovedEntryCursor implements ObjCursor<Map.Entry<Byte, Float>> {
        final byte[] keys;
        final int[] vals;
        final byte free;
        final byte removed;
    ...
    class SomeRemovedMapCursor implements ByteFloatCursor {
        final byte[] keys;
        final int[] vals;
        final byte free;
        final byte removed;
