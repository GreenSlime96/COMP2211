...
public abstract class LHashSeparateKVFloatCharMapFactoryGO
        extends LHashSeparateKVFloatCharMapFactorySO {

    LHashSeparateKVFloatCharMapFactoryGO(HashConfig hashConf, int defaultExpectedSize
            ) {
    ...
    private  UpdatableLHashSeparateKVFloatCharMapGO shrunk(
            UpdatableLHashSeparateKVFloatCharMapGO map) {
    ...
    @Override
    @Nonnull
    public  MutableLHashSeparateKVFloatCharMapGO newMutableMap() {
    ...
    public  UpdatableLHashSeparateKVFloatCharMapGO newUpdatableMap(
            Map<Float, Character> map1, Map<Float, Character> map2,
            int expectedSize) {
        UpdatableLHashSeparateKVFloatCharMapGO map = newUpdatableMap(expectedSize);
        map.putAll(map1);
        map.putAll(map2);
        return shrunk(map);
    }
    ...
    public  UpdatableLHashSeparateKVFloatCharMapGO newUpdatableMap(
            Consumer<net.openhft.koloboke.function.FloatCharConsumer> entriesSupplier,
            int expectedSize) {
        final UpdatableLHashSeparateKVFloatCharMapGO map = newUpdatableMap(expectedSize);
    ...
    @Override
    @Nonnull
    public  UpdatableLHashSeparateKVFloatCharMapGO newUpdatableMapOf(
            float k1, char v1) {
        UpdatableLHashSeparateKVFloatCharMapGO map = newUpdatableMap(1);
        map.put(k1, v1);
        return map;
    }
    ...
    public  UpdatableLHashSeparateKVFloatCharMapGO newUpdatableMapOf(
        ...
        UpdatableLHashSeparateKVFloatCharMapGO map = newUpdatableMap(2);
        map.put(k1, v1);
        map.put(k2, v2);
        return map;
    }
    ...
    public  UpdatableLHashSeparateKVFloatCharMapGO newUpdatableMapOf(
            float k1, char v1, float k2, char v2,
            float k3, char v3) {
        UpdatableLHashSeparateKVFloatCharMapGO map = newUpdatableMap(3);
        map.put(k1, v1);
        map.put(k2, v2);
        map.put(k3, v3);
        return map;
    ...
    public  UpdatableLHashSeparateKVFloatCharMapGO newUpdatableMapOf(
        ...
        UpdatableLHashSeparateKVFloatCharMapGO map = newUpdatableMap(4);
        map.put(k1, v1);
        map.put(k2, v2);
        map.put(k3, v3);
        map.put(k4, v4);
    ...
    public  UpdatableLHashSeparateKVFloatCharMapGO newUpdatableMapOf(
            ...
            float k3, char v3, float k4, char v4,
            float k5, char v5) {
        UpdatableLHashSeparateKVFloatCharMapGO map = newUpdatableMap(5);
        map.put(k1, v1);
        map.put(k2, v2);
        map.put(k3, v3);
        map.put(k4, v4);
    ...
    public  HashFloatCharMap newMutableMap(Map<Float, Character> map1,
        ...
        MutableLHashSeparateKVFloatCharMapGO res = uninitializedMutableMap();
    ...
    public  HashFloatCharMap newImmutableMap(Map<Float, Character> map1,
            Map<Float, Character> map2, int expectedSize) {
        ImmutableLHashSeparateKVFloatCharMapGO res = uninitializedImmutableMap();
        res.move(newUpdatableMap(map1, map2, expectedSize));
        return res;
    }
    ...
    public  HashFloatCharMap newImmutableMap(
            Consumer<net.openhft.koloboke.function.FloatCharConsumer> entriesSupplier
            , int expectedSize) {
        ImmutableLHashSeparateKVFloatCharMapGO map = uninitializedImmutableMap();
        map.move(newUpdatableMap(entriesSupplier, expectedSize));
        return map;
    }
