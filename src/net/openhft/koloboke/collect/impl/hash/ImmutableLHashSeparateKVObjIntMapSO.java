...
public abstract class ImmutableLHashSeparateKVObjIntMapSO<K>
        extends ImmutableLHashSeparateKVObjKeyMap<K>
        implements HashObjIntMap<K>, InternalObjIntMapOps<K>, SeparateKVObjIntLHash {

    int[] values;

    void copy(SeparateKVObjIntLHash hash) {
        super.copy(hash);
        values = hash.valueArray().clone();
    }

    void move(SeparateKVObjIntLHash hash) {
        super.move(hash);
