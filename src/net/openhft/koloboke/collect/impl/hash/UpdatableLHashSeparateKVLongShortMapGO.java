...
public class UpdatableLHashSeparateKVLongShortMapGO
        extends UpdatableLHashSeparateKVLongShortMapSO {
    ...
    class EntryView extends AbstractSetView<Map.Entry<Long, Short>>
        ...
        public HashConfig hashConfig() {
            return UpdatableLHashSeparateKVLongShortMapGO.this.hashConfig();
        }


        @Override
        public int size() {
            return UpdatableLHashSeparateKVLongShortMapGO.this.size();
        }

        @Override
        public double currentLoad() {
            return UpdatableLHashSeparateKVLongShortMapGO.this.currentLoad();
        }
        ...
        public int hashCode() {
            return UpdatableLHashSeparateKVLongShortMapGO.this.hashCode();
        }
        ...
        public boolean shrink() {
            return UpdatableLHashSeparateKVLongShortMapGO.this.shrink();
        }
        ...
        public boolean remove(Object o) {
            try {
                ...
                return UpdatableLHashSeparateKVLongShortMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
        ...
        @Override
        public void clear() {
            UpdatableLHashSeparateKVLongShortMapGO.this.clear();
        }
    }
    ...
    class MutableEntry extends LongShortEntry {
        final int modCount;
    ...
    class ValueView extends AbstractShortValueView {
        ...
        @Override
        public boolean contains(Object o) {
            return UpdatableLHashSeparateKVLongShortMapGO.this.containsValue(o);
        }

        @Override
        public boolean contains(short v) {
            return UpdatableLHashSeparateKVLongShortMapGO.this.containsValue(v);
        }
