...
public class UpdatableQHashSeparateKVDoubleCharMapGO
        extends UpdatableQHashSeparateKVDoubleCharMapSO {
    ...
    class EntryView extends AbstractSetView<Map.Entry<Double, Character>>
        ...
        public boolean remove(Object o) {
            try {
                ...
                return UpdatableQHashSeparateKVDoubleCharMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
    ...
    class ValueView extends AbstractCharValueView {
        ...
        @Override
        public boolean contains(Object o) {
            return UpdatableQHashSeparateKVDoubleCharMapGO.this.containsValue(o);
        }

        @Override
        public boolean contains(char v) {
            return UpdatableQHashSeparateKVDoubleCharMapGO.this.containsValue(v);
        }
