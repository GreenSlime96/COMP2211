...
public class MutableQHashSeparateKVIntObjMapGO<V>
    ...
    // under this condition - operations, overridden from MutableSeparateKVIntQHashGO
    ...
    class SomeRemovedEntryIterator implements ObjIterator<Map.Entry<Integer, V>> {
        final int[] keys;
        final V[] vals;
        final int free;
        final int removed;
    ...
    class SomeRemovedEntryCursor implements ObjCursor<Map.Entry<Integer, V>> {
        final int[] keys;
        final V[] vals;
        final int free;
        final int removed;
    ...
    class SomeRemovedMapCursor implements IntObjCursor<V> {
        final int[] keys;
        final V[] vals;
        final int free;
        final int removed;
