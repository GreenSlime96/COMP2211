...
public abstract class UpdatableQHashSeparateKVIntObjMapSO<V>
        extends UpdatableQHashSeparateKVIntKeyMap
        implements HashIntObjMap<V>,
        InternalIntObjMapOps<V>, SeparateKVIntObjQHash {

    V[] values;

    void copy(SeparateKVIntObjQHash hash) {
        super.copy(hash);
        // noinspection unchecked
        values = (V[]) hash.valueArray().clone();
    }

    void move(SeparateKVIntObjQHash hash) {
        super.move(hash);
        // noinspection unchecked
