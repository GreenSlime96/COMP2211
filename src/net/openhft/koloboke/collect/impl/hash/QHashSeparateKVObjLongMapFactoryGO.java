...
public abstract class QHashSeparateKVObjLongMapFactoryGO<K>
        extends QHashSeparateKVObjLongMapFactorySO<K> {

    QHashSeparateKVObjLongMapFactoryGO(HashConfig hashConf, int defaultExpectedSize
    ...
    private <K2 extends K>
     UpdatableQHashSeparateKVObjLongMapGO<K2> shrunk(
            UpdatableQHashSeparateKVObjLongMapGO<K2> map) {
    ...
    public <K2 extends K>
     UpdatableQHashSeparateKVObjLongMapGO<K2> newUpdatableMap(
            Map<? extends K2, Long> map1, Map<? extends K2, Long> map2,
            int expectedSize) {
        UpdatableQHashSeparateKVObjLongMapGO<K2> map = newUpdatableMap(expectedSize);
        map.putAll(map1);
        map.putAll(map2);
        return shrunk(map);
    }
    ...
    public <K2 extends K>
     UpdatableQHashSeparateKVObjLongMapGO<K2> newUpdatableMap(
            Consumer<net.openhft.koloboke.function.ObjLongConsumer<K2>> entriesSupplier,
            int expectedSize) {
        final UpdatableQHashSeparateKVObjLongMapGO<K2> map = newUpdatableMap(expectedSize);
    ...
    @Nonnull
    public <K2 extends K>
     UpdatableQHashSeparateKVObjLongMapGO<K2> newUpdatableMapOf(
            K2 k1, long v1) {
        UpdatableQHashSeparateKVObjLongMapGO<K2> map = newUpdatableMap(1);
        map.put(k1, v1);
        return map;
    }
    ...
    public <K2 extends K>
     UpdatableQHashSeparateKVObjLongMapGO<K2> newUpdatableMapOf(
        ...
        UpdatableQHashSeparateKVObjLongMapGO<K2> map = newUpdatableMap(2);
        map.put(k1, v1);
        map.put(k2, v2);
        return map;
    }
    ...
    public <K2 extends K>
     UpdatableQHashSeparateKVObjLongMapGO<K2> newUpdatableMapOf(
            K2 k1, long v1, K2 k2, long v2,
            K2 k3, long v3) {
        UpdatableQHashSeparateKVObjLongMapGO<K2> map = newUpdatableMap(3);
        map.put(k1, v1);
        map.put(k2, v2);
        map.put(k3, v3);
        return map;
    ...
    public <K2 extends K>
     UpdatableQHashSeparateKVObjLongMapGO<K2> newUpdatableMapOf(
        ...
        UpdatableQHashSeparateKVObjLongMapGO<K2> map = newUpdatableMap(4);
        map.put(k1, v1);
        map.put(k2, v2);
        map.put(k3, v3);
        map.put(k4, v4);
    ...
    public <K2 extends K>
     UpdatableQHashSeparateKVObjLongMapGO<K2> newUpdatableMapOf(
            ...
            K2 k3, long v3, K2 k4, long v4,
            K2 k5, long v5) {
        UpdatableQHashSeparateKVObjLongMapGO<K2> map = newUpdatableMap(5);
        map.put(k1, v1);
        map.put(k2, v2);
        map.put(k3, v3);
        map.put(k4, v4);
    ...
    public <K2 extends K>
     HashObjLongMap<K2> newMutableMap(
            Map<? extends K2, Long> map, int expectedSize) {
        MutableQHashSeparateKVObjLongMapGO<K2> res = uninitializedMutableMap();
    ...
    public <K2 extends K>
     HashObjLongMap<K2> newImmutableMap(
            Map<? extends K2, Long> map, int expectedSize) {
        ImmutableQHashSeparateKVObjLongMapGO<K2> res = uninitializedImmutableMap();
        res.move(newUpdatableMap(map, expectedSize));
        return res;
    }
    ...
    public <K2 extends K>
     HashObjLongMap<K2> newImmutableMap(
            Consumer<net.openhft.koloboke.function.ObjLongConsumer<K2>> entriesSupplier
            , int expectedSize) {
        ImmutableQHashSeparateKVObjLongMapGO<K2> map = uninitializedImmutableMap();
        map.move(newUpdatableMap(entriesSupplier, expectedSize));
        return map;
    }
