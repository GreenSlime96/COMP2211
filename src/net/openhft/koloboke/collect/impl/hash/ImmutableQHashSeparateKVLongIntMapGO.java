...
public class ImmutableQHashSeparateKVLongIntMapGO
        extends ImmutableQHashSeparateKVLongIntMapSO {
    ...
    class EntryView extends AbstractSetView<Map.Entry<Long, Integer>>
        ...
        public HashConfig hashConfig() {
            return ImmutableQHashSeparateKVLongIntMapGO.this.hashConfig();
        }


        @Override
        public int size() {
            return ImmutableQHashSeparateKVLongIntMapGO.this.size();
        }

        @Override
        public double currentLoad() {
            return ImmutableQHashSeparateKVLongIntMapGO.this.currentLoad();
        }
        ...
        public int hashCode() {
            return ImmutableQHashSeparateKVLongIntMapGO.this.hashCode();
        }
        ...
        public boolean shrink() {
            return ImmutableQHashSeparateKVLongIntMapGO.this.shrink();
        }
        ...
        public boolean remove(Object o) {
            try {
                ...
                return ImmutableQHashSeparateKVLongIntMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
        ...
        @Override
        public void clear() {
            ImmutableQHashSeparateKVLongIntMapGO.this.clear();
        }
    }
    ...
    class ValueView extends AbstractIntValueView {
        ...
        @Override
        public boolean contains(Object o) {
            return ImmutableQHashSeparateKVLongIntMapGO.this.containsValue(o);
        }

        @Override
        public boolean contains(int v) {
            return ImmutableQHashSeparateKVLongIntMapGO.this.containsValue(v);
        }
