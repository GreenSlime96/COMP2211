...
public class UpdatableQHashParallelKVByteByteMapGO
        extends UpdatableQHashParallelKVByteByteMapSO {
    ...
    class EntryView extends AbstractSetView<Map.Entry<Byte, Byte>>
        ...
        public HashConfig hashConfig() {
            return UpdatableQHashParallelKVByteByteMapGO.this.hashConfig();
        }


        @Override
        public int size() {
            return UpdatableQHashParallelKVByteByteMapGO.this.size();
        }

        @Override
        public double currentLoad() {
            return UpdatableQHashParallelKVByteByteMapGO.this.currentLoad();
        }
        ...
        public int hashCode() {
            return UpdatableQHashParallelKVByteByteMapGO.this.hashCode();
        }
        ...
        public boolean shrink() {
            return UpdatableQHashParallelKVByteByteMapGO.this.shrink();
        }
        ...
        public boolean remove(Object o) {
            try {
                ...
                return UpdatableQHashParallelKVByteByteMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
        ...
        @Override
        public void clear() {
            UpdatableQHashParallelKVByteByteMapGO.this.clear();
        }
    }
    ...
    class ValueView extends AbstractByteValueView {
        ...
        @Override
        public boolean contains(Object o) {
            return UpdatableQHashParallelKVByteByteMapGO.this.containsValue(o);
        }

        @Override
        public boolean contains(byte v) {
            return UpdatableQHashParallelKVByteByteMapGO.this.containsValue(v);
        }
