...
public class UpdatableLHashParallelKVObjObjMapGO<K, V>
        extends UpdatableLHashParallelKVObjObjMapSO<K, V> {
    ...
    class EntryView extends AbstractSetView<Map.Entry<K, V>>
        ...
        public boolean remove(Object o) {
            try {
                ...
                K key = e.getKey();
                V value = e.getValue();
                return UpdatableLHashParallelKVObjObjMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
    ...
    class ValueView extends AbstractObjValueView<V> {
        ...
        @Override
        public boolean contains(Object o) {
            return UpdatableLHashParallelKVObjObjMapGO.this.containsValue(o);
        }
