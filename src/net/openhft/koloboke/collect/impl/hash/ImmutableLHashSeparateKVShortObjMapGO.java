...
public class ImmutableLHashSeparateKVShortObjMapGO<V>
        extends ImmutableLHashSeparateKVShortObjMapSO<V> {
    ...
    class EntryView extends AbstractSetView<Map.Entry<Short, V>>
        ...
        public HashConfig hashConfig() {
            return ImmutableLHashSeparateKVShortObjMapGO.this.hashConfig();
        }


        @Override
        public int size() {
            return ImmutableLHashSeparateKVShortObjMapGO.this.size();
        }

        @Override
        public double currentLoad() {
            return ImmutableLHashSeparateKVShortObjMapGO.this.currentLoad();
        }
        ...
        public int hashCode() {
            return ImmutableLHashSeparateKVShortObjMapGO.this.hashCode();
        }
        ...
        public boolean shrink() {
            return ImmutableLHashSeparateKVShortObjMapGO.this.shrink();
        }
        ...
        public boolean remove(Object o) {
            try {
                ...
                short key = e.getKey();
                V value = e.getValue();
                return ImmutableLHashSeparateKVShortObjMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
        ...
        @Override
        public void clear() {
            ImmutableLHashSeparateKVShortObjMapGO.this.clear();
        }
    }
    ...
    private class ImmutableEntry extends ShortObjEntry {
    ...
    class ValueView extends AbstractObjValueView<V> {
        ...
        @Override
        public boolean contains(Object o) {
            return ImmutableLHashSeparateKVShortObjMapGO.this.containsValue(o);
        }
