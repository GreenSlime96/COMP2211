...
public class UpdatableQHashSeparateKVDoubleIntMapGO
        extends UpdatableQHashSeparateKVDoubleIntMapSO {
    ...
    class EntryView extends AbstractSetView<Map.Entry<Double, Integer>>
        ...
        public boolean remove(Object o) {
            try {
                ...
                return UpdatableQHashSeparateKVDoubleIntMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
    ...
    class ValueView extends AbstractIntValueView {
        ...
        @Override
        public boolean contains(Object o) {
            return UpdatableQHashSeparateKVDoubleIntMapGO.this.containsValue(o);
        }

        @Override
        public boolean contains(int v) {
            return UpdatableQHashSeparateKVDoubleIntMapGO.this.containsValue(v);
        }
