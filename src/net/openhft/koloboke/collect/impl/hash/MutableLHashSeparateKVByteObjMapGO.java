...
public class MutableLHashSeparateKVByteObjMapGO<V>
        extends MutableLHashSeparateKVByteObjMapSO<V> {
    ...
    class EntryView extends AbstractSetView<Map.Entry<Byte, V>>
        ...
        public HashConfig hashConfig() {
            return MutableLHashSeparateKVByteObjMapGO.this.hashConfig();
        }


        @Override
        public int size() {
            return MutableLHashSeparateKVByteObjMapGO.this.size();
        }

        @Override
        public double currentLoad() {
            return MutableLHashSeparateKVByteObjMapGO.this.currentLoad();
        }
        ...
        public int hashCode() {
            return MutableLHashSeparateKVByteObjMapGO.this.hashCode();
        }
        ...
        public boolean shrink() {
            return MutableLHashSeparateKVByteObjMapGO.this.shrink();
        }
        ...
        public boolean remove(Object o) {
            try {
                ...
                byte key = e.getKey();
                V value = e.getValue();
                return MutableLHashSeparateKVByteObjMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
        ...
        @Override
        public void clear() {
            MutableLHashSeparateKVByteObjMapGO.this.clear();
        }
    }
    ...
    class ValueView extends AbstractObjValueView<V> {
        ...
        @Override
        public boolean contains(Object o) {
            return MutableLHashSeparateKVByteObjMapGO.this.containsValue(o);
        }
    ...
    class NoRemovedEntryIterator implements ObjIterator<Map.Entry<Byte, V>> {
        ...
        class MutableEntry2 extends MutableEntry {
            MutableEntry2(int modCount, int index, byte key, V value) {
