...
public abstract class ImmutableQHashSeparateKVByteLongMapSO
        extends ImmutableQHashSeparateKVByteKeyMap
        implements HashByteLongMap, InternalByteLongMapOps, SeparateKVByteLongQHash {

    long[] values;

    void copy(SeparateKVByteLongQHash hash) {
        super.copy(hash);
        values = hash.valueArray().clone();
    }

    void move(SeparateKVByteLongQHash hash) {
        super.move(hash);
