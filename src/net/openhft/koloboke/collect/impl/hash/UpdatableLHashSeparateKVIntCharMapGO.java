...
public class UpdatableLHashSeparateKVIntCharMapGO
        extends UpdatableLHashSeparateKVIntCharMapSO {
    ...
    class EntryView extends AbstractSetView<Map.Entry<Integer, Character>>
        ...
        public HashConfig hashConfig() {
            return UpdatableLHashSeparateKVIntCharMapGO.this.hashConfig();
        }


        @Override
        public int size() {
            return UpdatableLHashSeparateKVIntCharMapGO.this.size();
        }

        @Override
        public double currentLoad() {
            return UpdatableLHashSeparateKVIntCharMapGO.this.currentLoad();
        }
        ...
        public int hashCode() {
            return UpdatableLHashSeparateKVIntCharMapGO.this.hashCode();
        }
        ...
        public boolean shrink() {
            return UpdatableLHashSeparateKVIntCharMapGO.this.shrink();
        }
        ...
        public boolean remove(Object o) {
            try {
                ...
                return UpdatableLHashSeparateKVIntCharMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
        ...
        @Override
        public void clear() {
            UpdatableLHashSeparateKVIntCharMapGO.this.clear();
        }
    }
    ...
    class ValueView extends AbstractCharValueView {
        ...
        @Override
        public boolean contains(Object o) {
            return UpdatableLHashSeparateKVIntCharMapGO.this.containsValue(o);
        }

        @Override
        public boolean contains(char v) {
            return UpdatableLHashSeparateKVIntCharMapGO.this.containsValue(v);
        }
