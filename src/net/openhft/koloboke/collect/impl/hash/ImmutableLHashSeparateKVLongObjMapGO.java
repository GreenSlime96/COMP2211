...
public class ImmutableLHashSeparateKVLongObjMapGO<V>
        extends ImmutableLHashSeparateKVLongObjMapSO<V> {
    ...
    class EntryView extends AbstractSetView<Map.Entry<Long, V>>
        ...
        public HashConfig hashConfig() {
            return ImmutableLHashSeparateKVLongObjMapGO.this.hashConfig();
        }


        @Override
        public int size() {
            return ImmutableLHashSeparateKVLongObjMapGO.this.size();
        }

        @Override
        public double currentLoad() {
            return ImmutableLHashSeparateKVLongObjMapGO.this.currentLoad();
        }
        ...
        public int hashCode() {
            return ImmutableLHashSeparateKVLongObjMapGO.this.hashCode();
        }
        ...
        public boolean shrink() {
            return ImmutableLHashSeparateKVLongObjMapGO.this.shrink();
        }
        ...
        public boolean remove(Object o) {
            try {
                ...
                long key = e.getKey();
                V value = e.getValue();
                return ImmutableLHashSeparateKVLongObjMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
        ...
        @Override
        public void clear() {
            ImmutableLHashSeparateKVLongObjMapGO.this.clear();
        }
    }
    ...
    class ValueView extends AbstractObjValueView<V> {
        ...
        @Override
        public boolean contains(Object o) {
            return ImmutableLHashSeparateKVLongObjMapGO.this.containsValue(o);
        }
