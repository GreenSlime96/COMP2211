...
public class UpdatableLHashSeparateKVByteShortMapGO
        extends UpdatableLHashSeparateKVByteShortMapSO {
    ...
    class EntryView extends AbstractSetView<Map.Entry<Byte, Short>>
        ...
        public HashConfig hashConfig() {
            return UpdatableLHashSeparateKVByteShortMapGO.this.hashConfig();
        }


        @Override
        public int size() {
            return UpdatableLHashSeparateKVByteShortMapGO.this.size();
        }

        @Override
        public double currentLoad() {
            return UpdatableLHashSeparateKVByteShortMapGO.this.currentLoad();
        }
        ...
        public int hashCode() {
            return UpdatableLHashSeparateKVByteShortMapGO.this.hashCode();
        }
        ...
        public boolean shrink() {
            return UpdatableLHashSeparateKVByteShortMapGO.this.shrink();
        }
        ...
        public boolean remove(Object o) {
            try {
                ...
                return UpdatableLHashSeparateKVByteShortMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
        ...
        @Override
        public void clear() {
            UpdatableLHashSeparateKVByteShortMapGO.this.clear();
        }
    }
    ...
    class ValueView extends AbstractShortValueView {
        ...
        @Override
        public boolean contains(Object o) {
            return UpdatableLHashSeparateKVByteShortMapGO.this.containsValue(o);
        }

        @Override
        public boolean contains(short v) {
            return UpdatableLHashSeparateKVByteShortMapGO.this.containsValue(v);
        }
