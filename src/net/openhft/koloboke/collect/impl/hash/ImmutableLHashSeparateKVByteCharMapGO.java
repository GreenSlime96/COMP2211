...
public class ImmutableLHashSeparateKVByteCharMapGO
        extends ImmutableLHashSeparateKVByteCharMapSO {
    ...
    class EntryView extends AbstractSetView<Map.Entry<Byte, Character>>
        ...
        public HashConfig hashConfig() {
            return ImmutableLHashSeparateKVByteCharMapGO.this.hashConfig();
        }


        @Override
        public int size() {
            return ImmutableLHashSeparateKVByteCharMapGO.this.size();
        }

        @Override
        public double currentLoad() {
            return ImmutableLHashSeparateKVByteCharMapGO.this.currentLoad();
        }
        ...
        public int hashCode() {
            return ImmutableLHashSeparateKVByteCharMapGO.this.hashCode();
        }
        ...
        public boolean shrink() {
            return ImmutableLHashSeparateKVByteCharMapGO.this.shrink();
        }
        ...
        public boolean remove(Object o) {
            try {
                ...
                return ImmutableLHashSeparateKVByteCharMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
        ...
        @Override
        public void clear() {
            ImmutableLHashSeparateKVByteCharMapGO.this.clear();
        }
    }
    ...
    class ValueView extends AbstractCharValueView {
        ...
        @Override
        public boolean contains(Object o) {
            return ImmutableLHashSeparateKVByteCharMapGO.this.containsValue(o);
        }

        @Override
        public boolean contains(char v) {
            return ImmutableLHashSeparateKVByteCharMapGO.this.containsValue(v);
        }
