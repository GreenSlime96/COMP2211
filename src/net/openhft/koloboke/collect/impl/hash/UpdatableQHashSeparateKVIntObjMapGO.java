...
public class UpdatableQHashSeparateKVIntObjMapGO<V>
        extends UpdatableQHashSeparateKVIntObjMapSO<V> {
    ...
    class EntryView extends AbstractSetView<Map.Entry<Integer, V>>
        ...
        public HashConfig hashConfig() {
            return UpdatableQHashSeparateKVIntObjMapGO.this.hashConfig();
        }


        @Override
        public int size() {
            return UpdatableQHashSeparateKVIntObjMapGO.this.size();
        }

        @Override
        public double currentLoad() {
            return UpdatableQHashSeparateKVIntObjMapGO.this.currentLoad();
        }
        ...
        public int hashCode() {
            return UpdatableQHashSeparateKVIntObjMapGO.this.hashCode();
        }
        ...
        public boolean shrink() {
            return UpdatableQHashSeparateKVIntObjMapGO.this.shrink();
        }
        ...
        public boolean remove(Object o) {
            try {
                ...
                int key = e.getKey();
                V value = e.getValue();
                return UpdatableQHashSeparateKVIntObjMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
        ...
        @Override
        public void clear() {
            UpdatableQHashSeparateKVIntObjMapGO.this.clear();
        }
    }
    ...
    class ValueView extends AbstractObjValueView<V> {
        ...
        @Override
        public boolean contains(Object o) {
            return UpdatableQHashSeparateKVIntObjMapGO.this.containsValue(o);
        }
