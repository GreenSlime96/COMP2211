...
public class UpdatableQHashSeparateKVShortDoubleMapGO
        extends UpdatableQHashSeparateKVShortDoubleMapSO {
    ...
    class EntryView extends AbstractSetView<Map.Entry<Short, Double>>
        ...
        public HashConfig hashConfig() {
            return UpdatableQHashSeparateKVShortDoubleMapGO.this.hashConfig();
        }


        @Override
        public int size() {
            return UpdatableQHashSeparateKVShortDoubleMapGO.this.size();
        }

        @Override
        public double currentLoad() {
            return UpdatableQHashSeparateKVShortDoubleMapGO.this.currentLoad();
        }
        ...
        public int hashCode() {
            return UpdatableQHashSeparateKVShortDoubleMapGO.this.hashCode();
        }
        ...
        public boolean shrink() {
            return UpdatableQHashSeparateKVShortDoubleMapGO.this.shrink();
        }
        ...
        public boolean remove(Object o) {
            try {
                ...
                return UpdatableQHashSeparateKVShortDoubleMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
        ...
        @Override
        public void clear() {
            UpdatableQHashSeparateKVShortDoubleMapGO.this.clear();
        }
    }
    ...
    class ValueView extends AbstractDoubleValueView {
        ...
        @Override
        public boolean contains(Object o) {
            return UpdatableQHashSeparateKVShortDoubleMapGO.this.containsValue(o);
        }

        @Override
        public boolean contains(double v) {
            return UpdatableQHashSeparateKVShortDoubleMapGO.this.containsValue(v);
        }

        @Override
        public boolean contains(long bits) {
            return UpdatableQHashSeparateKVShortDoubleMapGO.this.containsValue(bits);
        }
