...
public class ImmutableLHashParallelKVDoubleLongMapGO
        extends ImmutableLHashParallelKVDoubleLongMapSO {
    ...
    class EntryView extends AbstractSetView<Map.Entry<Double, Long>>
        ...
        public HashConfig hashConfig() {
            return ImmutableLHashParallelKVDoubleLongMapGO.this.hashConfig();
        }


        @Override
        public int size() {
            return ImmutableLHashParallelKVDoubleLongMapGO.this.size();
        }

        @Override
        public double currentLoad() {
            return ImmutableLHashParallelKVDoubleLongMapGO.this.currentLoad();
        }
        ...
        public int hashCode() {
            return ImmutableLHashParallelKVDoubleLongMapGO.this.hashCode();
        }
        ...
        public boolean shrink() {
            return ImmutableLHashParallelKVDoubleLongMapGO.this.shrink();
        }
        ...
        public boolean remove(Object o) {
            try {
                ...
                return ImmutableLHashParallelKVDoubleLongMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
        ...
        @Override
        public void clear() {
            ImmutableLHashParallelKVDoubleLongMapGO.this.clear();
        }
    }
    ...
    class ValueView extends AbstractLongValueView {
        ...
        @Override
        public boolean contains(Object o) {
            return ImmutableLHashParallelKVDoubleLongMapGO.this.containsValue(o);
        }

        @Override
        public boolean contains(long v) {
            return ImmutableLHashParallelKVDoubleLongMapGO.this.containsValue(v);
        }
