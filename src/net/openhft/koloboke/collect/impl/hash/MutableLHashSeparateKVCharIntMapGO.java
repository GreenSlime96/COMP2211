...
public class MutableLHashSeparateKVCharIntMapGO
        extends MutableLHashSeparateKVCharIntMapSO {

    @Override
    final void copy(SeparateKVCharIntLHash hash) {
    ...
    @Override
    final void move(SeparateKVCharIntLHash hash) {
        int myMC = modCount(), hashMC = hash.modCount();
        super.move(hash);
        if (myMC != modCount() || hashMC != hash.modCount())
            throw new ConcurrentModificationException();
    ...
    class EntryView extends AbstractSetView<Map.Entry<Character, Integer>>
        ...
        public HashConfig hashConfig() {
            return MutableLHashSeparateKVCharIntMapGO.this.hashConfig();
        }


        @Override
        public int size() {
            return MutableLHashSeparateKVCharIntMapGO.this.size();
        }

        @Override
        public double currentLoad() {
            return MutableLHashSeparateKVCharIntMapGO.this.currentLoad();
        }
        ...
        public int hashCode() {
            return MutableLHashSeparateKVCharIntMapGO.this.hashCode();
        }
        ...
        public boolean shrink() {
            return MutableLHashSeparateKVCharIntMapGO.this.shrink();
        }
        ...
        public boolean remove(Object o) {
            try {
                ...
                return MutableLHashSeparateKVCharIntMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
        ...
        @Override
        public void clear() {
            MutableLHashSeparateKVCharIntMapGO.this.clear();
        }
    }
    ...
    class ValueView extends AbstractIntValueView {
        ...
        @Override
        public boolean contains(Object o) {
            return MutableLHashSeparateKVCharIntMapGO.this.containsValue(o);
        }

        @Override
        public boolean contains(int v) {
            return MutableLHashSeparateKVCharIntMapGO.this.containsValue(v);
        }
    ...
    class NoRemovedEntryIterator implements ObjIterator<Map.Entry<Character, Integer>> {
        ...
        class MutableEntry2 extends MutableEntry {
            MutableEntry2(int modCount, int index, char key, int value) {
