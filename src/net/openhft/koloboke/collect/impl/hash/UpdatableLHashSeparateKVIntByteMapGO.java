...
public class UpdatableLHashSeparateKVIntByteMapGO
        extends UpdatableLHashSeparateKVIntByteMapSO {
    ...
    class EntryView extends AbstractSetView<Map.Entry<Integer, Byte>>
        ...
        public HashConfig hashConfig() {
            return UpdatableLHashSeparateKVIntByteMapGO.this.hashConfig();
        }


        @Override
        public int size() {
            return UpdatableLHashSeparateKVIntByteMapGO.this.size();
        }

        @Override
        public double currentLoad() {
            return UpdatableLHashSeparateKVIntByteMapGO.this.currentLoad();
        }
        ...
        public int hashCode() {
            return UpdatableLHashSeparateKVIntByteMapGO.this.hashCode();
        }
        ...
        public boolean shrink() {
            return UpdatableLHashSeparateKVIntByteMapGO.this.shrink();
        }
        ...
        public boolean remove(Object o) {
            try {
                ...
                return UpdatableLHashSeparateKVIntByteMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
        ...
        @Override
        public void clear() {
            UpdatableLHashSeparateKVIntByteMapGO.this.clear();
        }
    }
    ...
    class ValueView extends AbstractByteValueView {
        ...
        @Override
        public boolean contains(Object o) {
            return UpdatableLHashSeparateKVIntByteMapGO.this.containsValue(o);
        }

        @Override
        public boolean contains(byte v) {
            return UpdatableLHashSeparateKVIntByteMapGO.this.containsValue(v);
        }
