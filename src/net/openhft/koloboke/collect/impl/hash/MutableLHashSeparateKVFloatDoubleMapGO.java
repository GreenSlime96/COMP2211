...
public class MutableLHashSeparateKVFloatDoubleMapGO
        extends MutableLHashSeparateKVFloatDoubleMapSO {
    ...
    public boolean removeIf(FloatDoublePredicate filter) {
        ...
        for (int i = keys.length - 1; i >= 0; i--) {
            int key;
            if ((key = keys[i]) < FREE_BITS) {
                if (filter.test(Float.intBitsToFloat(key), Double.longBitsToDouble(vals[i]))) {
                    incrementModCount();
                    mc++;
                    closeDeletion:
    ...
    class EntryView extends AbstractSetView<Map.Entry<Float, Double>>
        ...
        public HashConfig hashConfig() {
            return MutableLHashSeparateKVFloatDoubleMapGO.this.hashConfig();
        }


        @Override
        public int size() {
            return MutableLHashSeparateKVFloatDoubleMapGO.this.size();
        }

        @Override
        public double currentLoad() {
            return MutableLHashSeparateKVFloatDoubleMapGO.this.currentLoad();
        }
        ...
        public int hashCode() {
            return MutableLHashSeparateKVFloatDoubleMapGO.this.hashCode();
        }
        ...
        public boolean shrink() {
            return MutableLHashSeparateKVFloatDoubleMapGO.this.shrink();
        }
        ...
        public boolean remove(Object o) {
            try {
                ...
                return MutableLHashSeparateKVFloatDoubleMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
        ...
        @Override
        public void clear() {
            MutableLHashSeparateKVFloatDoubleMapGO.this.clear();
        }
    }
    ...
    class ValueView extends AbstractDoubleValueView {
        ...
        @Override
        public boolean contains(Object o) {
            return MutableLHashSeparateKVFloatDoubleMapGO.this.containsValue(o);
        }

        @Override
        public boolean contains(double v) {
            return MutableLHashSeparateKVFloatDoubleMapGO.this.containsValue(v);
        }

        @Override
        public boolean contains(long bits) {
            return MutableLHashSeparateKVFloatDoubleMapGO.this.containsValue(bits);
        }
