...
public class UpdatableQHashSeparateKVCharObjMapGO<V>
        extends UpdatableQHashSeparateKVCharObjMapSO<V> {
    ...
    class EntryView extends AbstractSetView<Map.Entry<Character, V>>
        ...
        public HashConfig hashConfig() {
            return UpdatableQHashSeparateKVCharObjMapGO.this.hashConfig();
        }


        @Override
        public int size() {
            return UpdatableQHashSeparateKVCharObjMapGO.this.size();
        }

        @Override
        public double currentLoad() {
            return UpdatableQHashSeparateKVCharObjMapGO.this.currentLoad();
        }
        ...
        public int hashCode() {
            return UpdatableQHashSeparateKVCharObjMapGO.this.hashCode();
        }
        ...
        public boolean shrink() {
            return UpdatableQHashSeparateKVCharObjMapGO.this.shrink();
        }
        ...
        public boolean remove(Object o) {
            try {
                ...
                char key = e.getKey();
                V value = e.getValue();
                return UpdatableQHashSeparateKVCharObjMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
        ...
        @Override
        public void clear() {
            UpdatableQHashSeparateKVCharObjMapGO.this.clear();
        }
    }
    ...
    class ValueView extends AbstractObjValueView<V> {
        ...
        @Override
        public boolean contains(Object o) {
            return UpdatableQHashSeparateKVCharObjMapGO.this.containsValue(o);
        }
