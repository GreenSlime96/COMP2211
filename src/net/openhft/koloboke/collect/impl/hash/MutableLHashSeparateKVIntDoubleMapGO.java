...
public class MutableLHashSeparateKVIntDoubleMapGO
        extends MutableLHashSeparateKVIntDoubleMapSO {
    ...
    class EntryView extends AbstractSetView<Map.Entry<Integer, Double>>
        ...
        public HashConfig hashConfig() {
            return MutableLHashSeparateKVIntDoubleMapGO.this.hashConfig();
        }


        @Override
        public int size() {
            return MutableLHashSeparateKVIntDoubleMapGO.this.size();
        }

        @Override
        public double currentLoad() {
            return MutableLHashSeparateKVIntDoubleMapGO.this.currentLoad();
        }
        ...
        public int hashCode() {
            return MutableLHashSeparateKVIntDoubleMapGO.this.hashCode();
        }
        ...
        public boolean shrink() {
            return MutableLHashSeparateKVIntDoubleMapGO.this.shrink();
        }
        ...
        public boolean remove(Object o) {
            try {
                ...
                return MutableLHashSeparateKVIntDoubleMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
        ...
        @Override
        public void clear() {
            MutableLHashSeparateKVIntDoubleMapGO.this.clear();
        }
    }
    ...
    class ValueView extends AbstractDoubleValueView {
        ...
        @Override
        public boolean contains(Object o) {
            return MutableLHashSeparateKVIntDoubleMapGO.this.containsValue(o);
        }

        @Override
        public boolean contains(double v) {
            return MutableLHashSeparateKVIntDoubleMapGO.this.containsValue(v);
        }

        @Override
        public boolean contains(long bits) {
            return MutableLHashSeparateKVIntDoubleMapGO.this.containsValue(bits);
        }
