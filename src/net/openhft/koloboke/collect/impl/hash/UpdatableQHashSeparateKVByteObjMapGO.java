...
public class UpdatableQHashSeparateKVByteObjMapGO<V>
        extends UpdatableQHashSeparateKVByteObjMapSO<V> {
    ...
    class EntryView extends AbstractSetView<Map.Entry<Byte, V>>
        ...
        public HashConfig hashConfig() {
            return UpdatableQHashSeparateKVByteObjMapGO.this.hashConfig();
        }


        @Override
        public int size() {
            return UpdatableQHashSeparateKVByteObjMapGO.this.size();
        }

        @Override
        public double currentLoad() {
            return UpdatableQHashSeparateKVByteObjMapGO.this.currentLoad();
        }
        ...
        public int hashCode() {
            return UpdatableQHashSeparateKVByteObjMapGO.this.hashCode();
        }
        ...
        public boolean shrink() {
            return UpdatableQHashSeparateKVByteObjMapGO.this.shrink();
        }
        ...
        public boolean remove(Object o) {
            try {
                ...
                byte key = e.getKey();
                V value = e.getValue();
                return UpdatableQHashSeparateKVByteObjMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
        ...
        @Override
        public void clear() {
            UpdatableQHashSeparateKVByteObjMapGO.this.clear();
        }
    }
    ...
    class ValueView extends AbstractObjValueView<V> {
        ...
        @Override
        public boolean contains(Object o) {
            return UpdatableQHashSeparateKVByteObjMapGO.this.containsValue(o);
        }
