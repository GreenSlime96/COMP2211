...
public class UpdatableQHashSeparateKVLongObjMapGO<V>
        extends UpdatableQHashSeparateKVLongObjMapSO<V> {
    ...
    class EntryView extends AbstractSetView<Map.Entry<Long, V>>
        ...
        public HashConfig hashConfig() {
            return UpdatableQHashSeparateKVLongObjMapGO.this.hashConfig();
        }


        @Override
        public int size() {
            return UpdatableQHashSeparateKVLongObjMapGO.this.size();
        }

        @Override
        public double currentLoad() {
            return UpdatableQHashSeparateKVLongObjMapGO.this.currentLoad();
        }
        ...
        public int hashCode() {
            return UpdatableQHashSeparateKVLongObjMapGO.this.hashCode();
        }
        ...
        public boolean shrink() {
            return UpdatableQHashSeparateKVLongObjMapGO.this.shrink();
        }
        ...
        public boolean remove(Object o) {
            try {
                ...
                long key = e.getKey();
                V value = e.getValue();
                return UpdatableQHashSeparateKVLongObjMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
        ...
        @Override
        public void clear() {
            UpdatableQHashSeparateKVLongObjMapGO.this.clear();
        }
    }
    ...
    class ValueView extends AbstractObjValueView<V> {
        ...
        @Override
        public boolean contains(Object o) {
            return UpdatableQHashSeparateKVLongObjMapGO.this.containsValue(o);
        }
