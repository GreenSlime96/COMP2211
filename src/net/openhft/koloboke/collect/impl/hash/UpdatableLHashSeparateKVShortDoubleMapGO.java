...
public class UpdatableLHashSeparateKVShortDoubleMapGO
        extends UpdatableLHashSeparateKVShortDoubleMapSO {
    ...
    class EntryView extends AbstractSetView<Map.Entry<Short, Double>>
        ...
        public HashConfig hashConfig() {
            return UpdatableLHashSeparateKVShortDoubleMapGO.this.hashConfig();
        }


        @Override
        public int size() {
            return UpdatableLHashSeparateKVShortDoubleMapGO.this.size();
        }

        @Override
        public double currentLoad() {
            return UpdatableLHashSeparateKVShortDoubleMapGO.this.currentLoad();
        }
        ...
        public int hashCode() {
            return UpdatableLHashSeparateKVShortDoubleMapGO.this.hashCode();
        }
        ...
        public boolean shrink() {
            return UpdatableLHashSeparateKVShortDoubleMapGO.this.shrink();
        }
        ...
        public boolean remove(Object o) {
            try {
                ...
                return UpdatableLHashSeparateKVShortDoubleMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
        ...
        @Override
        public void clear() {
            UpdatableLHashSeparateKVShortDoubleMapGO.this.clear();
        }
    }
    ...
    class ValueView extends AbstractDoubleValueView {
        ...
        @Override
        public boolean contains(Object o) {
            return UpdatableLHashSeparateKVShortDoubleMapGO.this.containsValue(o);
        }

        @Override
        public boolean contains(double v) {
            return UpdatableLHashSeparateKVShortDoubleMapGO.this.containsValue(v);
        }

        @Override
        public boolean contains(long bits) {
            return UpdatableLHashSeparateKVShortDoubleMapGO.this.containsValue(bits);
        }
