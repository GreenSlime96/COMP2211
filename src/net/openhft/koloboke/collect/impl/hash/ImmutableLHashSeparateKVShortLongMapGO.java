...
public class ImmutableLHashSeparateKVShortLongMapGO
        extends ImmutableLHashSeparateKVShortLongMapSO {
    ...
    class EntryView extends AbstractSetView<Map.Entry<Short, Long>>
        ...
        public HashConfig hashConfig() {
            return ImmutableLHashSeparateKVShortLongMapGO.this.hashConfig();
        }


        @Override
        public int size() {
            return ImmutableLHashSeparateKVShortLongMapGO.this.size();
        }

        @Override
        public double currentLoad() {
            return ImmutableLHashSeparateKVShortLongMapGO.this.currentLoad();
        }
        ...
        public int hashCode() {
            return ImmutableLHashSeparateKVShortLongMapGO.this.hashCode();
        }
        ...
        public boolean shrink() {
            return ImmutableLHashSeparateKVShortLongMapGO.this.shrink();
        }
        ...
        public boolean remove(Object o) {
            try {
                ...
                return ImmutableLHashSeparateKVShortLongMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
        ...
        @Override
        public void clear() {
            ImmutableLHashSeparateKVShortLongMapGO.this.clear();
        }
    }
    ...
    class ValueView extends AbstractLongValueView {
        ...
        @Override
        public boolean contains(Object o) {
            return ImmutableLHashSeparateKVShortLongMapGO.this.containsValue(o);
        }

        @Override
        public boolean contains(long v) {
            return ImmutableLHashSeparateKVShortLongMapGO.this.containsValue(v);
        }
