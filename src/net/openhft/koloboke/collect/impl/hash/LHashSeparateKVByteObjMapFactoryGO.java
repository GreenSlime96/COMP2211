...
public abstract class LHashSeparateKVByteObjMapFactoryGO<V>
        extends LHashSeparateKVByteObjMapFactorySO<V> {

    LHashSeparateKVByteObjMapFactoryGO(HashConfig hashConf, int defaultExpectedSize
...
;
    ...
    private <V2 extends V> UpdatableLHashSeparateKVByteObjMapGO<V2> shrunk(
            UpdatableLHashSeparateKVByteObjMapGO<V2> map) {
    ...
    @Override
    @Nonnull
    public <V2 extends V> MutableLHashSeparateKVByteObjMapGO<V2> newMutableMap() {
    ...
    public <V2 extends V> UpdatableLHashSeparateKVByteObjMapGO<V2> newUpdatableMap(
            Map<Byte, ? extends V2> map1, Map<Byte, ? extends V2> map2,
            int expectedSize) {
        UpdatableLHashSeparateKVByteObjMapGO<V2> map = newUpdatableMap(expectedSize);
        map.putAll(map1);
        map.putAll(map2);
        return shrunk(map);
    }
    ...
    public <V2 extends V> UpdatableLHashSeparateKVByteObjMapGO<V2> newUpdatableMap(
            Consumer<net.openhft.koloboke.function.ByteObjConsumer<V2>> entriesSupplier,
            int expectedSize) {
        final UpdatableLHashSeparateKVByteObjMapGO<V2> map = newUpdatableMap(expectedSize);
    ...
    @Override
    @Nonnull
    public <V2 extends V> UpdatableLHashSeparateKVByteObjMapGO<V2> newUpdatableMapOf(
            byte k1, V2 v1) {
        UpdatableLHashSeparateKVByteObjMapGO<V2> map = newUpdatableMap(1);
        map.put(k1, v1);
        return map;
    }
    ...
    public <V2 extends V> UpdatableLHashSeparateKVByteObjMapGO<V2> newUpdatableMapOf(
        ...
        UpdatableLHashSeparateKVByteObjMapGO<V2> map = newUpdatableMap(2);
        map.put(k1, v1);
        map.put(k2, v2);
        return map;
    }
    ...
    public <V2 extends V> UpdatableLHashSeparateKVByteObjMapGO<V2> newUpdatableMapOf(
            byte k1, V2 v1, byte k2, V2 v2,
            byte k3, V2 v3) {
        UpdatableLHashSeparateKVByteObjMapGO<V2> map = newUpdatableMap(3);
        map.put(k1, v1);
        map.put(k2, v2);
        map.put(k3, v3);
        return map;
    ...
    public <V2 extends V> UpdatableLHashSeparateKVByteObjMapGO<V2> newUpdatableMapOf(
        ...
        UpdatableLHashSeparateKVByteObjMapGO<V2> map = newUpdatableMap(4);
        map.put(k1, v1);
        map.put(k2, v2);
        map.put(k3, v3);
        map.put(k4, v4);
    ...
    public <V2 extends V> UpdatableLHashSeparateKVByteObjMapGO<V2> newUpdatableMapOf(
            ...
            byte k3, V2 v3, byte k4, V2 v4,
            byte k5, V2 v5) {
        UpdatableLHashSeparateKVByteObjMapGO<V2> map = newUpdatableMap(5);
        map.put(k1, v1);
        map.put(k2, v2);
        map.put(k3, v3);
        map.put(k4, v4);
    ...
    public <V2 extends V> HashByteObjMap<V2> newMutableMap(Map<Byte, ? extends V2> map1,
        ...
        MutableLHashSeparateKVByteObjMapGO<V2> res = uninitializedMutableMap();
    ...
    public <V2 extends V> HashByteObjMap<V2> newImmutableMap(Map<Byte, ? extends V2> map1,
            Map<Byte, ? extends V2> map2, int expectedSize) {
        ImmutableLHashSeparateKVByteObjMapGO<V2> res = uninitializedImmutableMap();
        res.move(newUpdatableMap(map1, map2, expectedSize));
        return res;
    }
    ...
    public <V2 extends V> HashByteObjMap<V2> newImmutableMap(
            Consumer<net.openhft.koloboke.function.ByteObjConsumer<V2>> entriesSupplier
            , int expectedSize) {
        ImmutableLHashSeparateKVByteObjMapGO<V2> map = uninitializedImmutableMap();
        map.move(newUpdatableMap(entriesSupplier, expectedSize));
        return map;
    }
