...
public abstract class LHashParallelKVObjObjMapFactoryGO<K, V>
        extends LHashParallelKVObjObjMapFactorySO<K, V> {

    LHashParallelKVObjObjMapFactoryGO(HashConfig hashConf, int defaultExpectedSize
...
;
    ...
    private <K2 extends K, V2 extends V> UpdatableLHashParallelKVObjObjMapGO<K2, V2> shrunk(
            UpdatableLHashParallelKVObjObjMapGO<K2, V2> map) {
    ...
    public <K2 extends K, V2 extends V> UpdatableLHashParallelKVObjObjMapGO<K2, V2> newUpdatableMap(
            Map<? extends K2, ? extends V2> map1, Map<? extends K2, ? extends V2> map2,
            int expectedSize) {
        UpdatableLHashParallelKVObjObjMapGO<K2, V2> map = newUpdatableMap(expectedSize);
        map.putAll(map1);
        map.putAll(map2);
        return shrunk(map);
    }
    ...
    public <K2 extends K, V2 extends V> UpdatableLHashParallelKVObjObjMapGO<K2, V2> newUpdatableMap(
            Consumer<net.openhft.koloboke.function.BiConsumer<K2, V2>> entriesSupplier,
            int expectedSize) {
        final UpdatableLHashParallelKVObjObjMapGO<K2, V2> map = newUpdatableMap(expectedSize);
    ...
    @Override
    @Nonnull
    public <K2 extends K, V2 extends V> UpdatableLHashParallelKVObjObjMapGO<K2, V2> newUpdatableMapOf(
            K2 k1, V2 v1) {
        UpdatableLHashParallelKVObjObjMapGO<K2, V2> map = newUpdatableMap(1);
        map.put(k1, v1);
        return map;
    }
    ...
    public <K2 extends K, V2 extends V> UpdatableLHashParallelKVObjObjMapGO<K2, V2> newUpdatableMapOf(
        ...
        UpdatableLHashParallelKVObjObjMapGO<K2, V2> map = newUpdatableMap(2);
        map.put(k1, v1);
        map.put(k2, v2);
        return map;
    }
    ...
    public <K2 extends K, V2 extends V> UpdatableLHashParallelKVObjObjMapGO<K2, V2> newUpdatableMapOf(
            K2 k1, V2 v1, K2 k2, V2 v2,
            K2 k3, V2 v3) {
        UpdatableLHashParallelKVObjObjMapGO<K2, V2> map = newUpdatableMap(3);
        map.put(k1, v1);
        map.put(k2, v2);
        map.put(k3, v3);
        return map;
    ...
    public <K2 extends K, V2 extends V> UpdatableLHashParallelKVObjObjMapGO<K2, V2> newUpdatableMapOf(
        ...
        UpdatableLHashParallelKVObjObjMapGO<K2, V2> map = newUpdatableMap(4);
        map.put(k1, v1);
        map.put(k2, v2);
        map.put(k3, v3);
        map.put(k4, v4);
    ...
    public <K2 extends K, V2 extends V> UpdatableLHashParallelKVObjObjMapGO<K2, V2> newUpdatableMapOf(
            ...
            K2 k3, V2 v3, K2 k4, V2 v4,
            K2 k5, V2 v5) {
        UpdatableLHashParallelKVObjObjMapGO<K2, V2> map = newUpdatableMap(5);
        map.put(k1, v1);
        map.put(k2, v2);
        map.put(k3, v3);
        map.put(k4, v4);
    ...
    public <K2 extends K, V2 extends V> HashObjObjMap<K2, V2> newMutableMap(
            Map<? extends K2, ? extends V2> map, int expectedSize) {
        MutableLHashParallelKVObjObjMapGO<K2, V2> res = uninitializedMutableMap();
    ...
    public <K2 extends K, V2 extends V> HashObjObjMap<K2, V2> newImmutableMap(
            Map<? extends K2, ? extends V2> map, int expectedSize) {
        ImmutableLHashParallelKVObjObjMapGO<K2, V2> res = uninitializedImmutableMap();
        res.move(newUpdatableMap(map, expectedSize));
        return res;
    }
    ...
    public <K2 extends K, V2 extends V> HashObjObjMap<K2, V2> newImmutableMap(
            Consumer<net.openhft.koloboke.function.BiConsumer<K2, V2>> entriesSupplier
            , int expectedSize) {
        ImmutableLHashParallelKVObjObjMapGO<K2, V2> map = uninitializedImmutableMap();
        map.move(newUpdatableMap(entriesSupplier, expectedSize));
        return map;
    }
