...
public class ImmutableQHashSeparateKVObjByteMapGO<K>
        extends ImmutableQHashSeparateKVObjByteMapSO<K> {
    ...
    class EntryView extends AbstractSetView<Map.Entry<K, Byte>>
        ...
        public HashConfig hashConfig() {
            return ImmutableQHashSeparateKVObjByteMapGO.this.hashConfig();
        }


        @Override
        public int size() {
            return ImmutableQHashSeparateKVObjByteMapGO.this.size();
        }

        @Override
        public double currentLoad() {
            return ImmutableQHashSeparateKVObjByteMapGO.this.currentLoad();
        }
        ...
        public int hashCode() {
            return ImmutableQHashSeparateKVObjByteMapGO.this.hashCode();
        }
        ...
        public boolean shrink() {
            return ImmutableQHashSeparateKVObjByteMapGO.this.shrink();
        }
        ...
        public boolean remove(Object o) {
            try {
                ...
                return ImmutableQHashSeparateKVObjByteMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
        ...
        @Override
        public void clear() {
            ImmutableQHashSeparateKVObjByteMapGO.this.clear();
        }
    }
    ...
    private class ImmutableEntry extends ObjByteEntry {
        private final K key;
        private final byte value;

        ImmutableEntry(K key, byte value) {
            this.key = key;
            this.value = value;
        }
    ...
    class ValueView extends AbstractByteValueView {
        ...
        @Override
        public boolean contains(Object o) {
            return ImmutableQHashSeparateKVObjByteMapGO.this.containsValue(o);
        }

        @Override
        public boolean contains(byte v) {
            return ImmutableQHashSeparateKVObjByteMapGO.this.containsValue(v);
        }
