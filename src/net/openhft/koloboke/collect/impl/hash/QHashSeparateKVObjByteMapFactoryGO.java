...
public abstract class QHashSeparateKVObjByteMapFactoryGO<K>
        extends QHashSeparateKVObjByteMapFactorySO<K> {

    QHashSeparateKVObjByteMapFactoryGO(HashConfig hashConf, int defaultExpectedSize
    ...
    private <K2 extends K>
     UpdatableQHashSeparateKVObjByteMapGO<K2> shrunk(
            UpdatableQHashSeparateKVObjByteMapGO<K2> map) {
    ...
    public <K2 extends K>
     UpdatableQHashSeparateKVObjByteMapGO<K2> newUpdatableMap(
            Map<? extends K2, Byte> map1, Map<? extends K2, Byte> map2,
            int expectedSize) {
        UpdatableQHashSeparateKVObjByteMapGO<K2> map = newUpdatableMap(expectedSize);
        map.putAll(map1);
        map.putAll(map2);
        return shrunk(map);
    }
    ...
    public <K2 extends K>
     UpdatableQHashSeparateKVObjByteMapGO<K2> newUpdatableMap(
            Consumer<net.openhft.koloboke.function.ObjByteConsumer<K2>> entriesSupplier,
            int expectedSize) {
        final UpdatableQHashSeparateKVObjByteMapGO<K2> map = newUpdatableMap(expectedSize);
    ...
    @Nonnull
    public <K2 extends K>
     UpdatableQHashSeparateKVObjByteMapGO<K2> newUpdatableMapOf(
            K2 k1, byte v1) {
        UpdatableQHashSeparateKVObjByteMapGO<K2> map = newUpdatableMap(1);
        map.put(k1, v1);
        return map;
    }
    ...
    public <K2 extends K>
     UpdatableQHashSeparateKVObjByteMapGO<K2> newUpdatableMapOf(
        ...
        UpdatableQHashSeparateKVObjByteMapGO<K2> map = newUpdatableMap(2);
        map.put(k1, v1);
        map.put(k2, v2);
        return map;
    }
    ...
    public <K2 extends K>
     UpdatableQHashSeparateKVObjByteMapGO<K2> newUpdatableMapOf(
            K2 k1, byte v1, K2 k2, byte v2,
            K2 k3, byte v3) {
        UpdatableQHashSeparateKVObjByteMapGO<K2> map = newUpdatableMap(3);
        map.put(k1, v1);
        map.put(k2, v2);
        map.put(k3, v3);
        return map;
    ...
    public <K2 extends K>
     UpdatableQHashSeparateKVObjByteMapGO<K2> newUpdatableMapOf(
        ...
        UpdatableQHashSeparateKVObjByteMapGO<K2> map = newUpdatableMap(4);
        map.put(k1, v1);
        map.put(k2, v2);
        map.put(k3, v3);
        map.put(k4, v4);
    ...
    public <K2 extends K>
     UpdatableQHashSeparateKVObjByteMapGO<K2> newUpdatableMapOf(
            ...
            K2 k3, byte v3, K2 k4, byte v4,
            K2 k5, byte v5) {
        UpdatableQHashSeparateKVObjByteMapGO<K2> map = newUpdatableMap(5);
        map.put(k1, v1);
        map.put(k2, v2);
        map.put(k3, v3);
        map.put(k4, v4);
    ...
    public <K2 extends K>
     HashObjByteMap<K2> newMutableMap(
            Map<? extends K2, Byte> map, int expectedSize) {
        MutableQHashSeparateKVObjByteMapGO<K2> res = uninitializedMutableMap();
    ...
    public <K2 extends K>
     HashObjByteMap<K2> newImmutableMap(
            Map<? extends K2, Byte> map, int expectedSize) {
        ImmutableQHashSeparateKVObjByteMapGO<K2> res = uninitializedImmutableMap();
        res.move(newUpdatableMap(map, expectedSize));
        return res;
    }
    ...
    public <K2 extends K>
     HashObjByteMap<K2> newImmutableMap(
            Consumer<net.openhft.koloboke.function.ObjByteConsumer<K2>> entriesSupplier
            , int expectedSize) {
        ImmutableQHashSeparateKVObjByteMapGO<K2> map = uninitializedImmutableMap();
        map.move(newUpdatableMap(entriesSupplier, expectedSize));
        return map;
    }
