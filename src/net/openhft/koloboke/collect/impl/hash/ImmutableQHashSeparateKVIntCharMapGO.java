...
public class ImmutableQHashSeparateKVIntCharMapGO
        extends ImmutableQHashSeparateKVIntCharMapSO {
    ...
    class EntryView extends AbstractSetView<Map.Entry<Integer, Character>>
        ...
        public HashConfig hashConfig() {
            return ImmutableQHashSeparateKVIntCharMapGO.this.hashConfig();
        }


        @Override
        public int size() {
            return ImmutableQHashSeparateKVIntCharMapGO.this.size();
        }

        @Override
        public double currentLoad() {
            return ImmutableQHashSeparateKVIntCharMapGO.this.currentLoad();
        }
        ...
        public int hashCode() {
            return ImmutableQHashSeparateKVIntCharMapGO.this.hashCode();
        }
        ...
        public boolean shrink() {
            return ImmutableQHashSeparateKVIntCharMapGO.this.shrink();
        }
        ...
        public boolean remove(Object o) {
            try {
                ...
                return ImmutableQHashSeparateKVIntCharMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
        ...
        @Override
        public void clear() {
            ImmutableQHashSeparateKVIntCharMapGO.this.clear();
        }
    }
    ...
    class ValueView extends AbstractCharValueView {
        ...
        @Override
        public boolean contains(Object o) {
            return ImmutableQHashSeparateKVIntCharMapGO.this.containsValue(o);
        }

        @Override
        public boolean contains(char v) {
            return ImmutableQHashSeparateKVIntCharMapGO.this.containsValue(v);
        }
