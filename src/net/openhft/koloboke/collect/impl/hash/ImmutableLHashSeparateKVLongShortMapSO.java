...
public abstract class ImmutableLHashSeparateKVLongShortMapSO
        extends ImmutableLHashSeparateKVLongKeyMap
        implements HashLongShortMap, InternalLongShortMapOps, SeparateKVLongShortLHash {

    short[] values;

    void copy(SeparateKVLongShortLHash hash) {
        super.copy(hash);
        values = hash.valueArray().clone();
    }

    void move(SeparateKVLongShortLHash hash) {
        super.move(hash);
