...
public final class LHashSeparateKVLongByteMapFactoryImpl
        extends LHashSeparateKVLongByteMapFactoryGO {
    ...
    LHashSeparateKVLongByteMapFactoryImpl(HashConfig hashConf, int defaultExpectedSize, long lower, long upper) {
    ...
    static final class WithCustomDefaultValue
        ...
        @Override
         MutableLHashSeparateKVLongByteMapGO uninitializedMutableMap() {
            MutableLHashSeparateKVLongByteMap.WithCustomDefaultValue map =
                    new MutableLHashSeparateKVLongByteMap.WithCustomDefaultValue();
            map.defaultValue = defaultValue;
            return map;
        }
        @Override
         UpdatableLHashSeparateKVLongByteMapGO uninitializedUpdatableMap() {
            UpdatableLHashSeparateKVLongByteMap.WithCustomDefaultValue map =
                    new UpdatableLHashSeparateKVLongByteMap.WithCustomDefaultValue();
            map.defaultValue = defaultValue;
            return map;
        }
        @Override
         ImmutableLHashSeparateKVLongByteMapGO uninitializedImmutableMap() {
            ImmutableLHashSeparateKVLongByteMap.WithCustomDefaultValue map =
                    new ImmutableLHashSeparateKVLongByteMap.WithCustomDefaultValue();
            map.defaultValue = defaultValue;
            return map;
        }
        ...
        public HashLongByteMapFactory withDefaultValue(byte defaultValue) {
            if (defaultValue == (byte) 0)
                return new LHashSeparateKVLongByteMapFactoryImpl(getHashConfig(), getDefaultExpectedSize()
