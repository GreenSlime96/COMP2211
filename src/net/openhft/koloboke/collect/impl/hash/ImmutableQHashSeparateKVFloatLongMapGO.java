...
public class ImmutableQHashSeparateKVFloatLongMapGO
        extends ImmutableQHashSeparateKVFloatLongMapSO {
    ...
    class EntryView extends AbstractSetView<Map.Entry<Float, Long>>
        ...
        public HashConfig hashConfig() {
            return ImmutableQHashSeparateKVFloatLongMapGO.this.hashConfig();
        }


        @Override
        public int size() {
            return ImmutableQHashSeparateKVFloatLongMapGO.this.size();
        }

        @Override
        public double currentLoad() {
            return ImmutableQHashSeparateKVFloatLongMapGO.this.currentLoad();
        }
        ...
        public int hashCode() {
            return ImmutableQHashSeparateKVFloatLongMapGO.this.hashCode();
        }
        ...
        public boolean shrink() {
            return ImmutableQHashSeparateKVFloatLongMapGO.this.shrink();
        }
        ...
        public boolean remove(Object o) {
            try {
                ...
                return ImmutableQHashSeparateKVFloatLongMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
        ...
        @Override
        public void clear() {
            ImmutableQHashSeparateKVFloatLongMapGO.this.clear();
        }
    }
    ...
    class ValueView extends AbstractLongValueView {
        ...
        @Override
        public boolean contains(Object o) {
            return ImmutableQHashSeparateKVFloatLongMapGO.this.containsValue(o);
        }

        @Override
        public boolean contains(long v) {
            return ImmutableQHashSeparateKVFloatLongMapGO.this.containsValue(v);
        }
