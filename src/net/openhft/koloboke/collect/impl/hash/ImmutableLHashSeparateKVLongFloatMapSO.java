...
public abstract class ImmutableLHashSeparateKVLongFloatMapSO
        extends ImmutableLHashSeparateKVLongKeyMap
        implements HashLongFloatMap, InternalLongFloatMapOps, SeparateKVLongFloatLHash {

    int[] values;

    void copy(SeparateKVLongFloatLHash hash) {
        super.copy(hash);
        values = hash.valueArray().clone();
    }

    void move(SeparateKVLongFloatLHash hash) {
        super.move(hash);
