...
public abstract class QHashSeparateKVCharObjMapFactoryGO<V>
        extends QHashSeparateKVCharObjMapFactorySO<V> {

    QHashSeparateKVCharObjMapFactoryGO(HashConfig hashConf, int defaultExpectedSize
...
;
    ...
    private <V2 extends V> UpdatableQHashSeparateKVCharObjMapGO<V2> shrunk(
            UpdatableQHashSeparateKVCharObjMapGO<V2> map) {
    ...
    @Override
    @Nonnull
    public <V2 extends V> MutableQHashSeparateKVCharObjMapGO<V2> newMutableMap() {
    ...
    public <V2 extends V> UpdatableQHashSeparateKVCharObjMapGO<V2> newUpdatableMap(
            Map<Character, ? extends V2> map1, Map<Character, ? extends V2> map2,
            int expectedSize) {
        UpdatableQHashSeparateKVCharObjMapGO<V2> map = newUpdatableMap(expectedSize);
        map.putAll(map1);
        map.putAll(map2);
        return shrunk(map);
    }
    ...
    public <V2 extends V> UpdatableQHashSeparateKVCharObjMapGO<V2> newUpdatableMap(
            Consumer<net.openhft.koloboke.function.CharObjConsumer<V2>> entriesSupplier,
            int expectedSize) {
        final UpdatableQHashSeparateKVCharObjMapGO<V2> map = newUpdatableMap(expectedSize);
    ...
    @Override
    @Nonnull
    public <V2 extends V> UpdatableQHashSeparateKVCharObjMapGO<V2> newUpdatableMapOf(
            char k1, V2 v1) {
        UpdatableQHashSeparateKVCharObjMapGO<V2> map = newUpdatableMap(1);
        map.put(k1, v1);
        return map;
    }
    ...
    public <V2 extends V> UpdatableQHashSeparateKVCharObjMapGO<V2> newUpdatableMapOf(
        ...
        UpdatableQHashSeparateKVCharObjMapGO<V2> map = newUpdatableMap(2);
        map.put(k1, v1);
        map.put(k2, v2);
        return map;
    }
    ...
    public <V2 extends V> UpdatableQHashSeparateKVCharObjMapGO<V2> newUpdatableMapOf(
            char k1, V2 v1, char k2, V2 v2,
            char k3, V2 v3) {
        UpdatableQHashSeparateKVCharObjMapGO<V2> map = newUpdatableMap(3);
        map.put(k1, v1);
        map.put(k2, v2);
        map.put(k3, v3);
        return map;
    ...
    public <V2 extends V> UpdatableQHashSeparateKVCharObjMapGO<V2> newUpdatableMapOf(
        ...
        UpdatableQHashSeparateKVCharObjMapGO<V2> map = newUpdatableMap(4);
        map.put(k1, v1);
        map.put(k2, v2);
        map.put(k3, v3);
        map.put(k4, v4);
    ...
    public <V2 extends V> UpdatableQHashSeparateKVCharObjMapGO<V2> newUpdatableMapOf(
            ...
            char k3, V2 v3, char k4, V2 v4,
            char k5, V2 v5) {
        UpdatableQHashSeparateKVCharObjMapGO<V2> map = newUpdatableMap(5);
        map.put(k1, v1);
        map.put(k2, v2);
        map.put(k3, v3);
        map.put(k4, v4);
    ...
    public <V2 extends V> HashCharObjMap<V2> newMutableMap(Map<Character, ? extends V2> map1,
        ...
        MutableQHashSeparateKVCharObjMapGO<V2> res = uninitializedMutableMap();
    ...
    public <V2 extends V> HashCharObjMap<V2> newMutableMap(
            Consumer<net.openhft.koloboke.function.CharObjConsumer<V2>> entriesSupplier
            , int expectedSize) {
        MutableQHashSeparateKVCharObjMapGO<V2> map = uninitializedMutableMap();
    ...
    public <V2 extends V> HashCharObjMap<V2> newImmutableMap(Map<Character, ? extends V2> map1,
            Map<Character, ? extends V2> map2, int expectedSize) {
        ImmutableQHashSeparateKVCharObjMapGO<V2> res = uninitializedImmutableMap();
        res.move(newUpdatableMap(map1, map2, expectedSize));
        return res;
    }
    ...
    public <V2 extends V> HashCharObjMap<V2> newImmutableMap(
            Consumer<net.openhft.koloboke.function.CharObjConsumer<V2>> entriesSupplier
            , int expectedSize) {
        ImmutableQHashSeparateKVCharObjMapGO<V2> map = uninitializedImmutableMap();
        map.move(newUpdatableMap(entriesSupplier, expectedSize));
        return map;
    }
