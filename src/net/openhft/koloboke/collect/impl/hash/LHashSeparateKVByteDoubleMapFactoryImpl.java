...
public final class LHashSeparateKVByteDoubleMapFactoryImpl
        extends LHashSeparateKVByteDoubleMapFactoryGO {
    ...
    LHashSeparateKVByteDoubleMapFactoryImpl(HashConfig hashConf, int defaultExpectedSize, byte lower, byte upper) {
    ...
    static final class WithCustomDefaultValue
        ...
        @Override
         MutableLHashSeparateKVByteDoubleMapGO uninitializedMutableMap() {
            MutableLHashSeparateKVByteDoubleMap.WithCustomDefaultValue map =
                    new MutableLHashSeparateKVByteDoubleMap.WithCustomDefaultValue();
            map.defaultValue = defaultValue;
            return map;
        }
        @Override
         UpdatableLHashSeparateKVByteDoubleMapGO uninitializedUpdatableMap() {
            UpdatableLHashSeparateKVByteDoubleMap.WithCustomDefaultValue map =
                    new UpdatableLHashSeparateKVByteDoubleMap.WithCustomDefaultValue();
            map.defaultValue = defaultValue;
            return map;
        }
        @Override
         ImmutableLHashSeparateKVByteDoubleMapGO uninitializedImmutableMap() {
            ImmutableLHashSeparateKVByteDoubleMap.WithCustomDefaultValue map =
                    new ImmutableLHashSeparateKVByteDoubleMap.WithCustomDefaultValue();
            map.defaultValue = defaultValue;
            return map;
        }
        ...
        public HashByteDoubleMapFactory withDefaultValue(double defaultValue) {
            if (defaultValue == 0.0)
                return new LHashSeparateKVByteDoubleMapFactoryImpl(getHashConfig(), getDefaultExpectedSize()
