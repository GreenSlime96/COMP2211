...
public class MutableQHashSeparateKVByteIntMapGO
        extends MutableQHashSeparateKVByteIntMapSO {
    ...
    class EntryView extends AbstractSetView<Map.Entry<Byte, Integer>>
        ...
        public HashConfig hashConfig() {
            return MutableQHashSeparateKVByteIntMapGO.this.hashConfig();
        }


        @Override
        public int size() {
            return MutableQHashSeparateKVByteIntMapGO.this.size();
        }

        @Override
        public double currentLoad() {
            return MutableQHashSeparateKVByteIntMapGO.this.currentLoad();
        }
        ...
        public int hashCode() {
            return MutableQHashSeparateKVByteIntMapGO.this.hashCode();
        }
        ...
        public boolean shrink() {
            return MutableQHashSeparateKVByteIntMapGO.this.shrink();
        }
        ...
        public boolean remove(Object o) {
            try {
                ...
                return MutableQHashSeparateKVByteIntMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
        ...
        @Override
        public void clear() {
            MutableQHashSeparateKVByteIntMapGO.this.clear();
        }
    }
    ...
    class ValueView extends AbstractIntValueView {
        ...
        @Override
        public boolean contains(Object o) {
            return MutableQHashSeparateKVByteIntMapGO.this.containsValue(o);
        }

        @Override
        public boolean contains(int v) {
            return MutableQHashSeparateKVByteIntMapGO.this.containsValue(v);
        }
    ...
    class SomeRemovedEntryIterator implements ObjIterator<Map.Entry<Byte, Integer>> {
        final byte[] keys;
        final int[] vals;
        final byte free;
        final byte removed;
    ...
    class SomeRemovedEntryCursor implements ObjCursor<Map.Entry<Byte, Integer>> {
        final byte[] keys;
        final int[] vals;
        final byte free;
        final byte removed;
    ...
    class SomeRemovedMapCursor implements ByteIntCursor {
        final byte[] keys;
        final int[] vals;
        final byte free;
        final byte removed;
