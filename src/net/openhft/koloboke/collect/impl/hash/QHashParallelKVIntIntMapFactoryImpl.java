...
public final class QHashParallelKVIntIntMapFactoryImpl
        extends QHashParallelKVIntIntMapFactoryGO {
    ...
    /** For ServiceLoader */
    public QHashParallelKVIntIntMapFactoryImpl() {
    ...
    QHashParallelKVIntIntMapFactoryImpl(HashConfig hashConf, int defaultExpectedSize, int lower, int upper) {
    ...
    static final class WithCustomDefaultValue
        ...
        @Override
         MutableQHashParallelKVIntIntMapGO uninitializedMutableMap() {
            MutableQHashParallelKVIntIntMap.WithCustomDefaultValue map =
                    new MutableQHashParallelKVIntIntMap.WithCustomDefaultValue();
            map.defaultValue = defaultValue;
            return map;
        }
        @Override
         UpdatableQHashParallelKVIntIntMapGO uninitializedUpdatableMap() {
            UpdatableQHashParallelKVIntIntMap.WithCustomDefaultValue map =
                    new UpdatableQHashParallelKVIntIntMap.WithCustomDefaultValue();
            map.defaultValue = defaultValue;
            return map;
        }
        @Override
         ImmutableQHashParallelKVIntIntMapGO uninitializedImmutableMap() {
            ImmutableQHashParallelKVIntIntMap.WithCustomDefaultValue map =
                    new ImmutableQHashParallelKVIntIntMap.WithCustomDefaultValue();
            map.defaultValue = defaultValue;
            return map;
        }
        ...
        public HashIntIntMapFactory withDefaultValue(int defaultValue) {
            if (defaultValue == 0)
                return new QHashParallelKVIntIntMapFactoryImpl(getHashConfig(), getDefaultExpectedSize()
