...
public abstract class UpdatableLHashParallelKVIntKeyMap
        extends UpdatableParallelKVIntLHashGO {
    ...
    class KeyView extends AbstractIntKeyView
        ...
        public final boolean contains(Object o) {
            return UpdatableLHashParallelKVIntKeyMap.this.contains(o);
        }

        @Override
        public boolean contains(int key) {
            return UpdatableLHashParallelKVIntKeyMap.this.contains(key);
        }
        ...
        public void forEach(Consumer<? super Integer> action) {
            UpdatableLHashParallelKVIntKeyMap.this.forEach(action);
        }
        ...
        public boolean forEachWhile(IntPredicate
                predicate) {
            return UpdatableLHashParallelKVIntKeyMap.this.forEachWhile(predicate);
        }

        @Override
        public boolean allContainingIn(IntCollection c) {
            return UpdatableLHashParallelKVIntKeyMap.this.allContainingIn(c);
        }

        @Override
        public boolean reverseAddAllTo(IntCollection c) {
            return UpdatableLHashParallelKVIntKeyMap.this.reverseAddAllTo(c);
        }

        @Override
        public boolean reverseRemoveAllFrom(IntSet s) {
            return UpdatableLHashParallelKVIntKeyMap.this.reverseRemoveAllFrom(s);
        }
        ...
        public <T> T[] toArray(@Nonnull T[] a) {
            return UpdatableLHashParallelKVIntKeyMap.this.toArray(a);
        }
        ...
        public boolean removeIf(Predicate<? super Integer> filter) {
            return UpdatableLHashParallelKVIntKeyMap.this.removeIf(filter);
        }
        ...
        public boolean removeAll(@Nonnull Collection<?> c) {
            if (c instanceof IntCollection) {
                ...
                return UpdatableLHashParallelKVIntKeyMap.this.removeAll(this, (IntCollection) c);
            }
            return UpdatableLHashParallelKVIntKeyMap.this.removeAll(this, c);
        }

        @Override
        public boolean retainAll(@Nonnull Collection<?> c) {
            return UpdatableLHashParallelKVIntKeyMap.this.retainAll(this, c);
        }
