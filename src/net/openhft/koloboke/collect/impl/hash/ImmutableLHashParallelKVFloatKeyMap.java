...
public abstract class ImmutableLHashParallelKVFloatKeyMap
        extends ImmutableParallelKVFloatLHashGO {
    ...
    class KeyView extends AbstractFloatKeyView
        ...
        public final boolean contains(Object o) {
            return ImmutableLHashParallelKVFloatKeyMap.this.contains(o);
        }

        @Override
        public boolean contains(float key) {
            return ImmutableLHashParallelKVFloatKeyMap.this.contains(key);
        }

        @Override
        public boolean contains(int bits) {
            return ImmutableLHashParallelKVFloatKeyMap.this.contains(bits);
        }


        @Override
        public void forEach(Consumer<? super Float> action) {
            ImmutableLHashParallelKVFloatKeyMap.this.forEach(action);
        }
        ...
        public boolean forEachWhile(FloatPredicate
                predicate) {
            return ImmutableLHashParallelKVFloatKeyMap.this.forEachWhile(predicate);
        }

        @Override
        public boolean allContainingIn(FloatCollection c) {
            return ImmutableLHashParallelKVFloatKeyMap.this.allContainingIn(c);
        }

        @Override
        public boolean reverseAddAllTo(FloatCollection c) {
            return ImmutableLHashParallelKVFloatKeyMap.this.reverseAddAllTo(c);
        }

        @Override
        public boolean reverseRemoveAllFrom(FloatSet s) {
            return ImmutableLHashParallelKVFloatKeyMap.this.reverseRemoveAllFrom(s);
        }
        ...
        public <T> T[] toArray(@Nonnull T[] a) {
            return ImmutableLHashParallelKVFloatKeyMap.this.toArray(a);
        }
        ...
        public boolean removeIf(Predicate<? super Float> filter) {
            return ImmutableLHashParallelKVFloatKeyMap.this.removeIf(filter);
        }
        ...
        public boolean removeAll(@Nonnull Collection<?> c) {
            if (c instanceof FloatCollection) {
                ...
                return ImmutableLHashParallelKVFloatKeyMap.this.removeAll(this, (FloatCollection) c);
            }
            return ImmutableLHashParallelKVFloatKeyMap.this.removeAll(this, c);
        }

        @Override
        public boolean retainAll(@Nonnull Collection<?> c) {
            return ImmutableLHashParallelKVFloatKeyMap.this.retainAll(this, c);
        }
