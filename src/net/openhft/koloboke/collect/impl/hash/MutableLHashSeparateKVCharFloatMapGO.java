...
public class MutableLHashSeparateKVCharFloatMapGO
        extends MutableLHashSeparateKVCharFloatMapSO {
    ...
    class EntryView extends AbstractSetView<Map.Entry<Character, Float>>
        ...
        public boolean remove(Object o) {
            try {
                ...
                return MutableLHashSeparateKVCharFloatMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
    ...
    class ValueView extends AbstractFloatValueView {
        ...
        @Override
        public boolean contains(Object o) {
            return MutableLHashSeparateKVCharFloatMapGO.this.containsValue(o);
        }

        @Override
        public boolean contains(float v) {
            return MutableLHashSeparateKVCharFloatMapGO.this.containsValue(v);
        }

        @Override
        public boolean contains(int bits) {
            return MutableLHashSeparateKVCharFloatMapGO.this.containsValue(bits);
        }
