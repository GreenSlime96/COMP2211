...
public abstract class QHashSeparateKVShortObjMapFactoryGO<V>
        extends QHashSeparateKVShortObjMapFactorySO<V> {
...
;
    ...
    private <V2 extends V> UpdatableQHashSeparateKVShortObjMapGO<V2> shrunk(
            UpdatableQHashSeparateKVShortObjMapGO<V2> map) {
    ...
    @Override
    @Nonnull
    public <V2 extends V> MutableQHashSeparateKVShortObjMapGO<V2> newMutableMap() {
    ...
    public <V2 extends V> UpdatableQHashSeparateKVShortObjMapGO<V2> newUpdatableMap(
            Map<Short, ? extends V2> map1, Map<Short, ? extends V2> map2,
            int expectedSize) {
        UpdatableQHashSeparateKVShortObjMapGO<V2> map = newUpdatableMap(expectedSize);
        map.putAll(map1);
        map.putAll(map2);
        return shrunk(map);
    }
    ...
    public <V2 extends V> UpdatableQHashSeparateKVShortObjMapGO<V2> newUpdatableMap(
            Consumer<net.openhft.koloboke.function.ShortObjConsumer<V2>> entriesSupplier,
            int expectedSize) {
        final UpdatableQHashSeparateKVShortObjMapGO<V2> map = newUpdatableMap(expectedSize);
    ...
    @Override
    @Nonnull
    public <V2 extends V> UpdatableQHashSeparateKVShortObjMapGO<V2> newUpdatableMapOf(
            short k1, V2 v1) {
        UpdatableQHashSeparateKVShortObjMapGO<V2> map = newUpdatableMap(1);
        map.put(k1, v1);
        return map;
    }
    ...
    public <V2 extends V> UpdatableQHashSeparateKVShortObjMapGO<V2> newUpdatableMapOf(
        ...
        UpdatableQHashSeparateKVShortObjMapGO<V2> map = newUpdatableMap(2);
        map.put(k1, v1);
        map.put(k2, v2);
        return map;
    }
    ...
    public <V2 extends V> UpdatableQHashSeparateKVShortObjMapGO<V2> newUpdatableMapOf(
            short k1, V2 v1, short k2, V2 v2,
            short k3, V2 v3) {
        UpdatableQHashSeparateKVShortObjMapGO<V2> map = newUpdatableMap(3);
        map.put(k1, v1);
        map.put(k2, v2);
        map.put(k3, v3);
        return map;
    ...
    public <V2 extends V> UpdatableQHashSeparateKVShortObjMapGO<V2> newUpdatableMapOf(
        ...
        UpdatableQHashSeparateKVShortObjMapGO<V2> map = newUpdatableMap(4);
        map.put(k1, v1);
        map.put(k2, v2);
        map.put(k3, v3);
        map.put(k4, v4);
    ...
    public <V2 extends V> UpdatableQHashSeparateKVShortObjMapGO<V2> newUpdatableMapOf(
            ...
            short k3, V2 v3, short k4, V2 v4,
            short k5, V2 v5) {
        UpdatableQHashSeparateKVShortObjMapGO<V2> map = newUpdatableMap(5);
        map.put(k1, v1);
        map.put(k2, v2);
        map.put(k3, v3);
        map.put(k4, v4);
    ...
    public <V2 extends V> HashShortObjMap<V2> newMutableMap(Map<Short, ? extends V2> map1,
        ...
        MutableQHashSeparateKVShortObjMapGO<V2> res = uninitializedMutableMap();
    ...
    public <V2 extends V> HashShortObjMap<V2> newMutableMap(
            Consumer<net.openhft.koloboke.function.ShortObjConsumer<V2>> entriesSupplier
            , int expectedSize) {
        MutableQHashSeparateKVShortObjMapGO<V2> map = uninitializedMutableMap();
    ...
    public <V2 extends V> HashShortObjMap<V2> newImmutableMap(Map<Short, ? extends V2> map1,
            Map<Short, ? extends V2> map2, int expectedSize) {
        ImmutableQHashSeparateKVShortObjMapGO<V2> res = uninitializedImmutableMap();
        res.move(newUpdatableMap(map1, map2, expectedSize));
        return res;
    }
    ...
    public <V2 extends V> HashShortObjMap<V2> newImmutableMap(
            Consumer<net.openhft.koloboke.function.ShortObjConsumer<V2>> entriesSupplier
            , int expectedSize) {
        ImmutableQHashSeparateKVShortObjMapGO<V2> map = uninitializedImmutableMap();
        map.move(newUpdatableMap(entriesSupplier, expectedSize));
        return map;
    }
