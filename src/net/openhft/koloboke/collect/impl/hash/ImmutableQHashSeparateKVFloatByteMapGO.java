...
public class ImmutableQHashSeparateKVFloatByteMapGO
        extends ImmutableQHashSeparateKVFloatByteMapSO {
    ...
    class EntryView extends AbstractSetView<Map.Entry<Float, Byte>>
        ...
        public boolean remove(Object o) {
            try {
                ...
                return ImmutableQHashSeparateKVFloatByteMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
    ...
    class ValueView extends AbstractByteValueView {
        ...
        @Override
        public boolean contains(Object o) {
            return ImmutableQHashSeparateKVFloatByteMapGO.this.containsValue(o);
        }

        @Override
        public boolean contains(byte v) {
            return ImmutableQHashSeparateKVFloatByteMapGO.this.containsValue(v);
        }
