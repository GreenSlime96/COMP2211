...
public abstract class MutableLHashParallelKVFloatKeyMap
        extends MutableParallelKVFloatLHashGO {
    ...
    class KeyView extends AbstractFloatKeyView
        ...
        public final boolean contains(Object o) {
            return MutableLHashParallelKVFloatKeyMap.this.contains(o);
        }

        @Override
        public boolean contains(float key) {
            return MutableLHashParallelKVFloatKeyMap.this.contains(key);
        }

        @Override
        public boolean contains(int bits) {
            return MutableLHashParallelKVFloatKeyMap.this.contains(bits);
        }


        @Override
        public void forEach(Consumer<? super Float> action) {
            MutableLHashParallelKVFloatKeyMap.this.forEach(action);
        }
        ...
        public boolean forEachWhile(FloatPredicate
                predicate) {
            return MutableLHashParallelKVFloatKeyMap.this.forEachWhile(predicate);
        }

        @Override
        public boolean allContainingIn(FloatCollection c) {
            return MutableLHashParallelKVFloatKeyMap.this.allContainingIn(c);
        }

        @Override
        public boolean reverseAddAllTo(FloatCollection c) {
            return MutableLHashParallelKVFloatKeyMap.this.reverseAddAllTo(c);
        }

        @Override
        public boolean reverseRemoveAllFrom(FloatSet s) {
            return MutableLHashParallelKVFloatKeyMap.this.reverseRemoveAllFrom(s);
        }
        ...
        public <T> T[] toArray(@Nonnull T[] a) {
            return MutableLHashParallelKVFloatKeyMap.this.toArray(a);
        }
        ...
        public boolean removeIf(Predicate<? super Float> filter) {
            return MutableLHashParallelKVFloatKeyMap.this.removeIf(filter);
        }
        ...
        public boolean removeAll(@Nonnull Collection<?> c) {
            if (c instanceof FloatCollection) {
                ...
                return MutableLHashParallelKVFloatKeyMap.this.removeAll(this, (FloatCollection) c);
            }
            return MutableLHashParallelKVFloatKeyMap.this.removeAll(this, c);
        }

        @Override
        public boolean retainAll(@Nonnull Collection<?> c) {
            return MutableLHashParallelKVFloatKeyMap.this.retainAll(this, c);
        }
