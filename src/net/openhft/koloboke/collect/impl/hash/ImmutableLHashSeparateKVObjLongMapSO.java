...
public abstract class ImmutableLHashSeparateKVObjLongMapSO<K>
        extends ImmutableLHashSeparateKVObjKeyMap<K>
        implements HashObjLongMap<K>, InternalObjLongMapOps<K>, SeparateKVObjLongLHash {

    long[] values;

    void copy(SeparateKVObjLongLHash hash) {
        super.copy(hash);
        values = hash.valueArray().clone();
    }

    void move(SeparateKVObjLongLHash hash) {
        super.move(hash);
