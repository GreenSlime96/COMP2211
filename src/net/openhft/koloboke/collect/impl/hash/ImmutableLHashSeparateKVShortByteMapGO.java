...
public class ImmutableLHashSeparateKVShortByteMapGO
        extends ImmutableLHashSeparateKVShortByteMapSO {
    ...
    class EntryView extends AbstractSetView<Map.Entry<Short, Byte>>
        ...
        public HashConfig hashConfig() {
            return ImmutableLHashSeparateKVShortByteMapGO.this.hashConfig();
        }


        @Override
        public int size() {
            return ImmutableLHashSeparateKVShortByteMapGO.this.size();
        }

        @Override
        public double currentLoad() {
            return ImmutableLHashSeparateKVShortByteMapGO.this.currentLoad();
        }
        ...
        public int hashCode() {
            return ImmutableLHashSeparateKVShortByteMapGO.this.hashCode();
        }
        ...
        public boolean shrink() {
            return ImmutableLHashSeparateKVShortByteMapGO.this.shrink();
        }
        ...
        public boolean remove(Object o) {
            try {
                ...
                return ImmutableLHashSeparateKVShortByteMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
        ...
        @Override
        public void clear() {
            ImmutableLHashSeparateKVShortByteMapGO.this.clear();
        }
    }
    ...
    class ValueView extends AbstractByteValueView {
        ...
        @Override
        public boolean contains(Object o) {
            return ImmutableLHashSeparateKVShortByteMapGO.this.containsValue(o);
        }

        @Override
        public boolean contains(byte v) {
            return ImmutableLHashSeparateKVShortByteMapGO.this.containsValue(v);
        }
