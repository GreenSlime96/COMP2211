...
public class UpdatableQHashParallelKVDoubleLongMapGO
        extends UpdatableQHashParallelKVDoubleLongMapSO {
    ...
    class EntryView extends AbstractSetView<Map.Entry<Double, Long>>
        ...
        public HashConfig hashConfig() {
            return UpdatableQHashParallelKVDoubleLongMapGO.this.hashConfig();
        }


        @Override
        public int size() {
            return UpdatableQHashParallelKVDoubleLongMapGO.this.size();
        }

        @Override
        public double currentLoad() {
            return UpdatableQHashParallelKVDoubleLongMapGO.this.currentLoad();
        }
        ...
        public int hashCode() {
            return UpdatableQHashParallelKVDoubleLongMapGO.this.hashCode();
        }
        ...
        public boolean shrink() {
            return UpdatableQHashParallelKVDoubleLongMapGO.this.shrink();
        }
        ...
        public boolean remove(Object o) {
            try {
                ...
                return UpdatableQHashParallelKVDoubleLongMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
        ...
        @Override
        public void clear() {
            UpdatableQHashParallelKVDoubleLongMapGO.this.clear();
        }
    }
    ...
    class ValueView extends AbstractLongValueView {
        ...
        @Override
        public boolean contains(Object o) {
            return UpdatableQHashParallelKVDoubleLongMapGO.this.containsValue(o);
        }

        @Override
        public boolean contains(long v) {
            return UpdatableQHashParallelKVDoubleLongMapGO.this.containsValue(v);
        }
