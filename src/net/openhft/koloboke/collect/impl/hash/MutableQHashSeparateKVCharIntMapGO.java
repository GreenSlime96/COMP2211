...
public class MutableQHashSeparateKVCharIntMapGO
        extends MutableQHashSeparateKVCharIntMapSO {
    ...
    class EntryView extends AbstractSetView<Map.Entry<Character, Integer>>
        ...
        public HashConfig hashConfig() {
            return MutableQHashSeparateKVCharIntMapGO.this.hashConfig();
        }


        @Override
        public int size() {
            return MutableQHashSeparateKVCharIntMapGO.this.size();
        }

        @Override
        public double currentLoad() {
            return MutableQHashSeparateKVCharIntMapGO.this.currentLoad();
        }
        ...
        public int hashCode() {
            return MutableQHashSeparateKVCharIntMapGO.this.hashCode();
        }
        ...
        public boolean shrink() {
            return MutableQHashSeparateKVCharIntMapGO.this.shrink();
        }
        ...
        public boolean remove(Object o) {
            try {
                ...
                return MutableQHashSeparateKVCharIntMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
        ...
        @Override
        public void clear() {
            MutableQHashSeparateKVCharIntMapGO.this.clear();
        }
    }
    ...
    class MutableEntry extends CharIntEntry {
        final int modCount;
    ...
    class ValueView extends AbstractIntValueView {
        ...
        @Override
        public boolean contains(Object o) {
            return MutableQHashSeparateKVCharIntMapGO.this.containsValue(o);
        }

        @Override
        public boolean contains(int v) {
            return MutableQHashSeparateKVCharIntMapGO.this.containsValue(v);
        }
    ...
    class SomeRemovedEntryIterator implements ObjIterator<Map.Entry<Character, Integer>> {
        final char[] keys;
        final int[] vals;
        final char free;
        final char removed;
    ...
    class SomeRemovedEntryCursor implements ObjCursor<Map.Entry<Character, Integer>> {
        final char[] keys;
        final int[] vals;
        final char free;
        final char removed;
    ...
    class SomeRemovedMapCursor implements CharIntCursor {
        final char[] keys;
        final int[] vals;
        final char free;
        final char removed;
