...
public abstract class UpdatableQHashSeparateKVByteDoubleMapSO
        extends UpdatableQHashSeparateKVByteKeyMap
        implements HashByteDoubleMap, InternalByteDoubleMapOps, SeparateKVByteDoubleQHash {

    long[] values;

    void copy(SeparateKVByteDoubleQHash hash) {
        super.copy(hash);
        values = hash.valueArray().clone();
    }

    void move(SeparateKVByteDoubleQHash hash) {
        super.move(hash);
