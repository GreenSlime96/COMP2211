...
public abstract class MutableQHashParallelKVByteKeyMap
        extends MutableParallelKVByteQHashGO {
    ...
    class KeyView extends AbstractByteKeyView
        ...
        public final boolean contains(Object o) {
            return MutableQHashParallelKVByteKeyMap.this.contains(o);
        }

        @Override
        public boolean contains(byte key) {
            return MutableQHashParallelKVByteKeyMap.this.contains(key);
        }
        ...
        public void forEach(Consumer<? super Byte> action) {
            MutableQHashParallelKVByteKeyMap.this.forEach(action);
        }
        ...
        public boolean forEachWhile(BytePredicate
                predicate) {
            return MutableQHashParallelKVByteKeyMap.this.forEachWhile(predicate);
        }

        @Override
        public boolean allContainingIn(ByteCollection c) {
            return MutableQHashParallelKVByteKeyMap.this.allContainingIn(c);
        }

        @Override
        public boolean reverseAddAllTo(ByteCollection c) {
            return MutableQHashParallelKVByteKeyMap.this.reverseAddAllTo(c);
        }

        @Override
        public boolean reverseRemoveAllFrom(ByteSet s) {
            return MutableQHashParallelKVByteKeyMap.this.reverseRemoveAllFrom(s);
        }
        ...
        public <T> T[] toArray(@Nonnull T[] a) {
            return MutableQHashParallelKVByteKeyMap.this.toArray(a);
        }
        ...
        public boolean removeIf(Predicate<? super Byte> filter) {
            return MutableQHashParallelKVByteKeyMap.this.removeIf(filter);
        }
        ...
        public boolean removeAll(@Nonnull Collection<?> c) {
            if (c instanceof ByteCollection) {
                ...
                return MutableQHashParallelKVByteKeyMap.this.removeAll(this, (ByteCollection) c);
            }
            return MutableQHashParallelKVByteKeyMap.this.removeAll(this, c);
        }

        @Override
        public boolean retainAll(@Nonnull Collection<?> c) {
            return MutableQHashParallelKVByteKeyMap.this.retainAll(this, c);
        }
