...
public abstract class QHashSeparateKVObjFloatMapFactoryGO<K>
        extends QHashSeparateKVObjFloatMapFactorySO<K> {

    QHashSeparateKVObjFloatMapFactoryGO(HashConfig hashConf, int defaultExpectedSize
    ...
    private <K2 extends K>
     UpdatableQHashSeparateKVObjFloatMapGO<K2> shrunk(
            UpdatableQHashSeparateKVObjFloatMapGO<K2> map) {
    ...
    public <K2 extends K>
     UpdatableQHashSeparateKVObjFloatMapGO<K2> newUpdatableMap(
            Map<? extends K2, Float> map1, Map<? extends K2, Float> map2,
            int expectedSize) {
        UpdatableQHashSeparateKVObjFloatMapGO<K2> map = newUpdatableMap(expectedSize);
        map.putAll(map1);
        map.putAll(map2);
        return shrunk(map);
    }
    ...
    public <K2 extends K>
     UpdatableQHashSeparateKVObjFloatMapGO<K2> newUpdatableMap(
            Consumer<net.openhft.koloboke.function.ObjFloatConsumer<K2>> entriesSupplier,
            int expectedSize) {
        final UpdatableQHashSeparateKVObjFloatMapGO<K2> map = newUpdatableMap(expectedSize);
    ...
    @Nonnull
    public <K2 extends K>
     UpdatableQHashSeparateKVObjFloatMapGO<K2> newUpdatableMapOf(
            K2 k1, float v1) {
        UpdatableQHashSeparateKVObjFloatMapGO<K2> map = newUpdatableMap(1);
        map.put(k1, v1);
        return map;
    }
    ...
    public <K2 extends K>
     UpdatableQHashSeparateKVObjFloatMapGO<K2> newUpdatableMapOf(
        ...
        UpdatableQHashSeparateKVObjFloatMapGO<K2> map = newUpdatableMap(2);
        map.put(k1, v1);
        map.put(k2, v2);
        return map;
    }
    ...
    public <K2 extends K>
     UpdatableQHashSeparateKVObjFloatMapGO<K2> newUpdatableMapOf(
            K2 k1, float v1, K2 k2, float v2,
            K2 k3, float v3) {
        UpdatableQHashSeparateKVObjFloatMapGO<K2> map = newUpdatableMap(3);
        map.put(k1, v1);
        map.put(k2, v2);
        map.put(k3, v3);
        return map;
    ...
    public <K2 extends K>
     UpdatableQHashSeparateKVObjFloatMapGO<K2> newUpdatableMapOf(
        ...
        UpdatableQHashSeparateKVObjFloatMapGO<K2> map = newUpdatableMap(4);
        map.put(k1, v1);
        map.put(k2, v2);
        map.put(k3, v3);
        map.put(k4, v4);
    ...
    public <K2 extends K>
     UpdatableQHashSeparateKVObjFloatMapGO<K2> newUpdatableMapOf(
            ...
            K2 k3, float v3, K2 k4, float v4,
            K2 k5, float v5) {
        UpdatableQHashSeparateKVObjFloatMapGO<K2> map = newUpdatableMap(5);
        map.put(k1, v1);
        map.put(k2, v2);
        map.put(k3, v3);
        map.put(k4, v4);
    ...
    public <K2 extends K>
     HashObjFloatMap<K2> newMutableMap(
            Map<? extends K2, Float> map, int expectedSize) {
        MutableQHashSeparateKVObjFloatMapGO<K2> res = uninitializedMutableMap();
    ...
    public <K2 extends K>
     HashObjFloatMap<K2> newImmutableMap(
            Map<? extends K2, Float> map, int expectedSize) {
        ImmutableQHashSeparateKVObjFloatMapGO<K2> res = uninitializedImmutableMap();
        res.move(newUpdatableMap(map, expectedSize));
        return res;
    }
    ...
    public <K2 extends K>
     HashObjFloatMap<K2> newImmutableMap(
            Consumer<net.openhft.koloboke.function.ObjFloatConsumer<K2>> entriesSupplier
            , int expectedSize) {
        ImmutableQHashSeparateKVObjFloatMapGO<K2> map = uninitializedImmutableMap();
        map.move(newUpdatableMap(entriesSupplier, expectedSize));
        return map;
    }
