...
import static net.openhft.koloboke.collect.impl.hash.QHashCapacities.*;
...
public abstract class UpdatableQHash extends HashWithoutRemovedSlots implements QHash {
     ...
     * in {@code UpdatableQHash} from {@link #initForRehash(int)} and
     ...
     * in {@code UpdatableQHash} from {@link #postInsertHook()}, {@link #ensureCapacity(long)}
     ...
     *
     * <p>It is UpdatableQHash's concern in order to treat edge cases of capacities near to Java
