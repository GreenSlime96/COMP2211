...
public class ImmutableQHashSeparateKVObjShortMapGO<K>
        extends ImmutableQHashSeparateKVObjShortMapSO<K> {
    ...
    class EntryView extends AbstractSetView<Map.Entry<K, Short>>
        ...
        public HashConfig hashConfig() {
            return ImmutableQHashSeparateKVObjShortMapGO.this.hashConfig();
        }


        @Override
        public int size() {
            return ImmutableQHashSeparateKVObjShortMapGO.this.size();
        }

        @Override
        public double currentLoad() {
            return ImmutableQHashSeparateKVObjShortMapGO.this.currentLoad();
        }
        ...
        public int hashCode() {
            return ImmutableQHashSeparateKVObjShortMapGO.this.hashCode();
        }
        ...
        public boolean shrink() {
            return ImmutableQHashSeparateKVObjShortMapGO.this.shrink();
        }
        ...
        public boolean remove(Object o) {
            try {
                ...
                return ImmutableQHashSeparateKVObjShortMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
        ...
        @Override
        public void clear() {
            ImmutableQHashSeparateKVObjShortMapGO.this.clear();
        }
    }
    ...
    class ValueView extends AbstractShortValueView {
        ...
        @Override
        public boolean contains(Object o) {
            return ImmutableQHashSeparateKVObjShortMapGO.this.containsValue(o);
        }

        @Override
        public boolean contains(short v) {
            return ImmutableQHashSeparateKVObjShortMapGO.this.containsValue(v);
        }
