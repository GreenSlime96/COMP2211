...
public abstract class UpdatableQHashSeparateKVByteKeyMap
        extends UpdatableSeparateKVByteQHashGO {
    ...
    class KeyView extends AbstractByteKeyView
        ...
        public final boolean contains(Object o) {
            return UpdatableQHashSeparateKVByteKeyMap.this.contains(o);
        }

        @Override
        public boolean contains(byte key) {
            return UpdatableQHashSeparateKVByteKeyMap.this.contains(key);
        }
        ...
        public void forEach(Consumer<? super Byte> action) {
            UpdatableQHashSeparateKVByteKeyMap.this.forEach(action);
        }
        ...
        public boolean forEachWhile(BytePredicate
                predicate) {
            return UpdatableQHashSeparateKVByteKeyMap.this.forEachWhile(predicate);
        }

        @Override
        public boolean allContainingIn(ByteCollection c) {
            return UpdatableQHashSeparateKVByteKeyMap.this.allContainingIn(c);
        }

        @Override
        public boolean reverseAddAllTo(ByteCollection c) {
            return UpdatableQHashSeparateKVByteKeyMap.this.reverseAddAllTo(c);
        }

        @Override
        public boolean reverseRemoveAllFrom(ByteSet s) {
            return UpdatableQHashSeparateKVByteKeyMap.this.reverseRemoveAllFrom(s);
        }
        ...
        public <T> T[] toArray(@Nonnull T[] a) {
            return UpdatableQHashSeparateKVByteKeyMap.this.toArray(a);
        }
        ...
        public boolean removeIf(Predicate<? super Byte> filter) {
            return UpdatableQHashSeparateKVByteKeyMap.this.removeIf(filter);
        }
        ...
        public boolean removeAll(@Nonnull Collection<?> c) {
            if (c instanceof ByteCollection) {
                ...
                return UpdatableQHashSeparateKVByteKeyMap.this.removeAll(this, (ByteCollection) c);
            }
            return UpdatableQHashSeparateKVByteKeyMap.this.removeAll(this, c);
        }

        @Override
        public boolean retainAll(@Nonnull Collection<?> c) {
            return UpdatableQHashSeparateKVByteKeyMap.this.retainAll(this, c);
        }
