...
public class UpdatableQHashSeparateKVIntLongMapGO
        extends UpdatableQHashSeparateKVIntLongMapSO {
    ...
    class EntryView extends AbstractSetView<Map.Entry<Integer, Long>>
        ...
        public HashConfig hashConfig() {
            return UpdatableQHashSeparateKVIntLongMapGO.this.hashConfig();
        }


        @Override
        public int size() {
            return UpdatableQHashSeparateKVIntLongMapGO.this.size();
        }

        @Override
        public double currentLoad() {
            return UpdatableQHashSeparateKVIntLongMapGO.this.currentLoad();
        }
        ...
        public int hashCode() {
            return UpdatableQHashSeparateKVIntLongMapGO.this.hashCode();
        }
        ...
        public boolean shrink() {
            return UpdatableQHashSeparateKVIntLongMapGO.this.shrink();
        }
        ...
        public boolean remove(Object o) {
            try {
                ...
                return UpdatableQHashSeparateKVIntLongMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
        ...
        @Override
        public void clear() {
            UpdatableQHashSeparateKVIntLongMapGO.this.clear();
        }
    }
    ...
    class MutableEntry extends IntLongEntry {
        final int modCount;
    ...
    class ValueView extends AbstractLongValueView {
        ...
        @Override
        public boolean contains(Object o) {
            return UpdatableQHashSeparateKVIntLongMapGO.this.containsValue(o);
        }

        @Override
        public boolean contains(long v) {
            return UpdatableQHashSeparateKVIntLongMapGO.this.containsValue(v);
        }
