...
public class ImmutableLHashSeparateKVByteIntMapGO
        extends ImmutableLHashSeparateKVByteIntMapSO {
    ...
    class EntryView extends AbstractSetView<Map.Entry<Byte, Integer>>
        ...
        public HashConfig hashConfig() {
            return ImmutableLHashSeparateKVByteIntMapGO.this.hashConfig();
        }


        @Override
        public int size() {
            return ImmutableLHashSeparateKVByteIntMapGO.this.size();
        }

        @Override
        public double currentLoad() {
            return ImmutableLHashSeparateKVByteIntMapGO.this.currentLoad();
        }
        ...
        public int hashCode() {
            return ImmutableLHashSeparateKVByteIntMapGO.this.hashCode();
        }
        ...
        public boolean shrink() {
            return ImmutableLHashSeparateKVByteIntMapGO.this.shrink();
        }
        ...
        public boolean remove(Object o) {
            try {
                ...
                return ImmutableLHashSeparateKVByteIntMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
        ...
        @Override
        public void clear() {
            ImmutableLHashSeparateKVByteIntMapGO.this.clear();
        }
    }
    ...
    class ValueView extends AbstractIntValueView {
        ...
        @Override
        public boolean contains(Object o) {
            return ImmutableLHashSeparateKVByteIntMapGO.this.containsValue(o);
        }

        @Override
        public boolean contains(int v) {
            return ImmutableLHashSeparateKVByteIntMapGO.this.containsValue(v);
        }
