...
public abstract class UpdatableQHashSeparateKVObjKeyMap<K>
        extends UpdatableSeparateKVObjQHashGO<K> {
    ...
    class KeyView extends AbstractObjKeyView<K>
        ...
        public final boolean contains(Object o) {
            return UpdatableQHashSeparateKVObjKeyMap.this.contains(o);
        }
        ...
        public void forEach(Consumer<? super K> action) {
            UpdatableQHashSeparateKVObjKeyMap.this.forEach(action);
        }
        ...
        public boolean allContainingIn(ObjCollection<?> c) {
            return UpdatableQHashSeparateKVObjKeyMap.this.allContainingIn(c);
        }

        @Override
        public boolean reverseAddAllTo(ObjCollection<? super K> c) {
            return UpdatableQHashSeparateKVObjKeyMap.this.reverseAddAllTo(c);
        }

        @Override
        public boolean reverseRemoveAllFrom(ObjSet<?> s) {
            return UpdatableQHashSeparateKVObjKeyMap.this.reverseRemoveAllFrom(s);
        }
        ...
        public <T> T[] toArray(@Nonnull T[] a) {
            return UpdatableQHashSeparateKVObjKeyMap.this.toArray(a);
        }
        ...
        public boolean removeIf(Predicate<? super K> filter) {
            return UpdatableQHashSeparateKVObjKeyMap.this.removeIf(filter);
        }
        ...
        public boolean removeAll(@Nonnull Collection<?> c) {
            ...
            return UpdatableQHashSeparateKVObjKeyMap.this.removeAll(this, c);
        }

        @Override
        public boolean retainAll(@Nonnull Collection<?> c) {
            return UpdatableQHashSeparateKVObjKeyMap.this.retainAll(this, c);
        }
