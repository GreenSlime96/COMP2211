...
public class MutableQHashSeparateKVShortFloatMapGO
        extends MutableQHashSeparateKVShortFloatMapSO {
    ...
    class EntryView extends AbstractSetView<Map.Entry<Short, Float>>
        ...
        public HashConfig hashConfig() {
            return MutableQHashSeparateKVShortFloatMapGO.this.hashConfig();
        }


        @Override
        public int size() {
            return MutableQHashSeparateKVShortFloatMapGO.this.size();
        }

        @Override
        public double currentLoad() {
            return MutableQHashSeparateKVShortFloatMapGO.this.currentLoad();
        }
        ...
        public int hashCode() {
            return MutableQHashSeparateKVShortFloatMapGO.this.hashCode();
        }
        ...
        public boolean shrink() {
            return MutableQHashSeparateKVShortFloatMapGO.this.shrink();
        }
        ...
        public boolean remove(Object o) {
            try {
                ...
                return MutableQHashSeparateKVShortFloatMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
        ...
        @Override
        public void clear() {
            MutableQHashSeparateKVShortFloatMapGO.this.clear();
        }
    }
    ...
    class MutableEntry extends ShortFloatEntry {
        final int modCount;
    ...
    class ValueView extends AbstractFloatValueView {
        ...
        @Override
        public boolean contains(Object o) {
            return MutableQHashSeparateKVShortFloatMapGO.this.containsValue(o);
        }

        @Override
        public boolean contains(float v) {
            return MutableQHashSeparateKVShortFloatMapGO.this.containsValue(v);
        }

        @Override
        public boolean contains(int bits) {
            return MutableQHashSeparateKVShortFloatMapGO.this.containsValue(bits);
        }
    ...
    class SomeRemovedEntryIterator implements ObjIterator<Map.Entry<Short, Float>> {
        final short[] keys;
        final int[] vals;
        final short free;
        final short removed;
    ...
    class SomeRemovedEntryCursor implements ObjCursor<Map.Entry<Short, Float>> {
        final short[] keys;
        final int[] vals;
        final short free;
        final short removed;
    ...
    class SomeRemovedMapCursor implements ShortFloatCursor {
        final short[] keys;
        final int[] vals;
        final short free;
        final short removed;
