...
public class MutableLHashSeparateKVLongCharMapGO
        extends MutableLHashSeparateKVLongCharMapSO {

    @Override
    final void copy(SeparateKVLongCharLHash hash) {
    ...
    @Override
    final void move(SeparateKVLongCharLHash hash) {
        int myMC = modCount(), hashMC = hash.modCount();
        super.move(hash);
        if (myMC != modCount() || hashMC != hash.modCount())
            throw new ConcurrentModificationException();
    ...
    public Character remove(Object key) {
        ...
        if (k != (free = freeValue)) {
            ...
            long cur;
            keyPresent:
            if ((cur = keys[index = SeparateKVLongKeyMixing.mix(k) & capacityMask]) != k) {
                if (cur == free) {
                    // key is absent
                    return null;
                } else {
    ...
    // under this condition - operations, overridden from MutableSeparateKVLongLHashGO
    ...
    class EntryView extends AbstractSetView<Map.Entry<Long, Character>>
        ...
        public HashConfig hashConfig() {
            return MutableLHashSeparateKVLongCharMapGO.this.hashConfig();
        }


        @Override
        public int size() {
            return MutableLHashSeparateKVLongCharMapGO.this.size();
        }

        @Override
        public double currentLoad() {
            return MutableLHashSeparateKVLongCharMapGO.this.currentLoad();
        }
        ...
        public int hashCode() {
            return MutableLHashSeparateKVLongCharMapGO.this.hashCode();
        }
        ...
        public boolean shrink() {
            return MutableLHashSeparateKVLongCharMapGO.this.shrink();
        }
        ...
        public boolean remove(Object o) {
            try {
                ...
                return MutableLHashSeparateKVLongCharMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
        ...
        @Override
        public void clear() {
            MutableLHashSeparateKVLongCharMapGO.this.clear();
        }
    }
    ...
    class MutableEntry extends LongCharEntry {
        final int modCount;
    ...
    class ValueView extends AbstractCharValueView {
        ...
        @Override
        public boolean contains(Object o) {
            return MutableLHashSeparateKVLongCharMapGO.this.containsValue(o);
        }

        @Override
        public boolean contains(char v) {
            return MutableLHashSeparateKVLongCharMapGO.this.containsValue(v);
        }
