...
import static net.openhft.koloboke.collect.impl.hash.QHashCapacities.nearestGreaterCapacity;
...
public abstract class MutableQHash extends AbstractContainer implements QHash {
     ...
     *
     * @param hash Mutable or Immutable QHash instance
     */
     ...
     * method is called in MutableQHash from initForRehash() and init() methods.
     *
     ...
     * in QHash from postInsertHooks, {@link #ensureCapacity(long)} and {@link #shrink()} methods.
     */
