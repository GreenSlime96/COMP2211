...
public final class QHashSeparateKVFloatShortMapFactoryImpl
        extends QHashSeparateKVFloatShortMapFactoryGO {
    ...
    /** For ServiceLoader */
    public QHashSeparateKVFloatShortMapFactoryImpl() {
    ...
    QHashSeparateKVFloatShortMapFactoryImpl(HashConfig hashConf, int defaultExpectedSize) {
    ...
    static final class WithCustomDefaultValue
        ...
        @Override
         MutableQHashSeparateKVFloatShortMapGO uninitializedMutableMap() {
            MutableQHashSeparateKVFloatShortMap.WithCustomDefaultValue map =
                    new MutableQHashSeparateKVFloatShortMap.WithCustomDefaultValue();
            map.defaultValue = defaultValue;
            return map;
        }
        @Override
         UpdatableQHashSeparateKVFloatShortMapGO uninitializedUpdatableMap() {
            UpdatableQHashSeparateKVFloatShortMap.WithCustomDefaultValue map =
                    new UpdatableQHashSeparateKVFloatShortMap.WithCustomDefaultValue();
            map.defaultValue = defaultValue;
            return map;
        }
        @Override
         ImmutableQHashSeparateKVFloatShortMapGO uninitializedImmutableMap() {
            ImmutableQHashSeparateKVFloatShortMap.WithCustomDefaultValue map =
                    new ImmutableQHashSeparateKVFloatShortMap.WithCustomDefaultValue();
            map.defaultValue = defaultValue;
            return map;
        }
        ...
        public HashFloatShortMapFactory withDefaultValue(short defaultValue) {
            if (defaultValue == (short) 0)
                return new QHashSeparateKVFloatShortMapFactoryImpl(getHashConfig(), getDefaultExpectedSize()
        );
