...
public abstract class LHashSeparateKVIntObjMapFactoryGO<V>
        extends LHashSeparateKVIntObjMapFactorySO<V> {

    LHashSeparateKVIntObjMapFactoryGO(HashConfig hashConf, int defaultExpectedSize
            , int lower, int upper) {
...
;
    ...
    private <V2 extends V> UpdatableLHashSeparateKVIntObjMapGO<V2> shrunk(
            UpdatableLHashSeparateKVIntObjMapGO<V2> map) {
    ...
    @Override
    @Nonnull
    public <V2 extends V> MutableLHashSeparateKVIntObjMapGO<V2> newMutableMap() {
    ...
    public <V2 extends V> UpdatableLHashSeparateKVIntObjMapGO<V2> newUpdatableMap(
            Map<Integer, ? extends V2> map1, Map<Integer, ? extends V2> map2,
            int expectedSize) {
        UpdatableLHashSeparateKVIntObjMapGO<V2> map = newUpdatableMap(expectedSize);
        map.putAll(map1);
        map.putAll(map2);
        return shrunk(map);
    }
    ...
    public <V2 extends V> UpdatableLHashSeparateKVIntObjMapGO<V2> newUpdatableMap(
            Consumer<net.openhft.koloboke.function.IntObjConsumer<V2>> entriesSupplier,
            int expectedSize) {
        final UpdatableLHashSeparateKVIntObjMapGO<V2> map = newUpdatableMap(expectedSize);
    ...
    @Override
    @Nonnull
    public <V2 extends V> UpdatableLHashSeparateKVIntObjMapGO<V2> newUpdatableMapOf(
            int k1, V2 v1) {
        UpdatableLHashSeparateKVIntObjMapGO<V2> map = newUpdatableMap(1);
        map.put(k1, v1);
        return map;
    }
    ...
    public <V2 extends V> UpdatableLHashSeparateKVIntObjMapGO<V2> newUpdatableMapOf(
        ...
        UpdatableLHashSeparateKVIntObjMapGO<V2> map = newUpdatableMap(2);
        map.put(k1, v1);
        map.put(k2, v2);
        return map;
    }
    ...
    public <V2 extends V> UpdatableLHashSeparateKVIntObjMapGO<V2> newUpdatableMapOf(
            int k1, V2 v1, int k2, V2 v2,
            int k3, V2 v3) {
        UpdatableLHashSeparateKVIntObjMapGO<V2> map = newUpdatableMap(3);
        map.put(k1, v1);
        map.put(k2, v2);
        map.put(k3, v3);
        return map;
    ...
    public <V2 extends V> UpdatableLHashSeparateKVIntObjMapGO<V2> newUpdatableMapOf(
        ...
        UpdatableLHashSeparateKVIntObjMapGO<V2> map = newUpdatableMap(4);
        map.put(k1, v1);
        map.put(k2, v2);
        map.put(k3, v3);
        map.put(k4, v4);
    ...
    public <V2 extends V> UpdatableLHashSeparateKVIntObjMapGO<V2> newUpdatableMapOf(
            ...
            int k3, V2 v3, int k4, V2 v4,
            int k5, V2 v5) {
        UpdatableLHashSeparateKVIntObjMapGO<V2> map = newUpdatableMap(5);
        map.put(k1, v1);
        map.put(k2, v2);
        map.put(k3, v3);
        map.put(k4, v4);
    ...
    public <V2 extends V> HashIntObjMap<V2> newMutableMap(Map<Integer, ? extends V2> map1,
        ...
        MutableLHashSeparateKVIntObjMapGO<V2> res = uninitializedMutableMap();
    ...
    public <V2 extends V> HashIntObjMap<V2> newImmutableMap(Map<Integer, ? extends V2> map1,
            Map<Integer, ? extends V2> map2, int expectedSize) {
        ImmutableLHashSeparateKVIntObjMapGO<V2> res = uninitializedImmutableMap();
        res.move(newUpdatableMap(map1, map2, expectedSize));
        return res;
    }
    ...
    public <V2 extends V> HashIntObjMap<V2> newImmutableMap(
            Consumer<net.openhft.koloboke.function.IntObjConsumer<V2>> entriesSupplier
            , int expectedSize) {
        ImmutableLHashSeparateKVIntObjMapGO<V2> map = uninitializedImmutableMap();
        map.move(newUpdatableMap(entriesSupplier, expectedSize));
        return map;
    }
