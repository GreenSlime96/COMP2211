...
public class UpdatableQHashSeparateKVShortFloatMapGO
        extends UpdatableQHashSeparateKVShortFloatMapSO {
    ...
    class EntryView extends AbstractSetView<Map.Entry<Short, Float>>
        ...
        public HashConfig hashConfig() {
            return UpdatableQHashSeparateKVShortFloatMapGO.this.hashConfig();
        }


        @Override
        public int size() {
            return UpdatableQHashSeparateKVShortFloatMapGO.this.size();
        }

        @Override
        public double currentLoad() {
            return UpdatableQHashSeparateKVShortFloatMapGO.this.currentLoad();
        }
        ...
        public int hashCode() {
            return UpdatableQHashSeparateKVShortFloatMapGO.this.hashCode();
        }
        ...
        public boolean shrink() {
            return UpdatableQHashSeparateKVShortFloatMapGO.this.shrink();
        }
        ...
        public boolean remove(Object o) {
            try {
                ...
                return UpdatableQHashSeparateKVShortFloatMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
        ...
        @Override
        public void clear() {
            UpdatableQHashSeparateKVShortFloatMapGO.this.clear();
        }
    }
    ...
    class ValueView extends AbstractFloatValueView {
        ...
        @Override
        public boolean contains(Object o) {
            return UpdatableQHashSeparateKVShortFloatMapGO.this.containsValue(o);
        }

        @Override
        public boolean contains(float v) {
            return UpdatableQHashSeparateKVShortFloatMapGO.this.containsValue(v);
        }

        @Override
        public boolean contains(int bits) {
            return UpdatableQHashSeparateKVShortFloatMapGO.this.containsValue(bits);
        }
