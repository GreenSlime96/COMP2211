...
public abstract class ImmutableQHashParallelKVByteKeyMap
        extends ImmutableParallelKVByteQHashGO {
    ...
    class KeyView extends AbstractByteKeyView
        ...
        public final boolean contains(Object o) {
            return ImmutableQHashParallelKVByteKeyMap.this.contains(o);
        }

        @Override
        public boolean contains(byte key) {
            return ImmutableQHashParallelKVByteKeyMap.this.contains(key);
        }
        ...
        public void forEach(Consumer<? super Byte> action) {
            ImmutableQHashParallelKVByteKeyMap.this.forEach(action);
        }
        ...
        public boolean forEachWhile(BytePredicate
                predicate) {
            return ImmutableQHashParallelKVByteKeyMap.this.forEachWhile(predicate);
        }

        @Override
        public boolean allContainingIn(ByteCollection c) {
            return ImmutableQHashParallelKVByteKeyMap.this.allContainingIn(c);
        }

        @Override
        public boolean reverseAddAllTo(ByteCollection c) {
            return ImmutableQHashParallelKVByteKeyMap.this.reverseAddAllTo(c);
        }

        @Override
        public boolean reverseRemoveAllFrom(ByteSet s) {
            return ImmutableQHashParallelKVByteKeyMap.this.reverseRemoveAllFrom(s);
        }
        ...
        public <T> T[] toArray(@Nonnull T[] a) {
            return ImmutableQHashParallelKVByteKeyMap.this.toArray(a);
        }
        ...
        public boolean removeIf(Predicate<? super Byte> filter) {
            return ImmutableQHashParallelKVByteKeyMap.this.removeIf(filter);
        }
        ...
        public boolean removeAll(@Nonnull Collection<?> c) {
            if (c instanceof ByteCollection) {
                ...
                return ImmutableQHashParallelKVByteKeyMap.this.removeAll(this, (ByteCollection) c);
            }
            return ImmutableQHashParallelKVByteKeyMap.this.removeAll(this, c);
        }

        @Override
        public boolean retainAll(@Nonnull Collection<?> c) {
            return ImmutableQHashParallelKVByteKeyMap.this.retainAll(this, c);
        }
