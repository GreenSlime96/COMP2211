...
public abstract class LHashSeparateKVDoubleObjMapFactoryGO<V>
        extends LHashSeparateKVDoubleObjMapFactorySO<V> {

    LHashSeparateKVDoubleObjMapFactoryGO(HashConfig hashConf, int defaultExpectedSize
            ) {
...
;
    ...
    private <V2 extends V> UpdatableLHashSeparateKVDoubleObjMapGO<V2> shrunk(
            UpdatableLHashSeparateKVDoubleObjMapGO<V2> map) {
    ...
    @Override
    @Nonnull
    public <V2 extends V> MutableLHashSeparateKVDoubleObjMapGO<V2> newMutableMap() {
    ...
    public <V2 extends V> UpdatableLHashSeparateKVDoubleObjMapGO<V2> newUpdatableMap(
            Map<Double, ? extends V2> map1, Map<Double, ? extends V2> map2,
            int expectedSize) {
        UpdatableLHashSeparateKVDoubleObjMapGO<V2> map = newUpdatableMap(expectedSize);
        map.putAll(map1);
        map.putAll(map2);
        return shrunk(map);
    }
    ...
    public <V2 extends V> UpdatableLHashSeparateKVDoubleObjMapGO<V2> newUpdatableMap(
            Consumer<net.openhft.koloboke.function.DoubleObjConsumer<V2>> entriesSupplier,
            int expectedSize) {
        final UpdatableLHashSeparateKVDoubleObjMapGO<V2> map = newUpdatableMap(expectedSize);
    ...
    @Override
    @Nonnull
    public <V2 extends V> UpdatableLHashSeparateKVDoubleObjMapGO<V2> newUpdatableMapOf(
            double k1, V2 v1) {
        UpdatableLHashSeparateKVDoubleObjMapGO<V2> map = newUpdatableMap(1);
        map.put(k1, v1);
        return map;
    }
    ...
    public <V2 extends V> UpdatableLHashSeparateKVDoubleObjMapGO<V2> newUpdatableMapOf(
        ...
        UpdatableLHashSeparateKVDoubleObjMapGO<V2> map = newUpdatableMap(2);
        map.put(k1, v1);
        map.put(k2, v2);
        return map;
    }
    ...
    public <V2 extends V> UpdatableLHashSeparateKVDoubleObjMapGO<V2> newUpdatableMapOf(
            double k1, V2 v1, double k2, V2 v2,
            double k3, V2 v3) {
        UpdatableLHashSeparateKVDoubleObjMapGO<V2> map = newUpdatableMap(3);
        map.put(k1, v1);
        map.put(k2, v2);
        map.put(k3, v3);
        return map;
    ...
    public <V2 extends V> UpdatableLHashSeparateKVDoubleObjMapGO<V2> newUpdatableMapOf(
        ...
        UpdatableLHashSeparateKVDoubleObjMapGO<V2> map = newUpdatableMap(4);
        map.put(k1, v1);
        map.put(k2, v2);
        map.put(k3, v3);
        map.put(k4, v4);
    ...
    public <V2 extends V> UpdatableLHashSeparateKVDoubleObjMapGO<V2> newUpdatableMapOf(
            ...
            double k3, V2 v3, double k4, V2 v4,
            double k5, V2 v5) {
        UpdatableLHashSeparateKVDoubleObjMapGO<V2> map = newUpdatableMap(5);
        map.put(k1, v1);
        map.put(k2, v2);
        map.put(k3, v3);
        map.put(k4, v4);
    ...
    public <V2 extends V> HashDoubleObjMap<V2> newMutableMap(Map<Double, ? extends V2> map1,
        ...
        MutableLHashSeparateKVDoubleObjMapGO<V2> res = uninitializedMutableMap();
    ...
    public <V2 extends V> HashDoubleObjMap<V2> newImmutableMap(Map<Double, ? extends V2> map1,
            Map<Double, ? extends V2> map2, int expectedSize) {
        ImmutableLHashSeparateKVDoubleObjMapGO<V2> res = uninitializedImmutableMap();
        res.move(newUpdatableMap(map1, map2, expectedSize));
        return res;
    }
    ...
    public <V2 extends V> HashDoubleObjMap<V2> newImmutableMap(
            Consumer<net.openhft.koloboke.function.DoubleObjConsumer<V2>> entriesSupplier
            , int expectedSize) {
        ImmutableLHashSeparateKVDoubleObjMapGO<V2> map = uninitializedImmutableMap();
        map.move(newUpdatableMap(entriesSupplier, expectedSize));
        return map;
    }
