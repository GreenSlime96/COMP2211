...
public abstract class UpdatableQHashParallelKVShortKeyMap
        extends UpdatableParallelKVShortQHashGO {
    ...
    class KeyView extends AbstractShortKeyView
        ...
        public final boolean contains(Object o) {
            return UpdatableQHashParallelKVShortKeyMap.this.contains(o);
        }

        @Override
        public boolean contains(short key) {
            return UpdatableQHashParallelKVShortKeyMap.this.contains(key);
        }
        ...
        public void forEach(Consumer<? super Short> action) {
            UpdatableQHashParallelKVShortKeyMap.this.forEach(action);
        }
        ...
        public boolean forEachWhile(ShortPredicate
                predicate) {
            return UpdatableQHashParallelKVShortKeyMap.this.forEachWhile(predicate);
        }

        @Override
        public boolean allContainingIn(ShortCollection c) {
            return UpdatableQHashParallelKVShortKeyMap.this.allContainingIn(c);
        }

        @Override
        public boolean reverseAddAllTo(ShortCollection c) {
            return UpdatableQHashParallelKVShortKeyMap.this.reverseAddAllTo(c);
        }

        @Override
        public boolean reverseRemoveAllFrom(ShortSet s) {
            return UpdatableQHashParallelKVShortKeyMap.this.reverseRemoveAllFrom(s);
        }
        ...
        public <T> T[] toArray(@Nonnull T[] a) {
            return UpdatableQHashParallelKVShortKeyMap.this.toArray(a);
        }
        ...
        public boolean removeIf(Predicate<? super Short> filter) {
            return UpdatableQHashParallelKVShortKeyMap.this.removeIf(filter);
        }
        ...
        public boolean removeAll(@Nonnull Collection<?> c) {
            if (c instanceof ShortCollection) {
                ...
                return UpdatableQHashParallelKVShortKeyMap.this.removeAll(this, (ShortCollection) c);
            }
            return UpdatableQHashParallelKVShortKeyMap.this.removeAll(this, c);
        }

        @Override
        public boolean retainAll(@Nonnull Collection<?> c) {
            return UpdatableQHashParallelKVShortKeyMap.this.retainAll(this, c);
        }
