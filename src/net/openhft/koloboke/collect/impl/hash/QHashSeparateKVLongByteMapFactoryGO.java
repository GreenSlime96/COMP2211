...
public abstract class QHashSeparateKVLongByteMapFactoryGO
    ...
    QHashSeparateKVLongByteMapFactoryGO(HashConfig hashConf, int defaultExpectedSize
    ...
    private  UpdatableQHashSeparateKVLongByteMapGO shrunk(
            UpdatableQHashSeparateKVLongByteMapGO map) {
    ...
    public  UpdatableQHashSeparateKVLongByteMapGO newUpdatableMap(
            Map<Long, Byte> map1, Map<Long, Byte> map2,
            int expectedSize) {
        UpdatableQHashSeparateKVLongByteMapGO map = newUpdatableMap(expectedSize);
        map.putAll(map1);
        map.putAll(map2);
        return shrunk(map);
    }
    ...
    public  UpdatableQHashSeparateKVLongByteMapGO newUpdatableMap(
            Consumer<net.openhft.koloboke.function.LongByteConsumer> entriesSupplier,
            int expectedSize) {
        final UpdatableQHashSeparateKVLongByteMapGO map = newUpdatableMap(expectedSize);
    ...
    @Override
    @Nonnull
    public  UpdatableQHashSeparateKVLongByteMapGO newUpdatableMapOf(
            long k1, byte v1) {
        UpdatableQHashSeparateKVLongByteMapGO map = newUpdatableMap(1);
        map.put(k1, v1);
        return map;
    }
    ...
    public  UpdatableQHashSeparateKVLongByteMapGO newUpdatableMapOf(
        ...
        UpdatableQHashSeparateKVLongByteMapGO map = newUpdatableMap(2);
        map.put(k1, v1);
        map.put(k2, v2);
        return map;
    }
    ...
    public  UpdatableQHashSeparateKVLongByteMapGO newUpdatableMapOf(
            long k1, byte v1, long k2, byte v2,
            long k3, byte v3) {
        UpdatableQHashSeparateKVLongByteMapGO map = newUpdatableMap(3);
        map.put(k1, v1);
        map.put(k2, v2);
        map.put(k3, v3);
        return map;
    ...
    public  UpdatableQHashSeparateKVLongByteMapGO newUpdatableMapOf(
        ...
        UpdatableQHashSeparateKVLongByteMapGO map = newUpdatableMap(4);
        map.put(k1, v1);
        map.put(k2, v2);
        map.put(k3, v3);
        map.put(k4, v4);
    ...
    public  UpdatableQHashSeparateKVLongByteMapGO newUpdatableMapOf(
            ...
            long k3, byte v3, long k4, byte v4,
            long k5, byte v5) {
        UpdatableQHashSeparateKVLongByteMapGO map = newUpdatableMap(5);
        map.put(k1, v1);
        map.put(k2, v2);
        map.put(k3, v3);
        map.put(k4, v4);
    ...
    public  HashLongByteMap newMutableMap(Map<Long, Byte> map1,
        ...
        MutableQHashSeparateKVLongByteMapGO res = uninitializedMutableMap();
    ...
    public  HashLongByteMap newImmutableMap(Map<Long, Byte> map1,
            Map<Long, Byte> map2, int expectedSize) {
        ImmutableQHashSeparateKVLongByteMapGO res = uninitializedImmutableMap();
        res.move(newUpdatableMap(map1, map2, expectedSize));
        return res;
    }
    ...
    public  HashLongByteMap newImmutableMap(
            Consumer<net.openhft.koloboke.function.LongByteConsumer> entriesSupplier
            , int expectedSize) {
        ImmutableQHashSeparateKVLongByteMapGO map = uninitializedImmutableMap();
        map.move(newUpdatableMap(entriesSupplier, expectedSize));
        return map;
    }
