...
public class MutableQHashSeparateKVFloatCharMapGO
    ...
    class SomeRemovedEntryIterator implements ObjIterator<Map.Entry<Float, Character>> {
        final int[] keys;
        final char[] vals;
        int expectedModCount;
        int index = -1;
    ...
    class SomeRemovedEntryCursor implements ObjCursor<Map.Entry<Float, Character>> {
        final int[] keys;
        final char[] vals;
        int expectedModCount;
        int index;
    ...
    class SomeRemovedMapCursor implements FloatCharCursor {
        final int[] keys;
        final char[] vals;
        int expectedModCount;
        int index;
