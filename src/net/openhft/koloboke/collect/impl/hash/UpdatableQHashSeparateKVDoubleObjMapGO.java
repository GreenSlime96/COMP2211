...
public class UpdatableQHashSeparateKVDoubleObjMapGO<V>
        extends UpdatableQHashSeparateKVDoubleObjMapSO<V> {
    ...
    class EntryView extends AbstractSetView<Map.Entry<Double, V>>
        ...
        public boolean remove(Object o) {
            try {
                ...
                double key = e.getKey();
                V value = e.getValue();
                return UpdatableQHashSeparateKVDoubleObjMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
    ...
    class ValueView extends AbstractObjValueView<V> {
        ...
        @Override
        public boolean contains(Object o) {
            return UpdatableQHashSeparateKVDoubleObjMapGO.this.containsValue(o);
        }
