...
public abstract class QHashParallelKVDoubleDoubleMapFactoryGO
        extends QHashParallelKVDoubleDoubleMapFactorySO {

    QHashParallelKVDoubleDoubleMapFactoryGO(HashConfig hashConf, int defaultExpectedSize
            ) {
    ...
    private  UpdatableQHashParallelKVDoubleDoubleMapGO shrunk(
            UpdatableQHashParallelKVDoubleDoubleMapGO map) {
    ...
    @Override
    @Nonnull
    public  MutableQHashParallelKVDoubleDoubleMapGO newMutableMap() {
    ...
    public  UpdatableQHashParallelKVDoubleDoubleMapGO newUpdatableMap(
            Map<Double, Double> map1, Map<Double, Double> map2,
            int expectedSize) {
        UpdatableQHashParallelKVDoubleDoubleMapGO map = newUpdatableMap(expectedSize);
        map.putAll(map1);
        map.putAll(map2);
        return shrunk(map);
    }
    ...
    public  UpdatableQHashParallelKVDoubleDoubleMapGO newUpdatableMap(
            Consumer<net.openhft.koloboke.function.DoubleDoubleConsumer> entriesSupplier,
            int expectedSize) {
        final UpdatableQHashParallelKVDoubleDoubleMapGO map = newUpdatableMap(expectedSize);
    ...
    @Override
    @Nonnull
    public  UpdatableQHashParallelKVDoubleDoubleMapGO newUpdatableMapOf(
            double k1, double v1) {
        UpdatableQHashParallelKVDoubleDoubleMapGO map = newUpdatableMap(1);
        map.put(k1, v1);
        return map;
    }
    ...
    public  UpdatableQHashParallelKVDoubleDoubleMapGO newUpdatableMapOf(
        ...
        UpdatableQHashParallelKVDoubleDoubleMapGO map = newUpdatableMap(2);
        map.put(k1, v1);
        map.put(k2, v2);
        return map;
    }
    ...
    public  UpdatableQHashParallelKVDoubleDoubleMapGO newUpdatableMapOf(
            double k1, double v1, double k2, double v2,
            double k3, double v3) {
        UpdatableQHashParallelKVDoubleDoubleMapGO map = newUpdatableMap(3);
        map.put(k1, v1);
        map.put(k2, v2);
        map.put(k3, v3);
        return map;
    ...
    public  UpdatableQHashParallelKVDoubleDoubleMapGO newUpdatableMapOf(
        ...
        UpdatableQHashParallelKVDoubleDoubleMapGO map = newUpdatableMap(4);
        map.put(k1, v1);
        map.put(k2, v2);
        map.put(k3, v3);
        map.put(k4, v4);
    ...
    public  UpdatableQHashParallelKVDoubleDoubleMapGO newUpdatableMapOf(
            ...
            double k3, double v3, double k4, double v4,
            double k5, double v5) {
        UpdatableQHashParallelKVDoubleDoubleMapGO map = newUpdatableMap(5);
        map.put(k1, v1);
        map.put(k2, v2);
        map.put(k3, v3);
        map.put(k4, v4);
    ...
    public  HashDoubleDoubleMap newMutableMap(Map<Double, Double> map1,
        ...
        MutableQHashParallelKVDoubleDoubleMapGO res = uninitializedMutableMap();
    ...
    public  HashDoubleDoubleMap newImmutableMap(Map<Double, Double> map1,
            Map<Double, Double> map2, int expectedSize) {
        ImmutableQHashParallelKVDoubleDoubleMapGO res = uninitializedImmutableMap();
        res.move(newUpdatableMap(map1, map2, expectedSize));
        return res;
    }
    ...
    public  HashDoubleDoubleMap newImmutableMap(
            Consumer<net.openhft.koloboke.function.DoubleDoubleConsumer> entriesSupplier
            , int expectedSize) {
        ImmutableQHashParallelKVDoubleDoubleMapGO map = uninitializedImmutableMap();
        map.move(newUpdatableMap(entriesSupplier, expectedSize));
        return map;
    }
