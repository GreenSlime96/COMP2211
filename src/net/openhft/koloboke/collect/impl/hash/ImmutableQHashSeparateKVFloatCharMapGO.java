...
public class ImmutableQHashSeparateKVFloatCharMapGO
        extends ImmutableQHashSeparateKVFloatCharMapSO {
    ...
    class EntryView extends AbstractSetView<Map.Entry<Float, Character>>
        ...
        public HashConfig hashConfig() {
            return ImmutableQHashSeparateKVFloatCharMapGO.this.hashConfig();
        }


        @Override
        public int size() {
            return ImmutableQHashSeparateKVFloatCharMapGO.this.size();
        }

        @Override
        public double currentLoad() {
            return ImmutableQHashSeparateKVFloatCharMapGO.this.currentLoad();
        }
        ...
        public int hashCode() {
            return ImmutableQHashSeparateKVFloatCharMapGO.this.hashCode();
        }
        ...
        public boolean shrink() {
            return ImmutableQHashSeparateKVFloatCharMapGO.this.shrink();
        }
        ...
        public boolean remove(Object o) {
            try {
                ...
                return ImmutableQHashSeparateKVFloatCharMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
        ...
        @Override
        public void clear() {
            ImmutableQHashSeparateKVFloatCharMapGO.this.clear();
        }
    }
    ...
    class ValueView extends AbstractCharValueView {
        ...
        @Override
        public boolean contains(Object o) {
            return ImmutableQHashSeparateKVFloatCharMapGO.this.containsValue(o);
        }

        @Override
        public boolean contains(char v) {
            return ImmutableQHashSeparateKVFloatCharMapGO.this.containsValue(v);
        }
