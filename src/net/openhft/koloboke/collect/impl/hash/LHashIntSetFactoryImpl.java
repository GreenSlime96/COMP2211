...
public final class LHashIntSetFactoryImpl extends LHashIntSetFactoryGO {
    ...
    public LHashIntSetFactoryImpl(HashConfig hashConf, int defaultExpectedSize
        , int lower, int upper) {
    ...
    HashIntSetFactory withDomain(int lower, int upper) {
        if (lower == getLowerKeyDomainBound() && upper == getUpperKeyDomainBound())
            return this;
        return new LHashIntSetFactoryImpl(getHashConfig(), getDefaultExpectedSize(), lower, upper);
    }
