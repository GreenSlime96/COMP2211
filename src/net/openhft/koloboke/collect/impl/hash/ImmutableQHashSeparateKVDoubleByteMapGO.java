...
public class ImmutableQHashSeparateKVDoubleByteMapGO
        extends ImmutableQHashSeparateKVDoubleByteMapSO {
    ...
    class EntryView extends AbstractSetView<Map.Entry<Double, Byte>>
        ...
        public HashConfig hashConfig() {
            return ImmutableQHashSeparateKVDoubleByteMapGO.this.hashConfig();
        }


        @Override
        public int size() {
            return ImmutableQHashSeparateKVDoubleByteMapGO.this.size();
        }

        @Override
        public double currentLoad() {
            return ImmutableQHashSeparateKVDoubleByteMapGO.this.currentLoad();
        }
        ...
        public int hashCode() {
            return ImmutableQHashSeparateKVDoubleByteMapGO.this.hashCode();
        }
        ...
        public boolean shrink() {
            return ImmutableQHashSeparateKVDoubleByteMapGO.this.shrink();
        }
        ...
        public boolean remove(Object o) {
            try {
                ...
                return ImmutableQHashSeparateKVDoubleByteMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
        ...
        @Override
        public void clear() {
            ImmutableQHashSeparateKVDoubleByteMapGO.this.clear();
        }
    }
    ...
    private class ImmutableEntry extends DoubleByteEntry {
        private final long key;
        private final byte value;

        ImmutableEntry(long key, byte value) {
            this.key = key;
            this.value = value;
        }
    ...
    class ValueView extends AbstractByteValueView {
        ...
        @Override
        public boolean contains(Object o) {
            return ImmutableQHashSeparateKVDoubleByteMapGO.this.containsValue(o);
        }

        @Override
        public boolean contains(byte v) {
            return ImmutableQHashSeparateKVDoubleByteMapGO.this.containsValue(v);
        }
