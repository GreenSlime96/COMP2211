...
public class MutableQHashSeparateKVLongCharMapGO
    ...
    class SomeRemovedEntryIterator implements ObjIterator<Map.Entry<Long, Character>> {
        final long[] keys;
        final char[] vals;
        final long free;
        final long removed;
    ...
    class SomeRemovedEntryCursor implements ObjCursor<Map.Entry<Long, Character>> {
        final long[] keys;
        final char[] vals;
        final long free;
        final long removed;
    ...
    class SomeRemovedMapCursor implements LongCharCursor {
        final long[] keys;
        final char[] vals;
        final long free;
        final long removed;
