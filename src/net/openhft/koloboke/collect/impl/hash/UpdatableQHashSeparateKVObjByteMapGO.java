...
public class UpdatableQHashSeparateKVObjByteMapGO<K>
        extends UpdatableQHashSeparateKVObjByteMapSO<K> {
    ...
    class EntryView extends AbstractSetView<Map.Entry<K, Byte>>
        ...
        public boolean remove(Object o) {
            try {
                ...
                return UpdatableQHashSeparateKVObjByteMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
    ...
    class ValueView extends AbstractByteValueView {
        ...
        @Override
        public boolean contains(Object o) {
            return UpdatableQHashSeparateKVObjByteMapGO.this.containsValue(o);
        }

        @Override
        public boolean contains(byte v) {
            return UpdatableQHashSeparateKVObjByteMapGO.this.containsValue(v);
        }
