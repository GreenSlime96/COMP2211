...
public class UpdatableQHashSeparateKVDoubleByteMapGO
        extends UpdatableQHashSeparateKVDoubleByteMapSO {

    @Override
    final void copy(SeparateKVDoubleByteQHash hash) {
    ...
    @Override
    final void move(SeparateKVDoubleByteQHash hash) {
        int myMC = modCount(), hashMC = hash.modCount();
        super.move(hash);
        if (myMC != modCount() || hashMC != hash.modCount())
            throw new ConcurrentModificationException();
    ...
    public boolean containsAllEntries(Map<?, ?> m) {
        return CommonDoubleByteMapOps.containsAllEntries(this, m);
    }
    ...
    @Override
    public Byte compute(Double key,
            BiFunction<? super Double, ? super Byte, ? extends Byte> remappingFunction) {
        long k = Double.doubleToLongBits(key);
        ...
        if ((cur = keys[index = SeparateKVDoubleKeyMixing.mix(k) % (capacity = keys.length)]) != k) {
            ...
            // key is absent
            Byte newValue = remappingFunction.apply(Double.longBitsToDouble(k), null);
            if (newValue != null) {
                incrementModCount();
                keys[index] = k;
                vals[index] = newValue;
        ...
        // key is present
        Byte newValue = remappingFunction.apply(Double.longBitsToDouble(k), vals[index]);
        if (newValue != null) {
            vals[index] = newValue;
            return newValue;
        } else {
    ...
    public byte compute(double key, DoubleByteToByteFunction remappingFunction) {
        ...
        if ((cur = keys[index = SeparateKVDoubleKeyMixing.mix(k) % (capacity = keys.length)]) != k) {
            ...
            // key is absent
            byte newValue = remappingFunction.applyAsByte(Double.longBitsToDouble(k), defaultValue());
            incrementModCount();
            keys[index] = k;
            vals[index] = newValue;
            postInsertHook();
        ...
        // key is present
        byte newValue = remappingFunction.applyAsByte(Double.longBitsToDouble(k), vals[index]);
        vals[index] = newValue;
        return newValue;
    }
    ...
    @Override
    public Byte computeIfAbsent(Double key,
            Function<? super Double, ? extends Byte> mappingFunction) {
        long k = Double.doubleToLongBits(key);
        ...
        if ((cur = keys[index = SeparateKVDoubleKeyMixing.mix(k) % (capacity = keys.length)]) == k) {
            ...
            // key is absent
            Byte value = mappingFunction.apply(Double.longBitsToDouble(k));
            if (value != null) {
                incrementModCount();
                keys[index] = k;
                vals[index] = value;
    ...
    @Override
    public Byte computeIfPresent(Double key,
            BiFunction<? super Double, ? super Byte, ? extends Byte> remappingFunction) {
        long k = Double.doubleToLongBits(key);
        if (remappingFunction == null)
            throw new java.lang.NullPointerException();
    ...
    @Override
    public Byte merge(Double key, Byte value,
    ...
    @Override
    public byte addValue(double key, byte addition, byte defaultValue) {
        long k = Double.doubleToLongBits(key);
    ...
    public void putAll(@Nonnull Map<? extends Double, ? extends Byte> m) {
        CommonDoubleByteMapOps.putAll(this, m);
    }
    ...
    public void replaceAll(
            BiFunction<? super Double, ? super Byte, ? extends Byte> function) {
        if (function == null)
            throw new java.lang.NullPointerException();
        if (isEmpty())
            return;
    ...
    class EntryView extends AbstractSetView<Map.Entry<Double, Byte>>
            implements HashObjSet<Map.Entry<Double, Byte>>,
            InternalObjCollectionOps<Map.Entry<Double, Byte>> {

        @Nonnull
        @Override
        public Equivalence<Entry<Double, Byte>> equivalence() {
        ...
        public HashConfig hashConfig() {
            return UpdatableQHashSeparateKVDoubleByteMapGO.this.hashConfig();
        }


        @Override
        public int size() {
            return UpdatableQHashSeparateKVDoubleByteMapGO.this.size();
        }

        @Override
        public double currentLoad() {
            return UpdatableQHashSeparateKVDoubleByteMapGO.this.currentLoad();
        }
        ...
        public int hashCode() {
            return UpdatableQHashSeparateKVDoubleByteMapGO.this.hashCode();
        }
        ...
        public boolean shrink() {
            return UpdatableQHashSeparateKVDoubleByteMapGO.this.shrink();
        }
        ...
        public boolean remove(Object o) {
            try {
                ...
                return UpdatableQHashSeparateKVDoubleByteMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
        ...
        @Override
        public void clear() {
            UpdatableQHashSeparateKVDoubleByteMapGO.this.clear();
        }
    }
    ...
    class MutableEntry extends DoubleByteEntry {
        final int modCount;
    ...
    class ValueView extends AbstractByteValueView {
        ...
        @Override
        public boolean contains(Object o) {
            return UpdatableQHashSeparateKVDoubleByteMapGO.this.containsValue(o);
        }

        @Override
        public boolean contains(byte v) {
            return UpdatableQHashSeparateKVDoubleByteMapGO.this.containsValue(v);
        }
    ...
    class NoRemovedEntryIterator implements ObjIterator<Map.Entry<Double, Byte>> {
        final long[] keys;
        final byte[] vals;
