...
public class UpdatableQHashSeparateKVObjIntMapGO<K>
        extends UpdatableQHashSeparateKVObjIntMapSO<K> {
    ...
    class EntryView extends AbstractSetView<Map.Entry<K, Integer>>
        ...
        public HashConfig hashConfig() {
            return UpdatableQHashSeparateKVObjIntMapGO.this.hashConfig();
        }


        @Override
        public int size() {
            return UpdatableQHashSeparateKVObjIntMapGO.this.size();
        }

        @Override
        public double currentLoad() {
            return UpdatableQHashSeparateKVObjIntMapGO.this.currentLoad();
        }
        ...
        public int hashCode() {
            return UpdatableQHashSeparateKVObjIntMapGO.this.hashCode();
        }
        ...
        public boolean shrink() {
            return UpdatableQHashSeparateKVObjIntMapGO.this.shrink();
        }
        ...
        public boolean remove(Object o) {
            try {
                ...
                return UpdatableQHashSeparateKVObjIntMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
        ...
        @Override
        public void clear() {
            UpdatableQHashSeparateKVObjIntMapGO.this.clear();
        }
    }
    ...
    class ValueView extends AbstractIntValueView {
        ...
        @Override
        public boolean contains(Object o) {
            return UpdatableQHashSeparateKVObjIntMapGO.this.containsValue(o);
        }

        @Override
        public boolean contains(int v) {
            return UpdatableQHashSeparateKVObjIntMapGO.this.containsValue(v);
        }
