...
public class MutableLHashSeparateKVFloatCharMapGO
        extends MutableLHashSeparateKVFloatCharMapSO {
    ...
    class EntryView extends AbstractSetView<Map.Entry<Float, Character>>
        ...
        public HashConfig hashConfig() {
            return MutableLHashSeparateKVFloatCharMapGO.this.hashConfig();
        }


        @Override
        public int size() {
            return MutableLHashSeparateKVFloatCharMapGO.this.size();
        }

        @Override
        public double currentLoad() {
            return MutableLHashSeparateKVFloatCharMapGO.this.currentLoad();
        }
        ...
        public int hashCode() {
            return MutableLHashSeparateKVFloatCharMapGO.this.hashCode();
        }
        ...
        public boolean shrink() {
            return MutableLHashSeparateKVFloatCharMapGO.this.shrink();
        }
        ...
        public boolean remove(Object o) {
            try {
                ...
                return MutableLHashSeparateKVFloatCharMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
        ...
        @Override
        public void clear() {
            MutableLHashSeparateKVFloatCharMapGO.this.clear();
        }
    }
    ...
    class ValueView extends AbstractCharValueView {
        ...
        @Override
        public boolean contains(Object o) {
            return MutableLHashSeparateKVFloatCharMapGO.this.containsValue(o);
        }

        @Override
        public boolean contains(char v) {
            return MutableLHashSeparateKVFloatCharMapGO.this.containsValue(v);
        }
