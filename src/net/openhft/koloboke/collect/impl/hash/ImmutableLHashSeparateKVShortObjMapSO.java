...
public abstract class ImmutableLHashSeparateKVShortObjMapSO<V>
        extends ImmutableLHashSeparateKVShortKeyMap
        implements HashShortObjMap<V>,
        InternalShortObjMapOps<V>, SeparateKVShortObjLHash {

    V[] values;

    void copy(SeparateKVShortObjLHash hash) {
        super.copy(hash);
        // noinspection unchecked
        values = (V[]) hash.valueArray().clone();
    }

    void move(SeparateKVShortObjLHash hash) {
        super.move(hash);
        // noinspection unchecked
