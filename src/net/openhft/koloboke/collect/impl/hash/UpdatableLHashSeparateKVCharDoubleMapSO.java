...
public abstract class UpdatableLHashSeparateKVCharDoubleMapSO
        extends UpdatableLHashSeparateKVCharKeyMap
        implements HashCharDoubleMap, InternalCharDoubleMapOps, SeparateKVCharDoubleLHash {

    long[] values;

    void copy(SeparateKVCharDoubleLHash hash) {
        super.copy(hash);
        values = hash.valueArray().clone();
    }

    void move(SeparateKVCharDoubleLHash hash) {
        super.move(hash);
