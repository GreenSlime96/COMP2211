...
public abstract class ImmutableLHashSeparateKVCharObjMapSO<V>
        extends ImmutableLHashSeparateKVCharKeyMap
        implements HashCharObjMap<V>,
        InternalCharObjMapOps<V>, SeparateKVCharObjLHash {

    V[] values;

    void copy(SeparateKVCharObjLHash hash) {
        super.copy(hash);
        // noinspection unchecked
        values = (V[]) hash.valueArray().clone();
    }

    void move(SeparateKVCharObjLHash hash) {
        super.move(hash);
        // noinspection unchecked
