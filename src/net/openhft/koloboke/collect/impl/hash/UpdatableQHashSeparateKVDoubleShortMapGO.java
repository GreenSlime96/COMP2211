...
public class UpdatableQHashSeparateKVDoubleShortMapGO
        extends UpdatableQHashSeparateKVDoubleShortMapSO {
    ...
    class EntryView extends AbstractSetView<Map.Entry<Double, Short>>
        ...
        public HashConfig hashConfig() {
            return UpdatableQHashSeparateKVDoubleShortMapGO.this.hashConfig();
        }


        @Override
        public int size() {
            return UpdatableQHashSeparateKVDoubleShortMapGO.this.size();
        }

        @Override
        public double currentLoad() {
            return UpdatableQHashSeparateKVDoubleShortMapGO.this.currentLoad();
        }
        ...
        public int hashCode() {
            return UpdatableQHashSeparateKVDoubleShortMapGO.this.hashCode();
        }
        ...
        public boolean shrink() {
            return UpdatableQHashSeparateKVDoubleShortMapGO.this.shrink();
        }
        ...
        public boolean remove(Object o) {
            try {
                ...
                return UpdatableQHashSeparateKVDoubleShortMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
        ...
        @Override
        public void clear() {
            UpdatableQHashSeparateKVDoubleShortMapGO.this.clear();
        }
    }
    ...
    class ValueView extends AbstractShortValueView {
        ...
        @Override
        public boolean contains(Object o) {
            return UpdatableQHashSeparateKVDoubleShortMapGO.this.containsValue(o);
        }

        @Override
        public boolean contains(short v) {
            return UpdatableQHashSeparateKVDoubleShortMapGO.this.containsValue(v);
        }
