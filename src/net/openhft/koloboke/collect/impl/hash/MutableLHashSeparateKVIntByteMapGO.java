...
public class MutableLHashSeparateKVIntByteMapGO
        extends MutableLHashSeparateKVIntByteMapSO {
    ...
    class EntryView extends AbstractSetView<Map.Entry<Integer, Byte>>
        ...
        public boolean remove(Object o) {
            try {
                ...
                return MutableLHashSeparateKVIntByteMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
    ...
    class ValueView extends AbstractByteValueView {
        ...
        @Override
        public boolean contains(Object o) {
            return MutableLHashSeparateKVIntByteMapGO.this.containsValue(o);
        }

        @Override
        public boolean contains(byte v) {
            return MutableLHashSeparateKVIntByteMapGO.this.containsValue(v);
        }
