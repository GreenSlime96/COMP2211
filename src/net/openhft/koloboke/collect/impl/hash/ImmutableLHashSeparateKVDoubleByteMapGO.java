...
public class ImmutableLHashSeparateKVDoubleByteMapGO
        extends ImmutableLHashSeparateKVDoubleByteMapSO {
    ...
    class EntryView extends AbstractSetView<Map.Entry<Double, Byte>>
        ...
        public HashConfig hashConfig() {
            return ImmutableLHashSeparateKVDoubleByteMapGO.this.hashConfig();
        }


        @Override
        public int size() {
            return ImmutableLHashSeparateKVDoubleByteMapGO.this.size();
        }

        @Override
        public double currentLoad() {
            return ImmutableLHashSeparateKVDoubleByteMapGO.this.currentLoad();
        }
        ...
        public int hashCode() {
            return ImmutableLHashSeparateKVDoubleByteMapGO.this.hashCode();
        }
        ...
        public boolean shrink() {
            return ImmutableLHashSeparateKVDoubleByteMapGO.this.shrink();
        }
        ...
        public boolean remove(Object o) {
            try {
                ...
                return ImmutableLHashSeparateKVDoubleByteMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
        ...
        @Override
        public void clear() {
            ImmutableLHashSeparateKVDoubleByteMapGO.this.clear();
        }
    }
    ...
    class ValueView extends AbstractByteValueView {
        ...
        @Override
        public boolean contains(Object o) {
            return ImmutableLHashSeparateKVDoubleByteMapGO.this.containsValue(o);
        }

        @Override
        public boolean contains(byte v) {
            return ImmutableLHashSeparateKVDoubleByteMapGO.this.containsValue(v);
        }
