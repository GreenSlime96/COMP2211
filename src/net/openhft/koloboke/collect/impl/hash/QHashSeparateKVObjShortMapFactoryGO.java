...
public abstract class QHashSeparateKVObjShortMapFactoryGO<K>
        extends QHashSeparateKVObjShortMapFactorySO<K> {

    QHashSeparateKVObjShortMapFactoryGO(HashConfig hashConf, int defaultExpectedSize
    ...
    private <K2 extends K>
     UpdatableQHashSeparateKVObjShortMapGO<K2> shrunk(
            UpdatableQHashSeparateKVObjShortMapGO<K2> map) {
    ...
    public <K2 extends K>
     UpdatableQHashSeparateKVObjShortMapGO<K2> newUpdatableMap(
            Map<? extends K2, Short> map1, Map<? extends K2, Short> map2,
            int expectedSize) {
        UpdatableQHashSeparateKVObjShortMapGO<K2> map = newUpdatableMap(expectedSize);
        map.putAll(map1);
        map.putAll(map2);
        return shrunk(map);
    }
    ...
    public <K2 extends K>
     UpdatableQHashSeparateKVObjShortMapGO<K2> newUpdatableMap(
            Consumer<net.openhft.koloboke.function.ObjShortConsumer<K2>> entriesSupplier,
            int expectedSize) {
        final UpdatableQHashSeparateKVObjShortMapGO<K2> map = newUpdatableMap(expectedSize);
    ...
    @Nonnull
    public <K2 extends K>
     UpdatableQHashSeparateKVObjShortMapGO<K2> newUpdatableMapOf(
            K2 k1, short v1) {
        UpdatableQHashSeparateKVObjShortMapGO<K2> map = newUpdatableMap(1);
        map.put(k1, v1);
        return map;
    }
    ...
    public <K2 extends K>
     UpdatableQHashSeparateKVObjShortMapGO<K2> newUpdatableMapOf(
        ...
        UpdatableQHashSeparateKVObjShortMapGO<K2> map = newUpdatableMap(2);
        map.put(k1, v1);
        map.put(k2, v2);
        return map;
    }
    ...
    public <K2 extends K>
     UpdatableQHashSeparateKVObjShortMapGO<K2> newUpdatableMapOf(
            K2 k1, short v1, K2 k2, short v2,
            K2 k3, short v3) {
        UpdatableQHashSeparateKVObjShortMapGO<K2> map = newUpdatableMap(3);
        map.put(k1, v1);
        map.put(k2, v2);
        map.put(k3, v3);
        return map;
    ...
    public <K2 extends K>
     UpdatableQHashSeparateKVObjShortMapGO<K2> newUpdatableMapOf(
        ...
        UpdatableQHashSeparateKVObjShortMapGO<K2> map = newUpdatableMap(4);
        map.put(k1, v1);
        map.put(k2, v2);
        map.put(k3, v3);
        map.put(k4, v4);
    ...
    public <K2 extends K>
     UpdatableQHashSeparateKVObjShortMapGO<K2> newUpdatableMapOf(
            ...
            K2 k3, short v3, K2 k4, short v4,
            K2 k5, short v5) {
        UpdatableQHashSeparateKVObjShortMapGO<K2> map = newUpdatableMap(5);
        map.put(k1, v1);
        map.put(k2, v2);
        map.put(k3, v3);
        map.put(k4, v4);
    ...
    public <K2 extends K>
     HashObjShortMap<K2> newMutableMap(
            Map<? extends K2, Short> map, int expectedSize) {
        MutableQHashSeparateKVObjShortMapGO<K2> res = uninitializedMutableMap();
    ...
    public <K2 extends K>
     HashObjShortMap<K2> newImmutableMap(
            Map<? extends K2, Short> map, int expectedSize) {
        ImmutableQHashSeparateKVObjShortMapGO<K2> res = uninitializedImmutableMap();
        res.move(newUpdatableMap(map, expectedSize));
        return res;
    }
    ...
    public <K2 extends K>
     HashObjShortMap<K2> newImmutableMap(
            Consumer<net.openhft.koloboke.function.ObjShortConsumer<K2>> entriesSupplier
            , int expectedSize) {
        ImmutableQHashSeparateKVObjShortMapGO<K2> map = uninitializedImmutableMap();
        map.move(newUpdatableMap(entriesSupplier, expectedSize));
        return map;
    }
