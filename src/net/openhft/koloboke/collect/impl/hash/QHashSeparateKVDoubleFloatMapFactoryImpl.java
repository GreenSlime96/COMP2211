...
public final class QHashSeparateKVDoubleFloatMapFactoryImpl
        extends QHashSeparateKVDoubleFloatMapFactoryGO {
    ...
    QHashSeparateKVDoubleFloatMapFactoryImpl(HashConfig hashConf, int defaultExpectedSize) {
    ...
    static final class WithCustomDefaultValue
        ...
        @Override
         MutableQHashSeparateKVDoubleFloatMapGO uninitializedMutableMap() {
            MutableQHashSeparateKVDoubleFloatMap.WithCustomDefaultValue map =
                    new MutableQHashSeparateKVDoubleFloatMap.WithCustomDefaultValue();
            map.defaultValue = defaultValue;
            return map;
        }
        @Override
         UpdatableQHashSeparateKVDoubleFloatMapGO uninitializedUpdatableMap() {
            UpdatableQHashSeparateKVDoubleFloatMap.WithCustomDefaultValue map =
                    new UpdatableQHashSeparateKVDoubleFloatMap.WithCustomDefaultValue();
            map.defaultValue = defaultValue;
            return map;
        }
        @Override
         ImmutableQHashSeparateKVDoubleFloatMapGO uninitializedImmutableMap() {
            ImmutableQHashSeparateKVDoubleFloatMap.WithCustomDefaultValue map =
                    new ImmutableQHashSeparateKVDoubleFloatMap.WithCustomDefaultValue();
            map.defaultValue = defaultValue;
            return map;
        }
        ...
        public HashDoubleFloatMapFactory withDefaultValue(float defaultValue) {
            if (defaultValue == 0.0f)
                return new QHashSeparateKVDoubleFloatMapFactoryImpl(getHashConfig(), getDefaultExpectedSize()
        );
