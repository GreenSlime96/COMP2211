...
public class ImmutableQHashSeparateKVCharObjMapGO<V>
        extends ImmutableQHashSeparateKVCharObjMapSO<V> {
    ...
    class EntryView extends AbstractSetView<Map.Entry<Character, V>>
        ...
        public HashConfig hashConfig() {
            return ImmutableQHashSeparateKVCharObjMapGO.this.hashConfig();
        }


        @Override
        public int size() {
            return ImmutableQHashSeparateKVCharObjMapGO.this.size();
        }

        @Override
        public double currentLoad() {
            return ImmutableQHashSeparateKVCharObjMapGO.this.currentLoad();
        }
        ...
        public int hashCode() {
            return ImmutableQHashSeparateKVCharObjMapGO.this.hashCode();
        }
        ...
        public boolean shrink() {
            return ImmutableQHashSeparateKVCharObjMapGO.this.shrink();
        }
        ...
        public boolean remove(Object o) {
            try {
                ...
                char key = e.getKey();
                V value = e.getValue();
                return ImmutableQHashSeparateKVCharObjMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
        ...
        @Override
        public void clear() {
            ImmutableQHashSeparateKVCharObjMapGO.this.clear();
        }
    }
    ...
    private class ImmutableEntry extends CharObjEntry {
        private final char key;
        private final V value;

        ImmutableEntry(char key, V value) {
            this.key = key;
            this.value = value;
        }
    ...
    class ValueView extends AbstractObjValueView<V> {
        ...
        @Override
        public boolean contains(Object o) {
            return ImmutableQHashSeparateKVCharObjMapGO.this.containsValue(o);
        }
