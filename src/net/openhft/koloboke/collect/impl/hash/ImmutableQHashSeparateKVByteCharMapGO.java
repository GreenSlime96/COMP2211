...
public class ImmutableQHashSeparateKVByteCharMapGO
        extends ImmutableQHashSeparateKVByteCharMapSO {
    ...
    class EntryView extends AbstractSetView<Map.Entry<Byte, Character>>
        ...
        public HashConfig hashConfig() {
            return ImmutableQHashSeparateKVByteCharMapGO.this.hashConfig();
        }


        @Override
        public int size() {
            return ImmutableQHashSeparateKVByteCharMapGO.this.size();
        }

        @Override
        public double currentLoad() {
            return ImmutableQHashSeparateKVByteCharMapGO.this.currentLoad();
        }
        ...
        public int hashCode() {
            return ImmutableQHashSeparateKVByteCharMapGO.this.hashCode();
        }
        ...
        public boolean shrink() {
            return ImmutableQHashSeparateKVByteCharMapGO.this.shrink();
        }
        ...
        public boolean remove(Object o) {
            try {
                ...
                return ImmutableQHashSeparateKVByteCharMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
        ...
        @Override
        public void clear() {
            ImmutableQHashSeparateKVByteCharMapGO.this.clear();
        }
    }
    ...
    private class ImmutableEntry extends ByteCharEntry {
        private final byte key;
        private final char value;

        ImmutableEntry(byte key, char value) {
            this.key = key;
            this.value = value;
        }
    ...
    class ValueView extends AbstractCharValueView {
        ...
        @Override
        public boolean contains(Object o) {
            return ImmutableQHashSeparateKVByteCharMapGO.this.containsValue(o);
        }

        @Override
        public boolean contains(char v) {
            return ImmutableQHashSeparateKVByteCharMapGO.this.containsValue(v);
        }
