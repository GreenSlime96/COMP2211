...
public class UpdatableQHashSeparateKVByteIntMapGO
        extends UpdatableQHashSeparateKVByteIntMapSO {
    ...
    class EntryView extends AbstractSetView<Map.Entry<Byte, Integer>>
        ...
        public HashConfig hashConfig() {
            return UpdatableQHashSeparateKVByteIntMapGO.this.hashConfig();
        }


        @Override
        public int size() {
            return UpdatableQHashSeparateKVByteIntMapGO.this.size();
        }

        @Override
        public double currentLoad() {
            return UpdatableQHashSeparateKVByteIntMapGO.this.currentLoad();
        }
        ...
        public int hashCode() {
            return UpdatableQHashSeparateKVByteIntMapGO.this.hashCode();
        }
        ...
        public boolean shrink() {
            return UpdatableQHashSeparateKVByteIntMapGO.this.shrink();
        }
        ...
        public boolean remove(Object o) {
            try {
                ...
                return UpdatableQHashSeparateKVByteIntMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
        ...
        @Override
        public void clear() {
            UpdatableQHashSeparateKVByteIntMapGO.this.clear();
        }
    }
    ...
    class ValueView extends AbstractIntValueView {
        ...
        @Override
        public boolean contains(Object o) {
            return UpdatableQHashSeparateKVByteIntMapGO.this.containsValue(o);
        }

        @Override
        public boolean contains(int v) {
            return UpdatableQHashSeparateKVByteIntMapGO.this.containsValue(v);
        }
