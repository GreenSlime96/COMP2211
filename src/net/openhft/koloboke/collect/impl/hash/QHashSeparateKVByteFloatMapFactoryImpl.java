...
public final class QHashSeparateKVByteFloatMapFactoryImpl
        extends QHashSeparateKVByteFloatMapFactoryGO {
    ...
    /** For ServiceLoader */
    public QHashSeparateKVByteFloatMapFactoryImpl() {
    ...
    QHashSeparateKVByteFloatMapFactoryImpl(HashConfig hashConf, int defaultExpectedSize, byte lower, byte upper) {
    ...
    static final class WithCustomDefaultValue
        ...
        @Override
         MutableQHashSeparateKVByteFloatMapGO uninitializedMutableMap() {
            MutableQHashSeparateKVByteFloatMap.WithCustomDefaultValue map =
                    new MutableQHashSeparateKVByteFloatMap.WithCustomDefaultValue();
            map.defaultValue = defaultValue;
            return map;
        }
        @Override
         UpdatableQHashSeparateKVByteFloatMapGO uninitializedUpdatableMap() {
            UpdatableQHashSeparateKVByteFloatMap.WithCustomDefaultValue map =
                    new UpdatableQHashSeparateKVByteFloatMap.WithCustomDefaultValue();
            map.defaultValue = defaultValue;
            return map;
        }
        @Override
         ImmutableQHashSeparateKVByteFloatMapGO uninitializedImmutableMap() {
            ImmutableQHashSeparateKVByteFloatMap.WithCustomDefaultValue map =
                    new ImmutableQHashSeparateKVByteFloatMap.WithCustomDefaultValue();
            map.defaultValue = defaultValue;
            return map;
        }
        ...
        public HashByteFloatMapFactory withDefaultValue(float defaultValue) {
            if (defaultValue == 0.0f)
                return new QHashSeparateKVByteFloatMapFactoryImpl(getHashConfig(), getDefaultExpectedSize()
