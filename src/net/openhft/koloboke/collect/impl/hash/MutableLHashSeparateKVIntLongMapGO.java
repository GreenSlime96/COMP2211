...
public class MutableLHashSeparateKVIntLongMapGO
        extends MutableLHashSeparateKVIntLongMapSO {
    ...
    class EntryView extends AbstractSetView<Map.Entry<Integer, Long>>
        ...
        public HashConfig hashConfig() {
            return MutableLHashSeparateKVIntLongMapGO.this.hashConfig();
        }


        @Override
        public int size() {
            return MutableLHashSeparateKVIntLongMapGO.this.size();
        }

        @Override
        public double currentLoad() {
            return MutableLHashSeparateKVIntLongMapGO.this.currentLoad();
        }
        ...
        public int hashCode() {
            return MutableLHashSeparateKVIntLongMapGO.this.hashCode();
        }
        ...
        public boolean shrink() {
            return MutableLHashSeparateKVIntLongMapGO.this.shrink();
        }
        ...
        public boolean remove(Object o) {
            try {
                ...
                return MutableLHashSeparateKVIntLongMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
        ...
        @Override
        public void clear() {
            MutableLHashSeparateKVIntLongMapGO.this.clear();
        }
    }
    ...
    class ValueView extends AbstractLongValueView {
        ...
        @Override
        public boolean contains(Object o) {
            return MutableLHashSeparateKVIntLongMapGO.this.containsValue(o);
        }

        @Override
        public boolean contains(long v) {
            return MutableLHashSeparateKVIntLongMapGO.this.containsValue(v);
        }
