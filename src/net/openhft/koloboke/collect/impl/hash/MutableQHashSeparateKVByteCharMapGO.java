...
import net.openhft.koloboke.function.ByteCharToCharFunction;
import net.openhft.koloboke.function.ByteToCharFunction;
...
public class MutableQHashSeparateKVByteCharMapGO
        extends MutableQHashSeparateKVByteCharMapSO {

    @Override
    final void copy(SeparateKVByteCharQHash hash) {
    ...
    @Override
    final void move(SeparateKVByteCharQHash hash) {
        int myMC = modCount(), hashMC = hash.modCount();
        super.move(hash);
        if (myMC != modCount() || hashMC != hash.modCount())
            throw new ConcurrentModificationException();
    ...
    public boolean containsAllEntries(Map<?, ?> m) {
        return CommonByteCharMapOps.containsAllEntries(this, m);
    }
    ...
    @Override
    public Character compute(Byte key,
            BiFunction<? super Byte, ? super Character, ? extends Character> remappingFunction) {
        byte k = key;
    ...
    @Override
    public Character computeIfAbsent(Byte key,
            Function<? super Byte, ? extends Character> mappingFunction) {
        byte k = key;
    ...
    @Override
    public Character computeIfPresent(Byte key,
            BiFunction<? super Byte, ? super Character, ? extends Character> remappingFunction) {
        byte k = key;
        if (remappingFunction == null)
            throw new java.lang.NullPointerException();
    ...
    @Override
    public Character merge(Byte key, Character value,
    ...
    @Override
    public char addValue(byte key, char addition, char defaultValue) {
    ...
    public void putAll(@Nonnull Map<? extends Byte, ? extends Character> m) {
        CommonByteCharMapOps.putAll(this, m);
    }
    ...
    public void replaceAll(
            BiFunction<? super Byte, ? super Character, ? extends Character> function) {
        if (function == null)
            throw new java.lang.NullPointerException();
        if (isEmpty())
            return;
    ...
    class EntryView extends AbstractSetView<Map.Entry<Byte, Character>>
            implements HashObjSet<Map.Entry<Byte, Character>>,
            InternalObjCollectionOps<Map.Entry<Byte, Character>> {

        @Nonnull
        @Override
        public Equivalence<Entry<Byte, Character>> equivalence() {
        ...
        public HashConfig hashConfig() {
            return MutableQHashSeparateKVByteCharMapGO.this.hashConfig();
        }


        @Override
        public int size() {
            return MutableQHashSeparateKVByteCharMapGO.this.size();
        }

        @Override
        public double currentLoad() {
            return MutableQHashSeparateKVByteCharMapGO.this.currentLoad();
        }
        ...
        public int hashCode() {
            return MutableQHashSeparateKVByteCharMapGO.this.hashCode();
        }
        ...
        public boolean shrink() {
            return MutableQHashSeparateKVByteCharMapGO.this.shrink();
        }
        ...
        public boolean remove(Object o) {
            try {
                ...
                return MutableQHashSeparateKVByteCharMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
        ...
        @Override
        public void clear() {
            MutableQHashSeparateKVByteCharMapGO.this.clear();
        }
    }
    ...
    class MutableEntry extends ByteCharEntry {
        final int modCount;
    ...
    class ValueView extends AbstractCharValueView {
        ...
        @Override
        public boolean contains(Object o) {
            return MutableQHashSeparateKVByteCharMapGO.this.containsValue(o);
        }

        @Override
        public boolean contains(char v) {
            return MutableQHashSeparateKVByteCharMapGO.this.containsValue(v);
        }
    ...
    class NoRemovedEntryIterator implements ObjIterator<Map.Entry<Byte, Character>> {
        final byte[] keys;
        final char[] vals;
        final byte free;
        final byte removed;
    ...
    class SomeRemovedEntryIterator implements ObjIterator<Map.Entry<Byte, Character>> {
        final byte[] keys;
        final char[] vals;
        final byte free;
        final byte removed;
    ...
    class SomeRemovedEntryCursor implements ObjCursor<Map.Entry<Byte, Character>> {
        final byte[] keys;
        final char[] vals;
        final byte free;
        final byte removed;
    ...
    class SomeRemovedMapCursor implements ByteCharCursor {
        final byte[] keys;
        final char[] vals;
        final byte free;
        final byte removed;
