...
public class MutableLHashSeparateKVIntObjMapGO<V>
        extends MutableLHashSeparateKVIntObjMapSO<V> {
    ...
    class EntryView extends AbstractSetView<Map.Entry<Integer, V>>
        ...
        public HashConfig hashConfig() {
            return MutableLHashSeparateKVIntObjMapGO.this.hashConfig();
        }


        @Override
        public int size() {
            return MutableLHashSeparateKVIntObjMapGO.this.size();
        }

        @Override
        public double currentLoad() {
            return MutableLHashSeparateKVIntObjMapGO.this.currentLoad();
        }
        ...
        public int hashCode() {
            return MutableLHashSeparateKVIntObjMapGO.this.hashCode();
        }
        ...
        public boolean shrink() {
            return MutableLHashSeparateKVIntObjMapGO.this.shrink();
        }
        ...
        public boolean remove(Object o) {
            try {
                ...
                int key = e.getKey();
                V value = e.getValue();
                return MutableLHashSeparateKVIntObjMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
        ...
        @Override
        public void clear() {
            MutableLHashSeparateKVIntObjMapGO.this.clear();
        }
    }
    ...
    class ValueView extends AbstractObjValueView<V> {
        ...
        @Override
        public boolean contains(Object o) {
            return MutableLHashSeparateKVIntObjMapGO.this.containsValue(o);
        }
