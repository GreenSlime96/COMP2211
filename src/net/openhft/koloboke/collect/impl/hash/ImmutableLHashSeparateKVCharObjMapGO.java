...
public class ImmutableLHashSeparateKVCharObjMapGO<V>
        extends ImmutableLHashSeparateKVCharObjMapSO<V> {
    ...
    class EntryView extends AbstractSetView<Map.Entry<Character, V>>
        ...
        public HashConfig hashConfig() {
            return ImmutableLHashSeparateKVCharObjMapGO.this.hashConfig();
        }


        @Override
        public int size() {
            return ImmutableLHashSeparateKVCharObjMapGO.this.size();
        }

        @Override
        public double currentLoad() {
            return ImmutableLHashSeparateKVCharObjMapGO.this.currentLoad();
        }
        ...
        public int hashCode() {
            return ImmutableLHashSeparateKVCharObjMapGO.this.hashCode();
        }
        ...
        public boolean shrink() {
            return ImmutableLHashSeparateKVCharObjMapGO.this.shrink();
        }
        ...
        public boolean remove(Object o) {
            try {
                ...
                char key = e.getKey();
                V value = e.getValue();
                return ImmutableLHashSeparateKVCharObjMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
        ...
        @Override
        public void clear() {
            ImmutableLHashSeparateKVCharObjMapGO.this.clear();
        }
    }
    ...
    class ValueView extends AbstractObjValueView<V> {
        ...
        @Override
        public boolean contains(Object o) {
            return ImmutableLHashSeparateKVCharObjMapGO.this.containsValue(o);
        }
