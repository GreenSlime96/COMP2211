...
public class ImmutableLHashParallelKVShortCharMapGO
        extends ImmutableLHashParallelKVShortCharMapSO {
    ...
    class EntryView extends AbstractSetView<Map.Entry<Short, Character>>
        ...
        public HashConfig hashConfig() {
            return ImmutableLHashParallelKVShortCharMapGO.this.hashConfig();
        }


        @Override
        public int size() {
            return ImmutableLHashParallelKVShortCharMapGO.this.size();
        }

        @Override
        public double currentLoad() {
            return ImmutableLHashParallelKVShortCharMapGO.this.currentLoad();
        }
        ...
        public int hashCode() {
            return ImmutableLHashParallelKVShortCharMapGO.this.hashCode();
        }
        ...
        public boolean shrink() {
            return ImmutableLHashParallelKVShortCharMapGO.this.shrink();
        }
        ...
        public boolean remove(Object o) {
            try {
                ...
                return ImmutableLHashParallelKVShortCharMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
        ...
        @Override
        public void clear() {
            ImmutableLHashParallelKVShortCharMapGO.this.clear();
        }
    }
    ...
    class ValueView extends AbstractCharValueView {
        ...
        @Override
        public boolean contains(Object o) {
            return ImmutableLHashParallelKVShortCharMapGO.this.containsValue(o);
        }

        @Override
        public boolean contains(char v) {
            return ImmutableLHashParallelKVShortCharMapGO.this.containsValue(v);
        }
