...
public class ImmutableQHashSeparateKVByteDoubleMapGO
        extends ImmutableQHashSeparateKVByteDoubleMapSO {
    ...
    class EntryView extends AbstractSetView<Map.Entry<Byte, Double>>
        ...
        public boolean remove(Object o) {
            try {
                ...
                return ImmutableQHashSeparateKVByteDoubleMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
    ...
    class ValueView extends AbstractDoubleValueView {
        ...
        @Override
        public boolean contains(Object o) {
            return ImmutableQHashSeparateKVByteDoubleMapGO.this.containsValue(o);
        }

        @Override
        public boolean contains(double v) {
            return ImmutableQHashSeparateKVByteDoubleMapGO.this.containsValue(v);
        }

        @Override
        public boolean contains(long bits) {
            return ImmutableQHashSeparateKVByteDoubleMapGO.this.containsValue(bits);
        }
