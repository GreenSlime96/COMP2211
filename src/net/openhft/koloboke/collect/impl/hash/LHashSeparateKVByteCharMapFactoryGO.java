...
public abstract class LHashSeparateKVByteCharMapFactoryGO
        extends LHashSeparateKVByteCharMapFactorySO {

    LHashSeparateKVByteCharMapFactoryGO(HashConfig hashConf, int defaultExpectedSize
    ...
    private  UpdatableLHashSeparateKVByteCharMapGO shrunk(
            UpdatableLHashSeparateKVByteCharMapGO map) {
    ...
    @Override
    @Nonnull
    public  MutableLHashSeparateKVByteCharMapGO newMutableMap() {
    ...
    public  UpdatableLHashSeparateKVByteCharMapGO newUpdatableMap(
            Map<Byte, Character> map1, Map<Byte, Character> map2,
            int expectedSize) {
        UpdatableLHashSeparateKVByteCharMapGO map = newUpdatableMap(expectedSize);
        map.putAll(map1);
        map.putAll(map2);
        return shrunk(map);
    }
    ...
    public  UpdatableLHashSeparateKVByteCharMapGO newUpdatableMap(
            Consumer<net.openhft.koloboke.function.ByteCharConsumer> entriesSupplier,
            int expectedSize) {
        final UpdatableLHashSeparateKVByteCharMapGO map = newUpdatableMap(expectedSize);
    ...
    @Override
    @Nonnull
    public  UpdatableLHashSeparateKVByteCharMapGO newUpdatableMapOf(
            byte k1, char v1) {
        UpdatableLHashSeparateKVByteCharMapGO map = newUpdatableMap(1);
        map.put(k1, v1);
        return map;
    }
    ...
    public  UpdatableLHashSeparateKVByteCharMapGO newUpdatableMapOf(
        ...
        UpdatableLHashSeparateKVByteCharMapGO map = newUpdatableMap(2);
        map.put(k1, v1);
        map.put(k2, v2);
        return map;
    }
    ...
    public  UpdatableLHashSeparateKVByteCharMapGO newUpdatableMapOf(
            byte k1, char v1, byte k2, char v2,
            byte k3, char v3) {
        UpdatableLHashSeparateKVByteCharMapGO map = newUpdatableMap(3);
        map.put(k1, v1);
        map.put(k2, v2);
        map.put(k3, v3);
        return map;
    ...
    public  UpdatableLHashSeparateKVByteCharMapGO newUpdatableMapOf(
        ...
        UpdatableLHashSeparateKVByteCharMapGO map = newUpdatableMap(4);
        map.put(k1, v1);
        map.put(k2, v2);
        map.put(k3, v3);
        map.put(k4, v4);
    ...
    public  UpdatableLHashSeparateKVByteCharMapGO newUpdatableMapOf(
            ...
            byte k3, char v3, byte k4, char v4,
            byte k5, char v5) {
        UpdatableLHashSeparateKVByteCharMapGO map = newUpdatableMap(5);
        map.put(k1, v1);
        map.put(k2, v2);
        map.put(k3, v3);
        map.put(k4, v4);
    ...
    public  HashByteCharMap newMutableMap(Map<Byte, Character> map1,
        ...
        MutableLHashSeparateKVByteCharMapGO res = uninitializedMutableMap();
    ...
    public  HashByteCharMap newImmutableMap(Map<Byte, Character> map1,
            Map<Byte, Character> map2, int expectedSize) {
        ImmutableLHashSeparateKVByteCharMapGO res = uninitializedImmutableMap();
        res.move(newUpdatableMap(map1, map2, expectedSize));
        return res;
    }
    ...
    public  HashByteCharMap newImmutableMap(
            Consumer<net.openhft.koloboke.function.ByteCharConsumer> entriesSupplier
            , int expectedSize) {
        ImmutableLHashSeparateKVByteCharMapGO map = uninitializedImmutableMap();
        map.move(newUpdatableMap(entriesSupplier, expectedSize));
        return map;
    }
