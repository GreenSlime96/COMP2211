...
public class MutableQHashSeparateKVShortByteMapGO
        extends MutableQHashSeparateKVShortByteMapSO {
    ...
    class EntryView extends AbstractSetView<Map.Entry<Short, Byte>>
        ...
        public HashConfig hashConfig() {
            return MutableQHashSeparateKVShortByteMapGO.this.hashConfig();
        }


        @Override
        public int size() {
            return MutableQHashSeparateKVShortByteMapGO.this.size();
        }

        @Override
        public double currentLoad() {
            return MutableQHashSeparateKVShortByteMapGO.this.currentLoad();
        }
        ...
        public int hashCode() {
            return MutableQHashSeparateKVShortByteMapGO.this.hashCode();
        }
        ...
        public boolean shrink() {
            return MutableQHashSeparateKVShortByteMapGO.this.shrink();
        }
        ...
        public boolean remove(Object o) {
            try {
                ...
                return MutableQHashSeparateKVShortByteMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
        ...
        @Override
        public void clear() {
            MutableQHashSeparateKVShortByteMapGO.this.clear();
        }
    }
    ...
    class ValueView extends AbstractByteValueView {
        ...
        @Override
        public boolean contains(Object o) {
            return MutableQHashSeparateKVShortByteMapGO.this.containsValue(o);
        }

        @Override
        public boolean contains(byte v) {
            return MutableQHashSeparateKVShortByteMapGO.this.containsValue(v);
        }
    ...
    class SomeRemovedEntryIterator implements ObjIterator<Map.Entry<Short, Byte>> {
        final short[] keys;
        final byte[] vals;
        final short free;
        final short removed;
    ...
    class SomeRemovedEntryCursor implements ObjCursor<Map.Entry<Short, Byte>> {
        final short[] keys;
        final byte[] vals;
        final short free;
        final short removed;
    ...
    class SomeRemovedMapCursor implements ShortByteCursor {
        final short[] keys;
        final byte[] vals;
        final short free;
        final short removed;
