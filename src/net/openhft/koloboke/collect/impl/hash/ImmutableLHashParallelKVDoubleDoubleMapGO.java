...
public class ImmutableLHashParallelKVDoubleDoubleMapGO
        extends ImmutableLHashParallelKVDoubleDoubleMapSO {
    ...
    class EntryView extends AbstractSetView<Map.Entry<Double, Double>>
        ...
        public HashConfig hashConfig() {
            return ImmutableLHashParallelKVDoubleDoubleMapGO.this.hashConfig();
        }


        @Override
        public int size() {
            return ImmutableLHashParallelKVDoubleDoubleMapGO.this.size();
        }

        @Override
        public double currentLoad() {
            return ImmutableLHashParallelKVDoubleDoubleMapGO.this.currentLoad();
        }
        ...
        public int hashCode() {
            return ImmutableLHashParallelKVDoubleDoubleMapGO.this.hashCode();
        }
        ...
        public boolean shrink() {
            return ImmutableLHashParallelKVDoubleDoubleMapGO.this.shrink();
        }
        ...
        public boolean remove(Object o) {
            try {
                ...
                return ImmutableLHashParallelKVDoubleDoubleMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
        ...
        @Override
        public void clear() {
            ImmutableLHashParallelKVDoubleDoubleMapGO.this.clear();
        }
    }
    ...
    class ValueView extends AbstractDoubleValueView {
        ...
        @Override
        public boolean contains(Object o) {
            return ImmutableLHashParallelKVDoubleDoubleMapGO.this.containsValue(o);
        }

        @Override
        public boolean contains(double v) {
            return ImmutableLHashParallelKVDoubleDoubleMapGO.this.containsValue(v);
        }

        @Override
        public boolean contains(long bits) {
            return ImmutableLHashParallelKVDoubleDoubleMapGO.this.containsValue(bits);
        }
