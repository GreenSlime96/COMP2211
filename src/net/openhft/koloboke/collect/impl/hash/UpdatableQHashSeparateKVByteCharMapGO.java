...
public class UpdatableQHashSeparateKVByteCharMapGO
        extends UpdatableQHashSeparateKVByteCharMapSO {
    ...
    class EntryView extends AbstractSetView<Map.Entry<Byte, Character>>
        ...
        public boolean remove(Object o) {
            try {
                ...
                return UpdatableQHashSeparateKVByteCharMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
    ...
    class ValueView extends AbstractCharValueView {
        ...
        @Override
        public boolean contains(Object o) {
            return UpdatableQHashSeparateKVByteCharMapGO.this.containsValue(o);
        }

        @Override
        public boolean contains(char v) {
            return UpdatableQHashSeparateKVByteCharMapGO.this.containsValue(v);
        }
