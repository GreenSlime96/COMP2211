...
public class MutableQHashSeparateKVIntLongMapGO
    ...
    class SomeRemovedEntryIterator implements ObjIterator<Map.Entry<Integer, Long>> {
        final int[] keys;
        final long[] vals;
        final int free;
        final int removed;
    ...
    class SomeRemovedEntryCursor implements ObjCursor<Map.Entry<Integer, Long>> {
        final int[] keys;
        final long[] vals;
        final int free;
        final int removed;
    ...
    class SomeRemovedMapCursor implements IntLongCursor {
        final int[] keys;
        final long[] vals;
        final int free;
        final int removed;
