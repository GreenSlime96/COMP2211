...
public final class LHashByteSetFactoryImpl extends LHashByteSetFactoryGO {

    /** For ServiceLoader */
    public LHashByteSetFactoryImpl() {
    ...
    public LHashByteSetFactoryImpl(HashConfig hashConf, int defaultExpectedSize
    ...
    HashByteSetFactory withDomain(byte lower, byte upper) {
        if (lower == getLowerKeyDomainBound() && upper == getUpperKeyDomainBound())
            return this;
        return new LHashByteSetFactoryImpl(getHashConfig(), getDefaultExpectedSize(), lower, upper);
    }
