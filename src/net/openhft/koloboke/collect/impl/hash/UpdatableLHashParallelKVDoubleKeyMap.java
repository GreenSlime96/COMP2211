...
public abstract class UpdatableLHashParallelKVDoubleKeyMap
        extends UpdatableParallelKVDoubleLHashGO {
    ...
    class KeyView extends AbstractDoubleKeyView
        ...
        public final boolean contains(Object o) {
            return UpdatableLHashParallelKVDoubleKeyMap.this.contains(o);
        }

        @Override
        public boolean contains(double key) {
            return UpdatableLHashParallelKVDoubleKeyMap.this.contains(key);
        }

        @Override
        public boolean contains(long bits) {
            return UpdatableLHashParallelKVDoubleKeyMap.this.contains(bits);
        }


        @Override
        public void forEach(Consumer<? super Double> action) {
            UpdatableLHashParallelKVDoubleKeyMap.this.forEach(action);
        }
        ...
        public boolean forEachWhile(DoublePredicate
                predicate) {
            return UpdatableLHashParallelKVDoubleKeyMap.this.forEachWhile(predicate);
        }

        @Override
        public boolean allContainingIn(DoubleCollection c) {
            return UpdatableLHashParallelKVDoubleKeyMap.this.allContainingIn(c);
        }

        @Override
        public boolean reverseAddAllTo(DoubleCollection c) {
            return UpdatableLHashParallelKVDoubleKeyMap.this.reverseAddAllTo(c);
        }

        @Override
        public boolean reverseRemoveAllFrom(DoubleSet s) {
            return UpdatableLHashParallelKVDoubleKeyMap.this.reverseRemoveAllFrom(s);
        }
        ...
        public <T> T[] toArray(@Nonnull T[] a) {
            return UpdatableLHashParallelKVDoubleKeyMap.this.toArray(a);
        }
        ...
        public boolean removeIf(Predicate<? super Double> filter) {
            return UpdatableLHashParallelKVDoubleKeyMap.this.removeIf(filter);
        }
        ...
        public boolean removeAll(@Nonnull Collection<?> c) {
            if (c instanceof DoubleCollection) {
                ...
                return UpdatableLHashParallelKVDoubleKeyMap.this.removeAll(this, (DoubleCollection) c);
            }
            return UpdatableLHashParallelKVDoubleKeyMap.this.removeAll(this, c);
        }

        @Override
        public boolean retainAll(@Nonnull Collection<?> c) {
            return UpdatableLHashParallelKVDoubleKeyMap.this.retainAll(this, c);
        }
