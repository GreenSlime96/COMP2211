...
public class UpdatableLHashSeparateKVByteLongMapGO
        extends UpdatableLHashSeparateKVByteLongMapSO {
    ...
    class EntryView extends AbstractSetView<Map.Entry<Byte, Long>>
        ...
        public HashConfig hashConfig() {
            return UpdatableLHashSeparateKVByteLongMapGO.this.hashConfig();
        }


        @Override
        public int size() {
            return UpdatableLHashSeparateKVByteLongMapGO.this.size();
        }

        @Override
        public double currentLoad() {
            return UpdatableLHashSeparateKVByteLongMapGO.this.currentLoad();
        }
        ...
        public int hashCode() {
            return UpdatableLHashSeparateKVByteLongMapGO.this.hashCode();
        }
        ...
        public boolean shrink() {
            return UpdatableLHashSeparateKVByteLongMapGO.this.shrink();
        }
        ...
        public boolean remove(Object o) {
            try {
                ...
                return UpdatableLHashSeparateKVByteLongMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
        ...
        @Override
        public void clear() {
            UpdatableLHashSeparateKVByteLongMapGO.this.clear();
        }
    }
    ...
    class ValueView extends AbstractLongValueView {
        ...
        @Override
        public boolean contains(Object o) {
            return UpdatableLHashSeparateKVByteLongMapGO.this.containsValue(o);
        }

        @Override
        public boolean contains(long v) {
            return UpdatableLHashSeparateKVByteLongMapGO.this.containsValue(v);
        }
