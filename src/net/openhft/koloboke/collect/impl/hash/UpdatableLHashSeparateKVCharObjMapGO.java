...
public class UpdatableLHashSeparateKVCharObjMapGO<V>
        extends UpdatableLHashSeparateKVCharObjMapSO<V> {
    ...
    class EntryView extends AbstractSetView<Map.Entry<Character, V>>
        ...
        public HashConfig hashConfig() {
            return UpdatableLHashSeparateKVCharObjMapGO.this.hashConfig();
        }


        @Override
        public int size() {
            return UpdatableLHashSeparateKVCharObjMapGO.this.size();
        }

        @Override
        public double currentLoad() {
            return UpdatableLHashSeparateKVCharObjMapGO.this.currentLoad();
        }
        ...
        public int hashCode() {
            return UpdatableLHashSeparateKVCharObjMapGO.this.hashCode();
        }
        ...
        public boolean shrink() {
            return UpdatableLHashSeparateKVCharObjMapGO.this.shrink();
        }
        ...
        public boolean remove(Object o) {
            try {
                ...
                char key = e.getKey();
                V value = e.getValue();
                return UpdatableLHashSeparateKVCharObjMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
        ...
        @Override
        public void clear() {
            UpdatableLHashSeparateKVCharObjMapGO.this.clear();
        }
    }
    ...
    class ValueView extends AbstractObjValueView<V> {
        ...
        @Override
        public boolean contains(Object o) {
            return UpdatableLHashSeparateKVCharObjMapGO.this.containsValue(o);
        }
