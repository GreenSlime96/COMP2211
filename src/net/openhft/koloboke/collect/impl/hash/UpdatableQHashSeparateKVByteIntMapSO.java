...
public abstract class UpdatableQHashSeparateKVByteIntMapSO
        extends UpdatableQHashSeparateKVByteKeyMap
        implements HashByteIntMap, InternalByteIntMapOps, SeparateKVByteIntQHash {

    int[] values;

    void copy(SeparateKVByteIntQHash hash) {
        super.copy(hash);
        values = hash.valueArray().clone();
    }

    void move(SeparateKVByteIntQHash hash) {
        super.move(hash);
