...
public class ImmutableLHashSeparateKVShortIntMapGO
        extends ImmutableLHashSeparateKVShortIntMapSO {
    ...
    class EntryView extends AbstractSetView<Map.Entry<Short, Integer>>
        ...
        public HashConfig hashConfig() {
            return ImmutableLHashSeparateKVShortIntMapGO.this.hashConfig();
        }


        @Override
        public int size() {
            return ImmutableLHashSeparateKVShortIntMapGO.this.size();
        }

        @Override
        public double currentLoad() {
            return ImmutableLHashSeparateKVShortIntMapGO.this.currentLoad();
        }
        ...
        public int hashCode() {
            return ImmutableLHashSeparateKVShortIntMapGO.this.hashCode();
        }
        ...
        public boolean shrink() {
            return ImmutableLHashSeparateKVShortIntMapGO.this.shrink();
        }
        ...
        public boolean remove(Object o) {
            try {
                ...
                return ImmutableLHashSeparateKVShortIntMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
        ...
        @Override
        public void clear() {
            ImmutableLHashSeparateKVShortIntMapGO.this.clear();
        }
    }
    ...
    class ValueView extends AbstractIntValueView {
        ...
        @Override
        public boolean contains(Object o) {
            return ImmutableLHashSeparateKVShortIntMapGO.this.containsValue(o);
        }

        @Override
        public boolean contains(int v) {
            return ImmutableLHashSeparateKVShortIntMapGO.this.containsValue(v);
        }
