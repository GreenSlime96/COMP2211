...
public abstract class ImmutableQHashSeparateKVDoubleCharMapSO
        extends ImmutableQHashSeparateKVDoubleKeyMap
        implements HashDoubleCharMap, InternalDoubleCharMapOps, SeparateKVDoubleCharQHash {

    char[] values;

    void copy(SeparateKVDoubleCharQHash hash) {
        super.copy(hash);
        values = hash.valueArray().clone();
    }

    void move(SeparateKVDoubleCharQHash hash) {
        super.move(hash);
