...
public class UpdatableLHashParallelKVFloatFloatMapGO
        extends UpdatableLHashParallelKVFloatFloatMapSO {
    ...
    class EntryView extends AbstractSetView<Map.Entry<Float, Float>>
        ...
        public HashConfig hashConfig() {
            return UpdatableLHashParallelKVFloatFloatMapGO.this.hashConfig();
        }


        @Override
        public int size() {
            return UpdatableLHashParallelKVFloatFloatMapGO.this.size();
        }

        @Override
        public double currentLoad() {
            return UpdatableLHashParallelKVFloatFloatMapGO.this.currentLoad();
        }
        ...
        public int hashCode() {
            return UpdatableLHashParallelKVFloatFloatMapGO.this.hashCode();
        }
        ...
        public boolean shrink() {
            return UpdatableLHashParallelKVFloatFloatMapGO.this.shrink();
        }
        ...
        public boolean remove(Object o) {
            try {
                ...
                return UpdatableLHashParallelKVFloatFloatMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
        ...
        @Override
        public void clear() {
            UpdatableLHashParallelKVFloatFloatMapGO.this.clear();
        }
    }
    ...
    class ValueView extends AbstractFloatValueView {
        ...
        @Override
        public boolean contains(Object o) {
            return UpdatableLHashParallelKVFloatFloatMapGO.this.containsValue(o);
        }

        @Override
        public boolean contains(float v) {
            return UpdatableLHashParallelKVFloatFloatMapGO.this.containsValue(v);
        }

        @Override
        public boolean contains(int bits) {
            return UpdatableLHashParallelKVFloatFloatMapGO.this.containsValue(bits);
        }
