...
public class UpdatableLHashSeparateKVShortFloatMapGO
        extends UpdatableLHashSeparateKVShortFloatMapSO {

    @Override
    final void copy(SeparateKVShortFloatLHash hash) {
    ...
    @Override
    final void move(SeparateKVShortFloatLHash hash) {
        int myMC = modCount(), hashMC = hash.modCount();
        super.move(hash);
        if (myMC != modCount() || hashMC != hash.modCount())
            throw new ConcurrentModificationException();
    ...
    class EntryView extends AbstractSetView<Map.Entry<Short, Float>>
        ...
        public HashConfig hashConfig() {
            return UpdatableLHashSeparateKVShortFloatMapGO.this.hashConfig();
        }


        @Override
        public int size() {
            return UpdatableLHashSeparateKVShortFloatMapGO.this.size();
        }

        @Override
        public double currentLoad() {
            return UpdatableLHashSeparateKVShortFloatMapGO.this.currentLoad();
        }
        ...
        public int hashCode() {
            return UpdatableLHashSeparateKVShortFloatMapGO.this.hashCode();
        }
        ...
        public boolean shrink() {
            return UpdatableLHashSeparateKVShortFloatMapGO.this.shrink();
        }
        ...
        public boolean remove(Object o) {
            try {
                ...
                return UpdatableLHashSeparateKVShortFloatMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
        ...
        @Override
        public void clear() {
            UpdatableLHashSeparateKVShortFloatMapGO.this.clear();
        }
    }
    ...
    class ValueView extends AbstractFloatValueView {
        ...
        @Override
        public boolean contains(Object o) {
            return UpdatableLHashSeparateKVShortFloatMapGO.this.containsValue(o);
        }

        @Override
        public boolean contains(float v) {
            return UpdatableLHashSeparateKVShortFloatMapGO.this.containsValue(v);
        }

        @Override
        public boolean contains(int bits) {
            return UpdatableLHashSeparateKVShortFloatMapGO.this.containsValue(bits);
        }
