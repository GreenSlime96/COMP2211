...
public class ImmutableLHashSeparateKVLongFloatMapGO
        extends ImmutableLHashSeparateKVLongFloatMapSO {
    ...
    class EntryView extends AbstractSetView<Map.Entry<Long, Float>>
        ...
        public HashConfig hashConfig() {
            return ImmutableLHashSeparateKVLongFloatMapGO.this.hashConfig();
        }


        @Override
        public int size() {
            return ImmutableLHashSeparateKVLongFloatMapGO.this.size();
        }

        @Override
        public double currentLoad() {
            return ImmutableLHashSeparateKVLongFloatMapGO.this.currentLoad();
        }
        ...
        public int hashCode() {
            return ImmutableLHashSeparateKVLongFloatMapGO.this.hashCode();
        }
        ...
        public boolean shrink() {
            return ImmutableLHashSeparateKVLongFloatMapGO.this.shrink();
        }
        ...
        public boolean remove(Object o) {
            try {
                ...
                return ImmutableLHashSeparateKVLongFloatMapGO.this.remove(key, value);
            } catch (NullPointerException e) {
                return false;
            } catch (ClassCastException e) {
                return false;
        ...
        @Override
        public void clear() {
            ImmutableLHashSeparateKVLongFloatMapGO.this.clear();
        }
    }
    ...
    private class ImmutableEntry extends LongFloatEntry {
    ...
    class ValueView extends AbstractFloatValueView {
        ...
        @Override
        public boolean contains(Object o) {
            return ImmutableLHashSeparateKVLongFloatMapGO.this.containsValue(o);
        }

        @Override
        public boolean contains(float v) {
            return ImmutableLHashSeparateKVLongFloatMapGO.this.containsValue(v);
        }

        @Override
        public boolean contains(int bits) {
            return ImmutableLHashSeparateKVLongFloatMapGO.this.containsValue(bits);
        }
