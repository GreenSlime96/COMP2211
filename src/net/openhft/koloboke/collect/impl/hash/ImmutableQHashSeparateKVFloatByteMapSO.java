...
public abstract class ImmutableQHashSeparateKVFloatByteMapSO
        extends ImmutableQHashSeparateKVFloatKeyMap
        implements HashFloatByteMap, InternalFloatByteMapOps, SeparateKVFloatByteQHash {

    byte[] values;

    void copy(SeparateKVFloatByteQHash hash) {
        super.copy(hash);
        values = hash.valueArray().clone();
    }

    void move(SeparateKVFloatByteQHash hash) {
        super.move(hash);
