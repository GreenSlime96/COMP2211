...
public final class CommonFloatShortMapOps {
    ...
    public static boolean containsAllEntries(final InternalFloatShortMapOps map,
            Map<?, ?> another) {
        if ( map == another )
    ...
    public static  void putAll(final InternalFloatShortMapOps map,
            Map<? extends Float, ? extends Short> another) {
        if (map == another)
            throw new IllegalArgumentException();
