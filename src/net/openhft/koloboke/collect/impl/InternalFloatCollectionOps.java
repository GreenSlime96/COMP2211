...
public interface InternalFloatCollectionOps extends FloatCollection {
    ...
    boolean add(int bits);

    boolean removeFloat(int bits);

    boolean allContainingIn(FloatCollection c);

    boolean reverseAddAllTo(FloatCollection c);

    boolean reverseRemoveAllFrom(FloatSet s);
}
